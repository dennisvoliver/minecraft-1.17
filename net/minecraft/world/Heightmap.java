...
public class Heightmap {
   ...
   static final Predicate<BlockState> SUFFOCATES = (state) -> {
   ...
   public void setTo(Chunk chunk, Heightmap.Type type, long[] ls) {
      ...
      if (ms.length == ls.length) {
         ...
         var10000.warn("Ignoring heightmap data for chunk " + var10001 + ", size does not match; expected: " + ms.length + ", got: " + ls.length);
