...
public class WorldSaveHandler {
   ...
   public void savePlayerData(PlayerEntity player) {
      try {
         ...
         LOGGER.warn((String)"Failed to save player data for {}", (Object)player.getName().getString());
      }
   ...
   public NbtCompound loadPlayerData(PlayerEntity player) {
      ...
      try {
         ...
         LOGGER.warn((String)"Failed to load player data for {}", (Object)player.getName().getString());
      }
