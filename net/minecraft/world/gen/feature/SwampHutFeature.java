...
public class SwampHutFeature extends StructureFeature<DefaultFeatureConfig> {
   ...
   static {
      MONSTER_SPAWNS = Pool.of((Weighted[])(new SpawnSettings.SpawnEntry(EntityType.WITCH, 1, 1, 1)));
      CREATURE_SPAWNS = Pool.of((Weighted[])(new SpawnSettings.SpawnEntry(EntityType.CAT, 1, 1, 1)));
   }
