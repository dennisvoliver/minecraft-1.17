...
public class ConfiguredFeature<FC extends FeatureConfig, F extends Feature<FC>> implements Decoratable<ConfiguredFeature<?, ?>> {
   ...
   public String toString() {
      return (String)BuiltinRegistries.CONFIGURED_FEATURE.getKey(this).map(Objects::toString).orElseGet(() -> {
   ...
   static {
      ...
      REGISTRY_CODEC = RegistryElementCodec.of(Registry.CONFIGURED_FEATURE_KEY, CODEC);
      field_26756 = RegistryElementCodec.method_31194(Registry.CONFIGURED_FEATURE_KEY, CODEC);
