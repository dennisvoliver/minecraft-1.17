...
public class TreeFeatureConfig implements FeatureConfig {
   public static final Codec<TreeFeatureConfig> CODEC = RecordCodecBuilder.create((instance) -> {
      ...
      }), TrunkPlacer.TYPE_CODEC.fieldOf("trunk_placer").forGetter((treeFeatureConfig) -> {
         return treeFeatureConfig.trunkPlacer;
      }), BlockStateProvider.TYPE_CODEC.fieldOf("foliage_provider").forGetter((treeFeatureConfig) -> {
         return treeFeatureConfig.foliageProvider;
      }), BlockStateProvider.TYPE_CODEC.fieldOf("sapling_provider").forGetter((treeFeatureConfig) -> {
         return treeFeatureConfig.saplingProvider;
      }), FoliagePlacer.TYPE_CODEC.fieldOf("foliage_placer").forGetter((treeFeatureConfig) -> {
         return treeFeatureConfig.foliagePlacer;
      }), BlockStateProvider.TYPE_CODEC.fieldOf("dirt_provider").forGetter((treeFeatureConfig) -> {
         return treeFeatureConfig.dirtProvider;
      ...
      }), Codec.BOOL.fieldOf("force_dirt").orElse(false).forGetter((treeFeatureConfig) -> {
         return treeFeatureConfig.forceDirt;
      })).apply(instance, (Function10)(TreeFeatureConfig::new));
   });
