...
public class ConfiguredStructureFeatures {
   ...
   public static final ConfiguredStructureFeature<RangeDecoratorConfig, ? extends StructureFeature<RangeDecoratorConfig>> NETHER_FOSSIL;
   ...
   static {
      PILLAGER_OUTPOST = register("pillager_outpost", StructureFeature.PILLAGER_OUTPOST.configure(new StructurePoolFeatureConfig(() -> {
         return PillagerOutpostGenerator.STRUCTURE_POOLS;
      }, 7)));
      ...
      NETHER_FOSSIL = register("nether_fossil", StructureFeature.NETHER_FOSSIL.configure(new RangeDecoratorConfig(UniformHeightProvider.create(YOffset.fixed(32), YOffset.belowTop(2)))));
      ...
      BASTION_REMNANT = register("bastion_remnant", StructureFeature.BASTION_REMNANT.configure(new StructurePoolFeatureConfig(() -> {
         return BastionRemnantGenerator.STRUCTURE_POOLS;
      }, 6)));
