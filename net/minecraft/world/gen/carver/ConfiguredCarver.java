...
public class ConfiguredCarver<WC extends CarverConfig> {
   ...
   public static final Codec<List<Supplier<ConfiguredCarver<?>>>> LIST_CODEC;
   ...
   static {
      ...
      REGISTRY_CODEC = RegistryElementCodec.of(Registry.CONFIGURED_CARVER_KEY, CODEC);
      LIST_CODEC = RegistryElementCodec.method_31194(Registry.CONFIGURED_CARVER_KEY, CODEC);
   }
}
