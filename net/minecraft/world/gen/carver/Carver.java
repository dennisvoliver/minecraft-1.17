...
public abstract class Carver<C extends CarverConfig> {
   ...
   static {
      ...
      UNDERWATER_CANYON = register("underwater_canyon", new UnderwaterCanyonCarver(RavineCarverConfig.RAVINE_CODEC));
      UNDERWATER_CAVE = register("underwater_cave", new UnderwaterCaveCarver(CaveCarverConfig.CAVE_CODEC));
      STONE_SOURCE = new DefaultBlockSource(Blocks.STONE.getDefaultState());
