...
public class WanderingTraderManager implements Spawner {
      ...
      if (!world.getGameRules().getBoolean(GameRules.DO_TRADER_SPAWNING)) {
         ...
         if (this.spawnDelay > 0) {
            ...
            if (!world.getGameRules().getBoolean(GameRules.DO_MOB_SPAWNING)) {
               ...
               this.spawnChance = MathHelper.clamp((int)(this.spawnChance + 25), (int)25, (int)75);
   ...
   private boolean trySpawn(ServerWorld world) {
      ...
      if (playerEntity == null) {
         ...
         Optional<BlockPos> optional = pointOfInterestStorage.getPosition(PointOfInterestType.MEETING.getCompletionCondition(), (pos) -> {
            return true;
         ...
         if (blockPos3 != null && this.doesNotSuffocateAt(world, blockPos3)) {
            ...
            WanderingTraderEntity wanderingTraderEntity = (WanderingTraderEntity)EntityType.WANDERING_TRADER.spawn(world, (NbtCompound)null, (Text)null, (PlayerEntity)null, blockPos3, SpawnReason.EVENT, false, false);
