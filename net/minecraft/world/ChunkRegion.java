...
public class ChunkRegion implements StructureWorldAccess {
   ...
   public boolean method_37368(BlockPos blockPos) {
      ...
      if (k <= this.field_33755 && l <= this.field_33755) {
         ...
         Util.error("Detected setBlock in a far chunk [" + i + ", " + j + "], pos: " + blockPos + ", status: " + this.field_33754 + (this.field_33756 == null ? "" : ", currently generating: " + (String)this.field_33756.get()));
         return false;
      }
   }
