...
public class LevelSummary implements Comparable<LevelSummary> {
   ...
   public MutableText getVersion() {
      return (MutableText)(ChatUtil.isEmpty(this.versionInfo.getVersionName()) ? new TranslatableText("selectWorld.versionUnknown") : new LiteralText(this.versionInfo.getVersionName()));
   }
