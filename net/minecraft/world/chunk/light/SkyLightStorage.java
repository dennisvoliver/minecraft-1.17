...
public class SkyLightStorage extends LightStorage<SkyLightStorage.Data> {
   ...
   protected int method_31931(long l, boolean bl) {
      ...
      SkyLightStorage.Data data = bl ? (SkyLightStorage.Data)this.storage : (SkyLightStorage.Data)this.uncachedStorage;
      ...
      if (doSkylight) {
            ...
            while(true) {
               while(true) {
                  ...
                  if (ag == 1) {
                     ...
                     for(int y = 0; y < 16; ++y) {
                        for(z = 0; z < 16; ++z) {
                           long aa = BlockPos.asLong(ChunkSectionPos.getOffsetPos(ChunkSectionPos.unpackX(l), y), ChunkSectionPos.getBlockCoord(ChunkSectionPos.unpackY(l)), ChunkSectionPos.getOffsetPos(ChunkSectionPos.unpackZ(l), z));
                           ab = BlockPos.asLong(ChunkSectionPos.getOffsetPos(ChunkSectionPos.unpackX(l), y), ChunkSectionPos.getBlockCoord(ChunkSectionPos.unpackY(l)) - 1, ChunkSectionPos.getOffsetPos(ChunkSectionPos.unpackZ(l), z));
                     ...
                     for(j = 0; j < 16; ++j) {
                        for(k = 0; k < 16; ++k) {
                           long ae = BlockPos.asLong(ChunkSectionPos.getOffsetPos(ChunkSectionPos.unpackX(l), j), ChunkSectionPos.getOffsetPos(ChunkSectionPos.unpackY(l), 15), ChunkSectionPos.getOffsetPos(ChunkSectionPos.unpackZ(l), k));
         ...
         if (!this.sectionsToRemove.isEmpty()) {
            ...
            while(true) {
               ...
               for(ag = 0; ag < 16; ++ag) {
                  for(j = 0; j < 16; ++j) {
                     long ai = BlockPos.asLong(ChunkSectionPos.getOffsetPos(ChunkSectionPos.unpackX(l), ag), ChunkSectionPos.getOffsetPos(ChunkSectionPos.unpackY(l), 15), ChunkSectionPos.getOffsetPos(ChunkSectionPos.unpackZ(l), j));
