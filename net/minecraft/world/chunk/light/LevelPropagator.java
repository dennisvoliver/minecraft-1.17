...
public abstract class LevelPropagator {
   ...
   private void updateLevel(long sourceId, long id, int level, int currentLevel, int pendingLevel, boolean decrease) {
      if (!this.isMarker(id)) {
         level = MathHelper.clamp((int)level, (int)0, (int)(this.levelCount - 1));
         currentLevel = MathHelper.clamp((int)currentLevel, (int)0, (int)(this.levelCount - 1));
         boolean bl2;
         if (pendingLevel == 255) {
            bl2 = true;
         ...
         if (decrease) {
            ...
            j = MathHelper.clamp((int)this.recalculateLevel(id, sourceId, level), (int)0, (int)(this.levelCount - 1));
         }
   ...
   protected final void propagateLevel(long sourceId, long targetId, int level, boolean decrease) {
      ...
      int j = MathHelper.clamp((int)this.getPropagatedLevel(sourceId, targetId, level), (int)0, (int)(this.levelCount - 1));
      if (decrease) {
         ...
         if (i == 255) {
            bl2 = true;
            l = MathHelper.clamp((int)this.getLevel(targetId), (int)0, (int)(this.levelCount - 1));
         } else {
            l = i;
            bl2 = false;
         }
   ...
   protected final int applyPendingUpdates(int maxSteps) {
      if (this.minPendingLevel >= this.levelCount) {
         ...
         while(this.minPendingLevel < this.levelCount && maxSteps > 0) {
            ...
            int i = MathHelper.clamp((int)this.getLevel(l), (int)0, (int)(this.levelCount - 1));
