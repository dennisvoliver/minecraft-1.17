...
public enum AddHillsLayer implements MergingLayer, NorthWestCoordinateTransformer {
   ...
   private static final Int2IntMap MUTATED_BIOMES = (Int2IntMap)Util.make(new Int2IntOpenHashMap(), (map) -> {
      map.put(1, 129);
      map.put(2, 130);
      map.put(3, 131);
      map.put(4, 132);
      ...
      if (!BiomeLayers.isShallowOcean(i) && j >= BiomeIds.DESERT && k == BiomeIds.PLAINS) {
         ...
         if (context.nextInt(3) == 0 || k == 0) {
            ...
            if (i == BiomeIds.DESERT) {
               ...
               l = BiomeIds.BADLANDS;
            } else if ((i == BiomeIds.DEEP_OCEAN || i == BiomeIds.DEEP_LUKEWARM_OCEAN || i == BiomeIds.DEEP_COLD_OCEAN || i == BiomeIds.DEEP_FROZEN_OCEAN) && context.nextInt(3) == 0) {
