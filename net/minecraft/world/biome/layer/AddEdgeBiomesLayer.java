   ...
   public int sample(LayerRandomnessSource context, int n, int e, int s, int w, int center) {
      if (center == BiomeIds.MUSHROOM_FIELDS) {
         ...
         if (SNOWY_IDS.contains(center)) {
            ...
            if (!BiomeLayers.isOcean(center) && center != BiomeIds.RIVER && center != BiomeIds.SWAMP && (BiomeLayers.isOcean(n) || BiomeLayers.isOcean(e) || BiomeLayers.isOcean(s) || BiomeLayers.isOcean(w))) {
               return 16;
            }
