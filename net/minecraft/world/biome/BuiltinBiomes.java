...
public abstract class BuiltinBiomes {
   ...
   static {
      ...
      PLAINS = register(BiomeIds.PLAINS, BiomeKeys.PLAINS, DefaultBiomeCreator.createPlains(false));
      ...
      register(BiomeIds.GRAVELLY_MOUNTAINS, BiomeKeys.GRAVELLY_MOUNTAINS, DefaultBiomeCreator.createMountains(1.0F, 0.5F, ConfiguredSurfaceBuilders.GRAVELLY_MOUNTAIN, false));
      ...
      register(BiomeIds.MODIFIED_GRAVELLY_MOUNTAINS, BiomeKeys.MODIFIED_GRAVELLY_MOUNTAINS, DefaultBiomeCreator.createMountains(1.0F, 0.5F, ConfiguredSurfaceBuilders.GRAVELLY_MOUNTAIN, false));
