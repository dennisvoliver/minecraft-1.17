...
public class BiomeAccess {
   ...
   public interface Storage {
      ...
      default Biome getBiomeForNoiseGen(ChunkPos chunkPos) {
         return this.getBiomeForNoiseGen(BiomeCoords.fromChunk(chunkPos.x) + BiomeAccess.CHUNK_CENTER_OFFSET, 0, BiomeCoords.fromChunk(chunkPos.z) + BiomeAccess.CHUNK_CENTER_OFFSET);
      }
   }
}
