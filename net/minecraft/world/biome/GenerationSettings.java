...
public class GenerationSettings {
   ...
   public static final MapCodec<GenerationSettings> CODEC = RecordCodecBuilder.mapCodec((instance) -> {
      RecordCodecBuilder var10001 = ConfiguredSurfaceBuilder.REGISTRY_CODEC.fieldOf("surface_builder").flatXmap(Codecs.method_37352(), Codecs.method_37352()).forGetter((generationSettings) -> {
         return generationSettings.surfaceBuilder;
      });
      Codec var10002 = GenerationStep.Carver.CODEC;
      Codec var10003 = ConfiguredCarver.LIST_CODEC;
      Logger var10005 = LOGGER;
      Objects.requireNonNull(var10005);
      RecordCodecBuilder var1 = Codec.simpleMap(var10002, var10003.promotePartial(Util.addPrefix("Carver: ", var10005::error)).flatXmap(Codecs.method_37351(), Codecs.method_37351()), StringIdentifiable.toKeyable(GenerationStep.Carver.values())).fieldOf("carvers").forGetter((generationSettings) -> {
         return generationSettings.carvers;
      });
      var10003 = ConfiguredFeature.field_26756;
      var10005 = LOGGER;
      Objects.requireNonNull(var10005);
      RecordCodecBuilder var2 = var10003.promotePartial(Util.addPrefix("Feature: ", var10005::error)).flatXmap(Codecs.method_37351(), Codecs.method_37351()).listOf().fieldOf("features").forGetter((generationSettings) -> {
         return generationSettings.features;
      });
      Codec var10004 = ConfiguredStructureFeature.REGISTRY_ELEMENT_CODEC;
      Logger var10006 = LOGGER;
      Objects.requireNonNull(var10006);
      return instance.group(var10001, var1, var2, var10004.promotePartial(Util.addPrefix("Structure start: ", var10006::error)).fieldOf("starts").flatXmap(Codecs.method_37351(), Codecs.method_37351()).forGetter((generationSettings) -> {
   ...
   GenerationSettings(Supplier<ConfiguredSurfaceBuilder<?>> surfaceBuilder, Map<GenerationStep.Carver, List<Supplier<ConfiguredCarver<?>>>> carvers, List<List<Supplier<ConfiguredFeature<?, ?>>>> features, List<Supplier<ConfiguredStructureFeature<?, ?>>> structureFeatures) {
      ...
      this.flowerFeatures = (List)features.stream().flatMap(Collection::stream).map(Supplier::get).flatMap(ConfiguredFeature::getDecoratedFeatures).filter((configuredFeature) -> {
