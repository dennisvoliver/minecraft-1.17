...
public final class VillagerType {
   ...
   private static final Map<RegistryKey<Biome>, VillagerType> BIOME_TO_TYPE = (Map)Util.make(Maps.newHashMap(), (map) -> {
   ...
   public static VillagerType forBiome(Optional<RegistryKey<Biome>> biomeKey) {
      return (VillagerType)biomeKey.flatMap((registryKey) -> {
         return Optional.ofNullable((VillagerType)BIOME_TO_TYPE.get(registryKey));
      }).orElse(PLAINS);
   }
}
