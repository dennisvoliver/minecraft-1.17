   ...
   private void trySpawnZombie(ServerWorld world) {
      ...
      if (vec3d != null) {
         ...
         try {
            ...
            zombieEntity2.initialize(world, world.getLocalDifficulty(zombieEntity2.getBlockPos()), SpawnReason.EVENT, (EntityData)null, (NbtCompound)null);
         } catch (Exception var5) {
            LOGGER.warn((String)"Failed to create zombie for village siege at {}", (Object)vec3d, (Object)var5);
            return;
         }
