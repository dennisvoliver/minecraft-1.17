   ...
   public void updateOffers() {
      ...
      if (itemStack3.isEmpty()) {
         ...
         if (!tradeOfferList.isEmpty()) {
            TradeOffer tradeOffer = tradeOfferList.getValidOffer(itemStack3, itemStack4, this.offerIndex);
            if (tradeOffer == null || tradeOffer.isDisabled()) {
               this.tradeOffer = tradeOffer;
               tradeOffer = tradeOfferList.getValidOffer(itemStack4, itemStack3, this.offerIndex);
            }
