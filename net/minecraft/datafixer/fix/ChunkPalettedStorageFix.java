...
public class ChunkPalettedStorageFix extends DataFix {
   ...
   static final Map<String, Dynamic<?>> FLOWER_POT = (Map)DataFixUtils.make(Maps.newHashMap(), (hashMap) -> {
   ...
   static final Map<String, Dynamic<?>> SKULL = (Map)DataFixUtils.make(Maps.newHashMap(), (hashMap) -> {
   ...
   static final Map<String, Dynamic<?>> DOOR = (Map)DataFixUtils.make(Maps.newHashMap(), (hashMap) -> {
   ...
   static final Map<String, Dynamic<?>> NOTE_BLOCK = (Map)DataFixUtils.make(Maps.newHashMap(), (hashMap) -> {
      for(int i = 0; i < 26; ++i) {
   ...
   static final Map<String, Dynamic<?>> BED = (Map)DataFixUtils.make(Maps.newHashMap(), (hashMap) -> {
   ...
   static final Map<String, Dynamic<?>> BANNER = (Map)DataFixUtils.make(Maps.newHashMap(), (hashMap) -> {
      ObjectIterator var1 = COLORS.int2ObjectEntrySet().iterator();
         ...
         dynamic.get("TileEntities").asStreamOpt().result().ifPresent((stream) -> {
            stream.forEach((dynamic) -> {
               ...
               if (this.blockEntities.put(l, dynamic) != null) {
                  ChunkPalettedStorageFix.LOGGER.warn((String)"In chunk: {}x{} found a duplicate block entity at position: [{}, {}, {}]", (Object)this.x, this.z, i, j, k);
               }
                  ...
                  while(true) {
                     ...
                     case 25:
                        ...
                        while(true) {
                           ...
                           if (dynamic12 != null) {
                              var10000 = Boolean.toString(dynamic12.get("powered").asBoolean(false));
                              string9 = var10000 + (byte)Math.min(Math.max(dynamic12.get("note").asInt(0), 0), 24);
                              this.setBlock(w, (Dynamic)ChunkPalettedStorageFix.NOTE_BLOCK.getOrDefault(string9, (Dynamic)ChunkPalettedStorageFix.NOTE_BLOCK.get("false0")));
                           }
                        }
                     case 26:
                        var10 = ((IntList)entry.getValue()).iterator();
                        ...
                        while(true) {
                           ...
                           if (dynamic12 != null) {
                              ...
                              if (v != 14 && v >= 0 && v < 16) {
                                 var10000 = ChunkPalettedStorageFix.getProperty(dynamic14, "facing");
                                 string5 = var10000 + ChunkPalettedStorageFix.getProperty(dynamic14, "occupied") + ChunkPalettedStorageFix.getProperty(dynamic14, "part") + v;
                     ...
                     case 140:
                        ...
                        while(true) {
                           ...
                           dynamic12 = this.removeBlockEntity(w);
                           if (dynamic12 != null) {
                              var10000 = dynamic12.get("Item").asString("");
                              string9 = var10000 + dynamic12.get("Data").asInt(0);
                              this.setBlock(w, (Dynamic)ChunkPalettedStorageFix.FLOWER_POT.getOrDefault(string9, (Dynamic)ChunkPalettedStorageFix.FLOWER_POT.get("minecraft:air0")));
                           }
                        }
                     case 144:
                        var10 = ((IntList)entry.getValue()).iterator();
                        ...
                        while(true) {
                           ...
                           this.setBlock(w, (Dynamic)ChunkPalettedStorageFix.SKULL.getOrDefault(string5, (Dynamic)ChunkPalettedStorageFix.SKULL.get("0north")));
                        }
                     case 175:
                        var10 = ((IntList)entry.getValue()).iterator();
                     ...
                     case 177:
                        ...
                        while(var10.hasNext()) {
                           ...
                           if (dynamic12 != null) {
                              ...
                              if (v != 15 && v >= 0 && v < 16) {
                                 var10000 = ChunkPalettedStorageFix.getProperty(dynamic14, (Integer)entry.getKey() == 176 ? "rotation" : "facing");
                                 string5 = var10000 + "_" + v;
