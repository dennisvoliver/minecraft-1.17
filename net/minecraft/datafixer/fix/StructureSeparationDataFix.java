...
public class StructureSeparationDataFix extends DataFix {
                  ...
                  if ("stronghold".equals(string)) {
                     ...
                     case 1:
                        if ("oceanmonument".equals(string)) {
                           StructureSeparationDataFix.Information information = (StructureSeparationDataFix.Information)map.getOrDefault("minecraft:monument", (StructureSeparationDataFix.Information)STRUCTURE_SPACING.get("minecraft:monument"));
   ...
   private static void method_28281(Map<String, StructureSeparationDataFix.Information> map, String string, String string2, int i) {
      StructureSeparationDataFix.Information information = (StructureSeparationDataFix.Information)map.getOrDefault(string, (StructureSeparationDataFix.Information)STRUCTURE_SPACING.get(string));
