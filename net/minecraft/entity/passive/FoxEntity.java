...
public class FoxEntity extends AnimalEntity {
   ...
   protected void initGoals() {
      this.followChickenAndRabbitGoal = new FollowTargetGoal(this, AnimalEntity.class, 10, false, false, (entity) -> {
      ...
      this.followFishGoal = new FollowTargetGoal(this, FishEntity.class, 20, false, false, (entity) -> {
      ...
      this.goalSelector.add(4, new FleeEntityGoal(this, PlayerEntity.class, 16.0F, 1.6D, 1.4D, (entity) -> {
         return NOTICEABLE_PLAYER_FILTER.test(entity) && !this.canTrust(entity.getUuid()) && !this.isAggressive();
      }));
      this.goalSelector.add(4, new FleeEntityGoal(this, WolfEntity.class, 8.0F, 1.6D, 1.4D, (entity) -> {
         return !((WolfEntity)entity).isTamed() && !this.isAggressive();
      }));
      this.goalSelector.add(4, new FleeEntityGoal(this, PolarBearEntity.class, 8.0F, 1.6D, 1.4D, (entity) -> {
      ...
      this.goalSelector.add(10, new FoxEntity.EatSweetBerriesGoal(1.2000000476837158D, 12, 1));
      ...
      this.targetSelector.add(3, new FoxEntity.DefendFriendGoal(LivingEntity.class, false, false, (entity) -> {
   ...
   public class JumpChasingGoal extends DiveJumpingGoal {
      ...
      public boolean shouldContinue() {
         ...
         if (livingEntity != null && livingEntity.isAlive()) {
            ...
            return (!(d * d < 0.05000000074505806D) || !(Math.abs(FoxEntity.this.getPitch()) < 15.0F) || !FoxEntity.this.onGround) && !FoxEntity.this.isWalking();
         } else {
            return false;
         }
      }
      ...
      public void tick() {
         ...
         if (!FoxEntity.this.isWalking()) {
            ...
            if (vec3d.y * vec3d.y < 0.029999999329447746D && FoxEntity.this.getPitch() != 0.0F) {
   ...
   private class DefendFriendGoal extends FollowTargetGoal<LivingEntity> {
      @Nullable
   ...
   private abstract class CalmDownGoal extends Goal {
      private final TargetPredicate WORRIABLE_ENTITY_PREDICATE = TargetPredicate.createAttackable().setBaseMaxDistance(12.0D).ignoreVisibility().setPredicate(FoxEntity.this.new WorriableEntityFilter());
