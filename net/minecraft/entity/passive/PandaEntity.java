...
public class PandaEntity extends AnimalEntity {
   ...
   static {
      ...
      ASK_FOR_BAMBOO_TARGET = TargetPredicate.createNonAttackable().setBaseMaxDistance(8.0D);
      IS_FOOD = (item) -> {
         ItemStack itemStack = item.getStack();
   ...
   private static class ExtinguishFireGoal extends EscapeDangerGoal {
      private final PandaEntity panda;
   ...
   private class PandaMateGoal extends AnimalMateGoal {
      private final PandaEntity panda;
   ...
   private static class PandaFleeGoal<T extends LivingEntity> extends FleeEntityGoal<T> {
      private final PandaEntity panda;
   ...
   private class PickUpFoodGoal extends Goal {
   ...
   private static class SneezeGoal extends Goal {
      private final PandaEntity panda;
         ...
         if (this.mob.getRandom().nextFloat() >= this.chance) {
            ...
            if (this.target == null) {
               if (this.targetType == PlayerEntity.class) {
                  ...
                  this.target = this.mob.world.getClosestEntity(this.mob.world.getEntitiesByClass(this.targetType, this.mob.getBoundingBox().expand((double)this.range, 3.0D, (double)this.range), (livingEntity) -> {
                     return true;
   ...
   private static class PandaRevengeGoal extends RevengeGoal {
      private final PandaEntity panda;
