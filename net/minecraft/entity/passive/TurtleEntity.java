...
public class TurtleEntity extends AnimalEntity {
   ...
   static class GoHomeGoal extends Goal {
      ...
      public void tick() {
         ...
         if (this.turtle.getNavigation().isIdle()) {
            ...
            if (vec3d2 == null) {
               vec3d2 = NoPenaltyTargeting.find(this.turtle, 8, 7, vec3d, 1.5707963705062866D);
            }

            if (vec3d2 != null && !bl && !this.turtle.world.getBlockState(new BlockPos(vec3d2)).isOf(Blocks.WATER)) {
               vec3d2 = NoPenaltyTargeting.find(this.turtle, 16, 5, vec3d, 1.5707963705062866D);
            }
   ...
   private static class TurtleSwimNavigation extends SwimNavigation {
