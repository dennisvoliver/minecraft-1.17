...
public class PufferfishEntity extends FishEntity {
   ...
   public void tickMovement() {
      ...
      if (this.isAlive() && this.getPuffState() > 0) {
         List<MobEntity> list = this.world.getEntitiesByClass(MobEntity.class, this.getBoundingBox().expand(0.3D), (entity) -> {
   ...
   private static class InflateGoal extends Goal {
      ...
      public boolean canStart() {
         List<LivingEntity> list = this.pufferfish.world.getEntitiesByClass(LivingEntity.class, this.pufferfish.getBoundingBox().expand(2.0D), (livingEntity) -> {
            return PufferfishEntity.BLOW_UP_TARGET_PREDICATE.test(this.pufferfish, livingEntity);
         });
         return !list.isEmpty();
      }
