      ...
      if (this.world instanceof ServerWorld) {
         ...
         if (this.isPatrolLeader() && raid == null && ((ServerWorld)this.world).getRaidAt(this.getBlockPos()) == null) {
            ...
            if (!itemStack.isEmpty() && ItemStack.areEqual(itemStack, Raid.getOminousBanner()) && playerEntity != null) {
               ...
               i = MathHelper.clamp((int)i, (int)0, (int)4);
   ...
   private static class AttackHomeGoal extends Goal {
      ...
      public void tick() {
         if (this.raider.getNavigation().isIdle()) {
            ...
            Vec3d vec3d2 = NoPenaltyTargeting.find(this.raider, 16, 7, vec3d, 0.3141592741012573D);
            if (vec3d2 == null) {
               vec3d2 = NoPenaltyTargeting.find(this.raider, 8, 7, vec3d, 1.5707963705062866D);
            }
