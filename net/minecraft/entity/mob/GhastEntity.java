      ...
      public void tick() {
         ...
         if (livingEntity.squaredDistanceTo(this.ghast) < 4096.0D && this.ghast.canSee(livingEntity)) {
            ...
            if (this.cooldown == 10 && !this.ghast.isSilent()) {
               world.syncWorldEvent((PlayerEntity)null, WorldEvents.GHAST_WARNS, this.ghast.getBlockPos(), 0);
            }
            ...
            if (this.cooldown == 20) {
               ...
               if (!this.ghast.isSilent()) {
                  world.syncWorldEvent((PlayerEntity)null, WorldEvents.GHAST_SHOOTS, this.ghast.getBlockPos(), 0);
               }
