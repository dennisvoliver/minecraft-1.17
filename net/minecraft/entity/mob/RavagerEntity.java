...
public class RavagerEntity extends RaiderEntity {
   ...
   private static final double field_30483 = 0.5725490196078431D;
   private static final double field_30484 = 0.5137254901960784D;
   private static final double field_30485 = 0.4980392156862745D;
   ...
   private void roar() {
      if (this.isAlive()) {
         List<? extends LivingEntity> list = this.world.getEntitiesByClass(LivingEntity.class, this.getBoundingBox().expand(4.0D), IS_NOT_RAVAGER);
