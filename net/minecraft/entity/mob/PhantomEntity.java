...
public class PhantomEntity extends FlyingEntity implements Monster {
   ...
   PhantomEntity.PhantomMovementType movementType;
   ...
   public void setPhantomSize(int size) {
      this.dataTracker.set(SIZE, MathHelper.clamp((int)size, (int)0, (int)64));
   }
   ...
   private class SwoopMovementGoal extends PhantomEntity.MovementGoal {
      SwoopMovementGoal() {
         super();
      }
