...
public class TemptTask extends Task<PathAwareEntity> {
   ...
   public static final double field_30116 = 2.5D;
   ...
   protected void finishRunning(ServerWorld serverWorld, PathAwareEntity pathAwareEntity, long l) {
      ...
      brain.remember(MemoryModuleType.IS_TEMPTED, (Object)false);
   ...
   protected void keepRunning(ServerWorld serverWorld, PathAwareEntity pathAwareEntity, long l) {
      ...
      if (pathAwareEntity.squaredDistanceTo(playerEntity) < 6.25D) {
         brain.forget(MemoryModuleType.WALK_TARGET);
      } else {
         brain.remember(MemoryModuleType.WALK_TARGET, (Object)(new WalkTarget(new EntityLookTarget(playerEntity, false), this.getSpeed(pathAwareEntity), 2)));
      }
