...
public class WalkTowardClosestAdultTask<E extends PassiveEntity> extends Task<E> {
   ...
   protected void run(ServerWorld serverWorld, E passiveEntity, long l) {
      LookTargetUtil.walkTowards(passiveEntity, (Entity)this.getNearestVisibleAdult(passiveEntity), (Float)this.speed.apply(passiveEntity), this.executionRange.getMin() - 1);
   }
