...
public class LeapingChargeTask extends Task<MobEntity> {
   ...
   protected void finishRunning(ServerWorld serverWorld, MobEntity mobEntity, long l) {
      if (mobEntity.isOnGround()) {
         mobEntity.setVelocity(mobEntity.getVelocity().multiply(0.10000000149011612D));
         serverWorld.playSoundFromEntity((PlayerEntity)null, mobEntity, this.field_33459, SoundCategory.NEUTRAL, 2.0F, 1.0F);
      }
