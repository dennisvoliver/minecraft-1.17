...
public class FindWalkTargetTask extends Task<PathAwareEntity> {
   ...
   private void updateWalkTarget(PathAwareEntity entity, ChunkSectionPos pos) {
      Optional<Vec3d> optional = Optional.ofNullable(NoPenaltyTargeting.find(entity, this.maxHorizontalDistance, this.maxVerticalDistance, Vec3d.ofBottomCenter(pos.getCenterPos()), 1.5707963705062866D));
