...
public class RamImpactTask<E extends PathAwareEntity> extends Task<E> {
   ...
   protected void keepRunning(ServerWorld serverWorld, E pathAwareEntity, long l) {
      ...
      if (!list.isEmpty()) {
         ...
         serverWorld.playSoundFromEntity((PlayerEntity)null, pathAwareEntity, (SoundEvent)this.soundFactory.apply(pathAwareEntity), SoundCategory.HOSTILE, 1.0F, 1.0F);
      } else {
         ...
         boolean bl = !optional.isPresent() || !optional2.isPresent() || ((WalkTarget)optional.get()).getLookTarget().getPos().distanceTo((Vec3d)optional2.get()) < 0.25D;
         if (bl) {
            this.finishRam(serverWorld, pathAwareEntity);
         }
      }
   ...
   protected void finishRam(ServerWorld world, E entity) {
      ...
      entity.getBrain().remember(MemoryModuleType.RAM_COOLDOWN_TICKS, (Object)((UniformIntProvider)this.cooldownRangeFactory.apply(entity)).get(world.random));
