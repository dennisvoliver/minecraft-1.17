...
public abstract class Sensor<E extends LivingEntity> {
   ...
   private static final TargetPredicate TARGET_PREDICATE = TargetPredicate.createNonAttackable().setBaseMaxDistance(16.0D);
   private static final TargetPredicate TARGET_PREDICATE_IGNORE_DISTANCE_SCALING = TargetPredicate.createNonAttackable().setBaseMaxDistance(16.0D).ignoreDistanceScalingFactor();
   private static final TargetPredicate field_33762 = TargetPredicate.createAttackable().setBaseMaxDistance(16.0D);
   private static final TargetPredicate field_33763 = TargetPredicate.createAttackable().setBaseMaxDistance(16.0D).ignoreDistanceScalingFactor();
   ...
   public static boolean method_36982(LivingEntity livingEntity, LivingEntity livingEntity2) {
      return livingEntity.getBrain().hasMemoryModuleWithValue(MemoryModuleType.ATTACK_TARGET, livingEntity2) ? field_33763.test(livingEntity, livingEntity2) : field_33762.test(livingEntity, livingEntity2);
   }
}
