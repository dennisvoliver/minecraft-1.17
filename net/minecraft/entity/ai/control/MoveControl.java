...
public class MoveControl implements Control {
   ...
   private boolean method_25946(float f, float g) {
      ...
      if (entityNavigation != null) {
         ...
         if (pathNodeMaker != null && pathNodeMaker.getDefaultNodeType(this.entity.world, MathHelper.floor(this.entity.getX() + (double)f), this.entity.getBlockY(), MathHelper.floor(this.entity.getZ() + (double)g)) != PathNodeType.WALKABLE) {
            return false;
         }
      }
