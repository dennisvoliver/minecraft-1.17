...
public class FlyOntoTreeGoal extends WanderAroundFarGoal {
   ...
   private Vec3d getTreeTarget() {
      ...
      do {
         ...
         BlockState blockState = this.mob.world.getBlockState(mutable2.set(blockPos2, (Direction)Direction.DOWN));
         bl = blockState.getBlock() instanceof LeavesBlock || blockState.isIn(BlockTags.LOGS);
      } while(!bl || !this.mob.world.isAir(blockPos2) || !this.mob.world.isAir(mutable.set(blockPos2, (Direction)Direction.UP)));
