...
public class FleeEntityGoal<T extends LivingEntity> extends Goal {
   ...
   public boolean canStart() {
      this.targetEntity = this.mob.world.getClosestEntity(this.mob.world.getEntitiesByClass(this.classToFleeFrom, this.mob.getBoundingBox().expand((double)this.fleeDistance, 3.0D, (double)this.fleeDistance), (livingEntity) -> {
         return true;
