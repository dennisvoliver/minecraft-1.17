      ...
      if (!NavigationConditions.hasMobNavigation(this.mob)) {
         ...
         if (this.requiresNighttime && this.mob.world.isDay()) {
            ...
            if (!serverWorld.isNearOccupiedPointOfInterest(blockPos, 6)) {
               ...
               Vec3d vec3d = FuzzyTargeting.find(this.mob, 15, 7, (blockPos2x) -> {
               ...
               if (vec3d == null) {
                  ...
                  if (!optional.isPresent()) {
                     ...
                     if (this.targetPath == null) {
                        Vec3d vec3d2 = NoPenaltyTargeting.find(this.mob, 10, 7, Vec3d.ofBottomCenter(this.target), 1.5707963705062866D);
                        if (vec3d2 == null) {
                           return false;
                        }
