...
public class UpdateStructureBlockC2SPacket implements Packet<ServerPlayPacketListener> {
   ...
   public UpdateStructureBlockC2SPacket(PacketByteBuf buf) {
      ...
      int i = true;
      this.offset = new BlockPos(MathHelper.clamp((int)buf.readByte(), (int)-48, (int)48), MathHelper.clamp((int)buf.readByte(), (int)-48, (int)48), MathHelper.clamp((int)buf.readByte(), (int)-48, (int)48));
      int j = true;
      this.size = new Vec3i(MathHelper.clamp((int)buf.readByte(), (int)0, (int)48), MathHelper.clamp((int)buf.readByte(), (int)0, (int)48), MathHelper.clamp((int)buf.readByte(), (int)0, (int)48));
