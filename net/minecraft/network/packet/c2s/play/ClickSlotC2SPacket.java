...
public class ClickSlotC2SPacket implements Packet<ServerPlayPacketListener> {
   ...
   public ClickSlotC2SPacket(PacketByteBuf buf) {
      ...
      this.modifiedStacks = Int2ObjectMaps.unmodifiable((Int2ObjectMap)buf.readMap(Int2ObjectOpenHashMap::new, (packetByteBuf) -> {
         return Integer.valueOf(packetByteBuf.readShort());
