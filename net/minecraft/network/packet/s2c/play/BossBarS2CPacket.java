...
public class BossBarS2CPacket implements Packet<ClientPlayPacketListener> {
   ...
   public BossBarS2CPacket(PacketByteBuf buf) {
      ...
      BossBarS2CPacket.Type type = (BossBarS2CPacket.Type)buf.readEnumConstant(BossBarS2CPacket.Type.class);
   ...
   private static class AddAction implements BossBarS2CPacket.Action {
   ...
   private static class UpdateProgressAction implements BossBarS2CPacket.Action {
      private final float percent;
   ...
   private static class UpdateNameAction implements BossBarS2CPacket.Action {
      private final Text name;
   ...
   private static class UpdateStyleAction implements BossBarS2CPacket.Action {
      private final BossBar.Color color;
      private final BossBar.Style style;
   ...
   private static class UpdatePropertiesAction implements BossBarS2CPacket.Action {
      private final boolean darkenSky;
      private final boolean dragonMusic;
      private final boolean thickenFog;
