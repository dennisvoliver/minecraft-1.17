...
public class TeamS2CPacket implements Packet<ClientPlayPacketListener> {
   ...
   public static TeamS2CPacket updateTeam(Team team, boolean updatePlayers) {
      return new TeamS2CPacket(team.getName(), updatePlayers ? ADD : UPDATE, Optional.of(new TeamS2CPacket.SerializableTeam(team)), (Collection)(updatePlayers ? team.getPlayerList() : ImmutableList.of()));
   }
   ...
   public void write(PacketByteBuf buf) {
      ...
      if (containsTeamInfo(this.packetType)) {
         ((TeamS2CPacket.SerializableTeam)this.team.orElseThrow(() -> {
