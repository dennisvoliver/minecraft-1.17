...
public class GameJoinS2CPacket implements Packet<ClientPlayPacketListener> {
   ...
   public GameJoinS2CPacket(PacketByteBuf buf) {
      ...
      this.dimensionIds = (Set)buf.readCollection(Sets::newHashSetWithExpectedSize, (b) -> {
         return RegistryKey.of(Registry.WORLD_KEY, b.readIdentifier());
      });
   ...
   public void write(PacketByteBuf buf) {
      ...
      buf.writeCollection(this.dimensionIds, (b, dimension) -> {
         b.writeIdentifier(dimension.getValue());
      });
