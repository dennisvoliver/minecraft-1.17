...
public class VibrationParticleEffect implements ParticleEffect {
   public static final Codec<VibrationParticleEffect> CODEC = RecordCodecBuilder.create((instance) -> {
      return instance.group(Vibration.CODEC.fieldOf("vibration").forGetter((vibrationParticleEffect) -> {
         return vibrationParticleEffect.vibration;
      })).apply(instance, (Function)(VibrationParticleEffect::new));
   });
