...
public class DustColorTransitionParticleEffect extends AbstractDustParticleEffect {
   ...
   public static final Codec<DustColorTransitionParticleEffect> CODEC;
   public static final ParticleEffect.Factory<DustColorTransitionParticleEffect> FACTORY;
   ...
   public String asString() {
      return String.format(Locale.ROOT, "%s %.2f %.2f %.2f %.2f %.2f %.2f %.2f", Registry.PARTICLE_TYPE.getId(this.getType()), this.color.getX(), this.color.getY(), this.color.getZ(), this.scale, this.toColor.getX(), this.toColor.getY(), this.toColor.getZ());
   }
   ...
   static {
      ...
      CODEC = RecordCodecBuilder.create((instance) -> {
         return instance.group(Vec3f.CODEC.fieldOf("fromColor").forGetter((dustColorTransitionParticleEffect) -> {
            return dustColorTransitionParticleEffect.color;
         }), Vec3f.CODEC.fieldOf("toColor").forGetter((dustColorTransitionParticleEffect) -> {
            return dustColorTransitionParticleEffect.toColor;
         }), Codec.FLOAT.fieldOf("scale").forGetter((dustColorTransitionParticleEffect) -> {
            return dustColorTransitionParticleEffect.scale;
         })).apply(instance, (Function3)(DustColorTransitionParticleEffect::new));
      });
      FACTORY = new ParticleEffect.Factory<DustColorTransitionParticleEffect>() {
