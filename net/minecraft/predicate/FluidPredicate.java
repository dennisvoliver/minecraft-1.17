...
public class FluidPredicate {
   ...
   public static FluidPredicate fromJson(@Nullable JsonElement json) {
      if (json != null && !json.isJsonNull()) {
         ...
         if (jsonObject.has("tag")) {
            ...
            tag = ServerTagManagerHolder.getTagManager().getTag(Registry.FLUID_KEY, identifier2, (id) -> {
   ...
   public JsonElement toJson() {
      if (this == ANY) {
         ...
         if (this.tag != null) {
            jsonObject.addProperty("tag", ServerTagManagerHolder.getTagManager().getTagId(Registry.FLUID_KEY, this.tag, () -> {
