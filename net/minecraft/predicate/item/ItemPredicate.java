   ...
   public boolean test(ItemStack stack) {
      if (this == ANY) {
         ...
         if (this.enchantments.length > 0) {
            map2 = EnchantmentHelper.fromNbt(stack.getEnchantments());
         ...
         if (this.storedEnchantments.length > 0) {
            map2 = EnchantmentHelper.fromNbt(EnchantedBookItem.getEnchantmentNbt(stack));
         ...
         if (jsonObject.has("data")) {
            ...
            if (jsonArray != null) {
               ...
               while(var8.hasNext()) {
                  ...
                  builder.add((Object)((Item)Registry.ITEM.getOrEmpty(identifier).orElseThrow(() -> {
            ...
            if (jsonObject.has("tag")) {
               ...
               tag = ServerTagManagerHolder.getTagManager().getTag(Registry.ITEM_KEY, identifier2, (id) -> {
      ...
      if (this == ANY) {
         ...
         if (this.items != null) {
            ...
            while(var3.hasNext()) {
               ...
               jsonArray3.add(Registry.ITEM.getId(item).toString());
            }
         ...
         if (this.enchantments.length > 0) {
            ...
            for(var5 = 0; var5 < var8; ++var5) {
               enchantmentPredicate2 = var7[var5];
               jsonArray3.add(enchantmentPredicate2.serialize());
            }

            jsonObject.add("enchantments", jsonArray3);
         }
