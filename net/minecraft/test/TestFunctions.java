...
public class TestFunctions {
   ...
   private static TestFunction getTestFunction(Method method) {
      ...
      return new TestFunction(string5, string3, string4, blockRotation, gameTest.tickLimit(), gameTest.duration(), gameTest.required(), gameTest.requiredSuccesses(), gameTest.maxAttempts(), getInvoker(method));
   }
