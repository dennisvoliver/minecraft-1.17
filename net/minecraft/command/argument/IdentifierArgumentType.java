...
public class IdentifierArgumentType implements ArgumentType<Identifier> {
   ...
   private static final DynamicCommandExceptionType UNKNOWN_PREDICATE_EXCEPTION = new DynamicCommandExceptionType((object) -> {
      return new TranslatableText("predicate.unknown", new Object[]{object});
   });
   private static final DynamicCommandExceptionType UNKNOWN_ATTRIBUTE_EXCEPTION = new DynamicCommandExceptionType((object) -> {
      return new TranslatableText("attribute.unknown", new Object[]{object});
   });
   private static final DynamicCommandExceptionType UNKNOWN_ITEM_MODIFIER_EXCEPTION = new DynamicCommandExceptionType((object) -> {
      return new TranslatableText("item_modifier.unknown", new Object[]{object});
   });
   ...
   public static EntityAttribute getAttributeArgument(CommandContext<ServerCommandSource> context, String argumentName) throws CommandSyntaxException {
      ...
      return (EntityAttribute)Registry.ATTRIBUTE.getOrEmpty(identifier).orElseThrow(() -> {
         return UNKNOWN_ATTRIBUTE_EXCEPTION.create(identifier);
      });
   }
