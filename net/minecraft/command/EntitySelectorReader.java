...
public class EntitySelectorReader {
   ...
   public static final DynamicCommandExceptionType UNKNOWN_SELECTOR_EXCEPTION = new DynamicCommandExceptionType((selectorType) -> {
      return new TranslatableText("argument.entity.selector.unknown", new Object[]{selectorType});
   });
   ...
   public static final DynamicCommandExceptionType VALUELESS_EXCEPTION = new DynamicCommandExceptionType((option) -> {
      return new TranslatableText("argument.entity.options.valueless", new Object[]{option});
   });
   public static final BiConsumer<Vec3d, List<? extends Entity>> ARBITRARY = (pos, entities) -> {
   };
   public static final BiConsumer<Vec3d, List<? extends Entity>> NEAREST = (pos, entities) -> {
      entities.sort((entity1, entity2) -> {
         return Doubles.compare(entity1.squaredDistanceTo(pos), entity2.squaredDistanceTo(pos));
      });
   };
   public static final BiConsumer<Vec3d, List<? extends Entity>> FURTHEST = (pos, entities) -> {
      entities.sort((entity1, entity2) -> {
         return Doubles.compare(entity2.squaredDistanceTo(pos), entity1.squaredDistanceTo(pos));
      });
   };
   public static final BiConsumer<Vec3d, List<? extends Entity>> RANDOM = (pos, entities) -> {
      Collections.shuffle(entities);
   };
   public static final BiFunction<SuggestionsBuilder, Consumer<SuggestionsBuilder>, CompletableFuture<Suggestions>> DEFAULT_SUGGESTION_PROVIDER = (builder, consumer) -> {
