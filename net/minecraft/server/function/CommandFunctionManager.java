...
public class CommandFunctionManager {
   ...
   public int execute(CommandFunction function, ServerCommandSource source) {
      return this.execute(function, source, (CommandFunctionManager.Tracer)null);
   }
   ...
   private void load(FunctionLoader loader) {
      this.tickFunctions = ImmutableList.copyOf((Collection)loader.getTags().getTagOrEmpty(TICK_TAG_ID).values());
