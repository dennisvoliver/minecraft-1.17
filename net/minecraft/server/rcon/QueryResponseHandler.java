...
public class QueryResponseHandler extends RconBase {
   ...
   private byte[] createRulesReply(DatagramPacket packet) throws IOException {
      ...
      if (l < this.lastResponseTime + 5000L) {
         ...
         this.data.writeBytes(this.server.getCurrentPlayerCount().makeConcatWithConstants<invokedynamic>(this.server.getCurrentPlayerCount()));
         this.data.writeBytes("maxplayers");
         this.data.writeBytes(this.maxPlayerCount.makeConcatWithConstants<invokedynamic>(this.maxPlayerCount));
         this.data.writeBytes("hostport");
         this.data.writeBytes(this.port.makeConcatWithConstants<invokedynamic>(this.port));
