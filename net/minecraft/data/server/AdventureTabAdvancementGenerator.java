...
public class AdventureTabAdvancementGenerator implements Consumer<Consumer<Advancement>> {
   ...
   private static LightningStrikeCriterion.Conditions createLightningStrike(NumberRange.IntRange range, EntityPredicate entity) {
      return LightningStrikeCriterion.Conditions.create(EntityPredicate.Builder.create().distance(DistancePredicate.absolute(NumberRange.FloatRange.atMost(30.0D))).lightningBolt(LightningBoltPredicate.of(range)).build(), entity);
   }
   ...
   public void accept(Consumer<Advancement> consumer) {
      ...
      Advancement.Task.create().parent(advancement5).display((ItemConvertible)Blocks.TARGET.asItem(), new TranslatableText("advancements.adventure.bullseye.title"), new TranslatableText("advancements.adventure.bullseye.description"), (Identifier)null, AdvancementFrame.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(50)).criterion("bullseye", (CriterionConditions)TargetHitCriterion.Conditions.create(NumberRange.IntRange.exactly(15), EntityPredicate.Extended.ofLegacy(EntityPredicate.Builder.create().distance(DistancePredicate.horizontal(NumberRange.FloatRange.atLeast(30.0D))).build()))).build(consumer, "adventure/bullseye");
      Advancement.Task.create().parent(advancement).display((ItemConvertible)Items.LEATHER_BOOTS, new TranslatableText("advancements.adventure.walk_on_powder_snow_with_leather_boots.title"), new TranslatableText("advancements.adventure.walk_on_powder_snow_with_leather_boots.description"), (Identifier)null, AdvancementFrame.TASK, true, true, false).criterion("walk_on_powder_snow_with_leather_boots", (CriterionConditions)LocationArrivalCriterion.Conditions.createSteppingOnWithBoots(Blocks.POWDER_SNOW, Items.LEATHER_BOOTS)).build(consumer, "adventure/walk_on_powder_snow_with_leather_boots");
      Advancement.Task.create().parent(advancement).display((ItemConvertible)Items.LIGHTNING_ROD, new TranslatableText("advancements.adventure.lightning_rod_with_villager_no_fire.title"), new TranslatableText("advancements.adventure.lightning_rod_with_villager_no_fire.description"), (Identifier)null, AdvancementFrame.TASK, true, true, false).criterion("lightning_rod_with_villager_no_fire", (CriterionConditions)createLightningStrike(NumberRange.IntRange.exactly(0), EntityPredicate.Builder.create().type(EntityType.VILLAGER).build())).build(consumer, "adventure/lightning_rod_with_villager_no_fire");
      Advancement advancement9 = Advancement.Task.create().parent(advancement).display((ItemConvertible)Items.SPYGLASS, new TranslatableText("advancements.adventure.spyglass_at_parrot.title"), new TranslatableText("advancements.adventure.spyglass_at_parrot.description"), (Identifier)null, AdvancementFrame.TASK, true, true, false).criterion("spyglass_at_parrot", (CriterionConditions)createLookingAtEntityUsing(EntityType.PARROT, Items.SPYGLASS)).build(consumer, "adventure/spyglass_at_parrot");
      Advancement advancement10 = Advancement.Task.create().parent(advancement9).display((ItemConvertible)Items.SPYGLASS, new TranslatableText("advancements.adventure.spyglass_at_ghast.title"), new TranslatableText("advancements.adventure.spyglass_at_ghast.description"), (Identifier)null, AdvancementFrame.TASK, true, true, false).criterion("spyglass_at_ghast", (CriterionConditions)createLookingAtEntityUsing(EntityType.GHAST, Items.SPYGLASS)).build(consumer, "adventure/spyglass_at_ghast");
      Advancement.Task.create().parent(advancement10).display((ItemConvertible)Items.SPYGLASS, new TranslatableText("advancements.adventure.spyglass_at_dragon.title"), new TranslatableText("advancements.adventure.spyglass_at_dragon.description"), (Identifier)null, AdvancementFrame.TASK, true, true, false).criterion("spyglass_at_dragon", (CriterionConditions)createLookingAtEntityUsing(EntityType.ENDER_DRAGON, Items.SPYGLASS)).build(consumer, "adventure/spyglass_at_dragon");
   }
