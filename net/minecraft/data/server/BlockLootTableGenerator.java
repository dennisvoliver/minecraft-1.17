...
public class BlockLootTableGenerator implements Consumer<BiConsumer<Identifier, LootTable.Builder>> {
   ...
   private static LootTable.Builder drops(ItemConvertible drop) {
      return LootTable.builder().pool((LootPool.Builder)addSurvivesExplosionCondition(drop, LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0F)).with(ItemEntry.builder(drop))));
   }
   ...
   private static LootTable.Builder drops(ItemConvertible drop, LootNumberProvider count) {
      return LootTable.builder().pool(LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0F)).with((LootPoolEntry.Builder)applyExplosionDecay(drop, ItemEntry.builder(drop).apply(SetCountLootFunction.builder(count)))));
   }
   ...
   private static LootTable.Builder pottedPlantDrops(ItemConvertible plant) {
      return LootTable.builder().pool((LootPool.Builder)addSurvivesExplosionCondition(Blocks.FLOWER_POT, LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0F)).with(ItemEntry.builder(Blocks.FLOWER_POT)))).pool((LootPool.Builder)addSurvivesExplosionCondition(plant, LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0F)).with(ItemEntry.builder(plant))));
   }

   private static LootTable.Builder slabDrops(Block drop) {
      return LootTable.builder().pool(LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0F)).with((LootPoolEntry.Builder)applyExplosionDecay(drop, ItemEntry.builder(drop).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(2.0F)).conditionally(BlockStatePropertyLootCondition.builder(drop).properties(StatePredicate.Builder.create().exactMatch(SlabBlock.TYPE, (Comparable)SlabType.DOUBLE)))))));
   }
   ...
   private static <T extends Comparable<T> & StringIdentifiable> LootTable.Builder dropsWithProperty(Block drop, Property<T> property, T comparable) {
      return LootTable.builder().pool((LootPool.Builder)addSurvivesExplosionCondition(drop, LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0F)).with(ItemEntry.builder(drop).conditionally(BlockStatePropertyLootCondition.builder(drop).properties(StatePredicate.Builder.create().exactMatch(property, comparable))))));
   }

   private static LootTable.Builder nameableContainerDrops(Block drop) {
      return LootTable.builder().pool((LootPool.Builder)addSurvivesExplosionCondition(drop, LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0F)).with(ItemEntry.builder(drop).apply(CopyNameLootFunction.builder(CopyNameLootFunction.Source.BLOCK_ENTITY)))));
   }

   private static LootTable.Builder shulkerBoxDrops(Block drop) {
      return LootTable.builder().pool((LootPool.Builder)addSurvivesExplosionCondition(drop, LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0F)).with(ItemEntry.builder(drop).apply(CopyNameLootFunction.builder(CopyNameLootFunction.Source.BLOCK_ENTITY)).apply(CopyNbtLootFunction.builder((LootNbtProvider)ContextLootNbtProvider.BLOCK_ENTITY).withOperation("Lock", "BlockEntityTag.Lock").withOperation("LootTable", "BlockEntityTag.LootTable").withOperation("LootTableSeed", "BlockEntityTag.LootTableSeed")).apply(SetContentsLootFunction.builder().withEntry(DynamicEntry.builder(ShulkerBoxBlock.CONTENTS))))));
   }

   private static LootTable.Builder copperOreDrops(Block ore) {
      return dropsWithSilkTouch(ore, (LootPoolEntry.Builder)applyExplosionDecay(ore, ItemEntry.builder(Items.RAW_COPPER).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(2.0F, 3.0F))).apply(ApplyBonusLootFunction.oreDrops(Enchantments.FORTUNE))));
   }

   private static LootTable.Builder lapisOreDrops(Block ore) {
      return dropsWithSilkTouch(ore, (LootPoolEntry.Builder)applyExplosionDecay(ore, ItemEntry.builder(Items.LAPIS_LAZULI).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(4.0F, 9.0F))).apply(ApplyBonusLootFunction.oreDrops(Enchantments.FORTUNE))));
   }

   private static LootTable.Builder redstoneOreDrops(Block ore) {
      return dropsWithSilkTouch(ore, (LootPoolEntry.Builder)applyExplosionDecay(ore, ItemEntry.builder(Items.REDSTONE).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(4.0F, 5.0F))).apply(ApplyBonusLootFunction.uniformBonusCount(Enchantments.FORTUNE))));
   }
   ...
   private static LootTable.Builder mushroomBlockDrops(Block dropWithSilkTouch, ItemConvertible drop) {
      return dropsWithSilkTouch(dropWithSilkTouch, (LootPoolEntry.Builder)applyExplosionDecay(dropWithSilkTouch, ItemEntry.builder(drop).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(-6.0F, 2.0F))).apply(LimitCountLootFunction.builder(BoundedIntUnaryOperator.createMin(0)))));
   }
   ...
   private static LootTable.Builder cropStemDrops(Block stem, Item drop) {
      return LootTable.builder().pool((LootPool.Builder)applyExplosionDecay(stem, LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0F)).with(ItemEntry.builder(drop).apply(SetCountLootFunction.builder(BinomialLootNumberProvider.create(3, 0.06666667F)).conditionally(BlockStatePropertyLootCondition.builder(stem).properties(StatePredicate.Builder.create().exactMatch(StemBlock.AGE, 0)))).apply(SetCountLootFunction.builder(BinomialLootNumberProvider.create(3, 0.13333334F)).conditionally(BlockStatePropertyLootCondition.builder(stem).properties(StatePredicate.Builder.create().exactMatch(StemBlock.AGE, 1)))).apply(SetCountLootFunction.builder(BinomialLootNumberProvider.create(3, 0.2F)).conditionally(BlockStatePropertyLootCondition.builder(stem).properties(StatePredicate.Builder.create().exactMatch(StemBlock.AGE, 2)))).apply(SetCountLootFunction.builder(BinomialLootNumberProvider.create(3, 0.26666668F)).conditionally(BlockStatePropertyLootCondition.builder(stem).properties(StatePredicate.Builder.create().exactMatch(StemBlock.AGE, 3)))).apply(SetCountLootFunction.builder(BinomialLootNumberProvider.create(3, 0.33333334F)).conditionally(BlockStatePropertyLootCondition.builder(stem).properties(StatePredicate.Builder.create().exactMatch(StemBlock.AGE, 4)))).apply(SetCountLootFunction.builder(BinomialLootNumberProvider.create(3, 0.4F)).conditionally(BlockStatePropertyLootCondition.builder(stem).properties(StatePredicate.Builder.create().exactMatch(StemBlock.AGE, 5)))).apply(SetCountLootFunction.builder(BinomialLootNumberProvider.create(3, 0.46666667F)).conditionally(BlockStatePropertyLootCondition.builder(stem).properties(StatePredicate.Builder.create().exactMatch(StemBlock.AGE, 6)))).apply(SetCountLootFunction.builder(BinomialLootNumberProvider.create(3, 0.53333336F)).conditionally(BlockStatePropertyLootCondition.builder(stem).properties(StatePredicate.Builder.create().exactMatch(StemBlock.AGE, 7)))))));
   }

   private static LootTable.Builder attachedCropStemDrops(Block stem, Item drop) {
      return LootTable.builder().pool((LootPool.Builder)applyExplosionDecay(stem, LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0F)).with(ItemEntry.builder(drop).apply(SetCountLootFunction.builder(BinomialLootNumberProvider.create(3, 0.53333336F))))));
   }
   ...
   private static LootTable.Builder method_37108(Block block) {
      return LootTable.builder().pool(LootPool.builder().with((LootPoolEntry.Builder)applyExplosionDecay(block, ((LeafEntry.Builder)ItemEntry.builder(block).conditionally(WITH_SHEARS)).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F), true).conditionally(BlockStatePropertyLootCondition.builder(block).properties(StatePredicate.Builder.create().exactMatch(ConnectingBlock.EAST, true)))).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F), true).conditionally(BlockStatePropertyLootCondition.builder(block).properties(StatePredicate.Builder.create().exactMatch(ConnectingBlock.WEST, true)))).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F), true).conditionally(BlockStatePropertyLootCondition.builder(block).properties(StatePredicate.Builder.create().exactMatch(ConnectingBlock.NORTH, true)))).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F), true).conditionally(BlockStatePropertyLootCondition.builder(block).properties(StatePredicate.Builder.create().exactMatch(ConnectingBlock.SOUTH, true)))).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F), true).conditionally(BlockStatePropertyLootCondition.builder(block).properties(StatePredicate.Builder.create().exactMatch(ConnectingBlock.UP, true)))).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F), true).conditionally(BlockStatePropertyLootCondition.builder(block).properties(StatePredicate.Builder.create().exactMatch(ConnectingBlock.DOWN, true)))).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(-1.0F), true)))));
   }
   ...
   private static LootTable.Builder oakLeavesDrop(Block leaves, Block drop, float... chance) {
      return leavesDrop(leaves, drop, chance).pool(LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0F)).conditionally(WITHOUT_SILK_TOUCH_NOR_SHEARS).with(((LeafEntry.Builder)addSurvivesExplosionCondition(leaves, ItemEntry.builder(Items.APPLE))).conditionally(TableBonusLootCondition.builder(Enchantments.FORTUNE, 0.005F, 0.0055555557F, 0.00625F, 0.008333334F, 0.025F))));
   }
   ...
   private static LootTable.Builder tallGrassDrops(Block tallGrass, Block grass) {
      ...
      return LootTable.builder().pool(LootPool.builder().with(builder).conditionally(BlockStatePropertyLootCondition.builder(tallGrass).properties(StatePredicate.Builder.create().exactMatch(TallPlantBlock.HALF, (Comparable)DoubleBlockHalf.LOWER))).conditionally(LocationCheckLootCondition.builder(LocationPredicate.Builder.create().block(BlockPredicate.Builder.create().blocks(tallGrass).state(StatePredicate.Builder.create().exactMatch(TallPlantBlock.HALF, (Comparable)DoubleBlockHalf.UPPER).build()).build()), new BlockPos(0, 1, 0)))).pool(LootPool.builder().with(builder).conditionally(BlockStatePropertyLootCondition.builder(tallGrass).properties(StatePredicate.Builder.create().exactMatch(TallPlantBlock.HALF, (Comparable)DoubleBlockHalf.UPPER))).conditionally(LocationCheckLootCondition.builder(LocationPredicate.Builder.create().block(BlockPredicate.Builder.create().blocks(tallGrass).state(StatePredicate.Builder.create().exactMatch(TallPlantBlock.HALF, (Comparable)DoubleBlockHalf.LOWER).build()).build()), new BlockPos(0, -1, 0))));
   }

   private static LootTable.Builder candleDrops(Block candle) {
      return LootTable.builder().pool(LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0F)).with((LootPoolEntry.Builder)applyExplosionDecay(candle, ItemEntry.builder(candle).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(2.0F)).conditionally(BlockStatePropertyLootCondition.builder(candle).properties(StatePredicate.Builder.create().exactMatch(CandleBlock.CANDLES, 2)))).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(3.0F)).conditionally(BlockStatePropertyLootCondition.builder(candle).properties(StatePredicate.Builder.create().exactMatch(CandleBlock.CANDLES, 3)))).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(4.0F)).conditionally(BlockStatePropertyLootCondition.builder(candle).properties(StatePredicate.Builder.create().exactMatch(CandleBlock.CANDLES, 4)))))));
   }
   ...
   public void accept(BiConsumer<Identifier, LootTable.Builder> biConsumer) {
      ...
      this.addDrop(Blocks.DIRT_PATH, (ItemConvertible)Blocks.DIRT);
      ...
      this.addDrop(Blocks.WATER_CAULDRON, (ItemConvertible)Blocks.CAULDRON);
      this.addDrop(Blocks.LAVA_CAULDRON, (ItemConvertible)Blocks.CAULDRON);
      this.addDrop(Blocks.POWDER_SNOW_CAULDRON, (ItemConvertible)Blocks.CAULDRON);
      this.addDrop(Blocks.BIG_DRIPLEAF_STEM, (ItemConvertible)Blocks.BIG_DRIPLEAF);
      this.addDrop(Blocks.STONE, (blockx) -> {
         return drops((Block)blockx, (ItemConvertible)Blocks.COBBLESTONE);
      });
      this.addDrop(Blocks.DEEPSLATE, (blockx) -> {
         return drops((Block)blockx, (ItemConvertible)Blocks.COBBLED_DEEPSLATE);
      });
      ...
      this.addDrop(Blocks.BOOKSHELF, (blockx) -> {
         return drops(blockx, (ItemConvertible)Items.BOOK, (LootNumberProvider)ConstantLootNumberProvider.create(3.0F));
      });
      this.addDrop(Blocks.CLAY, (blockx) -> {
         return drops(blockx, (ItemConvertible)Items.CLAY_BALL, (LootNumberProvider)ConstantLootNumberProvider.create(4.0F));
      });
      this.addDrop(Blocks.ENDER_CHEST, (blockx) -> {
         return drops(blockx, (ItemConvertible)Blocks.OBSIDIAN, (LootNumberProvider)ConstantLootNumberProvider.create(8.0F));
      });
      this.addDrop(Blocks.SNOW_BLOCK, (blockx) -> {
         return drops(blockx, (ItemConvertible)Items.SNOWBALL, (LootNumberProvider)ConstantLootNumberProvider.create(4.0F));
      });
      this.addDrop(Blocks.CHORUS_PLANT, drops((ItemConvertible)Items.CHORUS_FRUIT, (LootNumberProvider)UniformLootNumberProvider.create(0.0F, 1.0F)));
      ...
      this.addDrop(Blocks.COCOA, (blockx) -> {
         return LootTable.builder().pool(LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0F)).with((LootPoolEntry.Builder)applyExplosionDecay(blockx, ItemEntry.builder(Items.COCOA_BEANS).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(3.0F)).conditionally(BlockStatePropertyLootCondition.builder(blockx).properties(StatePredicate.Builder.create().exactMatch(CocoaBlock.AGE, 2)))))));
      });
      this.addDrop(Blocks.SEA_PICKLE, (blockx) -> {
         return LootTable.builder().pool(LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0F)).with((LootPoolEntry.Builder)applyExplosionDecay(Blocks.SEA_PICKLE, ItemEntry.builder(blockx).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(2.0F)).conditionally(BlockStatePropertyLootCondition.builder(blockx).properties(StatePredicate.Builder.create().exactMatch(SeaPickleBlock.PICKLES, 2)))).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(3.0F)).conditionally(BlockStatePropertyLootCondition.builder(blockx).properties(StatePredicate.Builder.create().exactMatch(SeaPickleBlock.PICKLES, 3)))).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(4.0F)).conditionally(BlockStatePropertyLootCondition.builder(blockx).properties(StatePredicate.Builder.create().exactMatch(SeaPickleBlock.PICKLES, 4)))))));
      });
      ...
      this.addDrop(Blocks.PLAYER_HEAD, (blockx) -> {
         return LootTable.builder().pool((LootPool.Builder)addSurvivesExplosionCondition(blockx, LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0F)).with(ItemEntry.builder(blockx).apply(CopyNbtLootFunction.builder((LootNbtProvider)ContextLootNbtProvider.BLOCK_ENTITY).withOperation("SkullOwner", "SkullOwner")))));
      });
      ...
      this.addDrop(Blocks.AZALEA_LEAVES, (blockx) -> {
         return leavesDrop(blockx, Blocks.AZALEA, SAPLING_DROP_CHANCE);
      });
      this.addDrop(Blocks.FLOWERING_AZALEA_LEAVES, (blockx) -> {
         return leavesDrop(blockx, Blocks.FLOWERING_AZALEA, SAPLING_DROP_CHANCE);
      });
      ...
      this.addDrop(Blocks.DEEPSLATE_COAL_ORE, (blockx) -> {
         return oreDrops(blockx, Items.COAL);
      });
      this.addDrop(Blocks.EMERALD_ORE, (blockx) -> {
         return oreDrops(blockx, Items.EMERALD);
      });
      this.addDrop(Blocks.DEEPSLATE_EMERALD_ORE, (blockx) -> {
         return oreDrops(blockx, Items.EMERALD);
      });
      ...
      this.addDrop(Blocks.DEEPSLATE_DIAMOND_ORE, (blockx) -> {
         return oreDrops(blockx, Items.DIAMOND);
      });
      ...
      this.addDrop(Blocks.IRON_ORE, (blockx) -> {
         return oreDrops(blockx, Items.RAW_IRON);
      });
      this.addDrop(Blocks.DEEPSLATE_IRON_ORE, (blockx) -> {
         return oreDrops(blockx, Items.RAW_IRON);
      });
      this.addDrop(Blocks.GOLD_ORE, (blockx) -> {
         return oreDrops(blockx, Items.RAW_GOLD);
      });
      this.addDrop(Blocks.DEEPSLATE_GOLD_ORE, (blockx) -> {
         return oreDrops(blockx, Items.RAW_GOLD);
      });
      this.addDrop(Blocks.NETHER_GOLD_ORE, (blockx) -> {
         return dropsWithSilkTouch(blockx, (LootPoolEntry.Builder)applyExplosionDecay(blockx, ItemEntry.builder(Items.GOLD_NUGGET).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(2.0F, 6.0F))).apply(ApplyBonusLootFunction.oreDrops(Enchantments.FORTUNE))));
      });
      ...
      this.addDrop(Blocks.DEAD_BUSH, (blockx) -> {
         return dropsWithShears(blockx, (LootPoolEntry.Builder)applyExplosionDecay(blockx, ItemEntry.builder(Items.STICK).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0F, 2.0F)))));
      });
      ...
      this.addDrop(Blocks.LARGE_FERN, (blockx) -> {
         return tallGrassDrops(blockx, Blocks.FERN);
      });
      this.addDrop(Blocks.TALL_GRASS, (blockx) -> {
         return tallGrassDrops(blockx, Blocks.GRASS);
      });
      ...
      this.addDrop(Blocks.CHORUS_FLOWER, (blockx) -> {
         return LootTable.builder().pool(LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0F)).with(((LeafEntry.Builder)addSurvivesExplosionCondition(blockx, ItemEntry.builder(blockx))).conditionally(EntityPropertiesLootCondition.create(LootContext.EntityTarget.THIS))));
      });
      ...
      this.addDrop(Blocks.MELON, (blockx) -> {
         return dropsWithSilkTouch(blockx, (LootPoolEntry.Builder)applyExplosionDecay(blockx, ItemEntry.builder(Items.MELON_SLICE).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(3.0F, 7.0F))).apply(ApplyBonusLootFunction.uniformBonusCount(Enchantments.FORTUNE)).apply(LimitCountLootFunction.builder(BoundedIntUnaryOperator.createMax(9)))));
      });
      ...
      this.addDrop(Blocks.NETHER_WART, (blockx) -> {
         return LootTable.builder().pool((LootPool.Builder)applyExplosionDecay(blockx, LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0F)).with(ItemEntry.builder(Items.NETHER_WART).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(2.0F, 4.0F)).conditionally(BlockStatePropertyLootCondition.builder(blockx).properties(StatePredicate.Builder.create().exactMatch(NetherWartBlock.AGE, 3)))).apply(ApplyBonusLootFunction.uniformBonusCount(Enchantments.FORTUNE).conditionally(BlockStatePropertyLootCondition.builder(blockx).properties(StatePredicate.Builder.create().exactMatch(NetherWartBlock.AGE, 3)))))));
      });
      this.addDrop(Blocks.SNOW, (blockx) -> {
         return LootTable.builder().pool(LootPool.builder().conditionally(EntityPropertiesLootCondition.create(LootContext.EntityTarget.THIS)).with(AlternativeEntry.builder(AlternativeEntry.builder(ItemEntry.builder(Items.SNOWBALL).conditionally(BlockStatePropertyLootCondition.builder(blockx).properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 1))), ((LeafEntry.Builder)ItemEntry.builder(Items.SNOWBALL).conditionally(BlockStatePropertyLootCondition.builder(blockx).properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 2)))).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(2.0F))), ((LeafEntry.Builder)ItemEntry.builder(Items.SNOWBALL).conditionally(BlockStatePropertyLootCondition.builder(blockx).properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 3)))).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(3.0F))), ((LeafEntry.Builder)ItemEntry.builder(Items.SNOWBALL).conditionally(BlockStatePropertyLootCondition.builder(blockx).properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 4)))).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(4.0F))), ((LeafEntry.Builder)ItemEntry.builder(Items.SNOWBALL).conditionally(BlockStatePropertyLootCondition.builder(blockx).properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 5)))).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(5.0F))), ((LeafEntry.Builder)ItemEntry.builder(Items.SNOWBALL).conditionally(BlockStatePropertyLootCondition.builder(blockx).properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 6)))).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(6.0F))), ((LeafEntry.Builder)ItemEntry.builder(Items.SNOWBALL).conditionally(BlockStatePropertyLootCondition.builder(blockx).properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 7)))).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(7.0F))), ItemEntry.builder(Items.SNOWBALL).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(8.0F)))).conditionally(WITHOUT_SILK_TOUCH), AlternativeEntry.builder(ItemEntry.builder(Blocks.SNOW).conditionally(BlockStatePropertyLootCondition.builder(blockx).properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 1))), ItemEntry.builder(Blocks.SNOW).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(2.0F))).conditionally(BlockStatePropertyLootCondition.builder(blockx).properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 2))), ItemEntry.builder(Blocks.SNOW).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(3.0F))).conditionally(BlockStatePropertyLootCondition.builder(blockx).properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 3))), ItemEntry.builder(Blocks.SNOW).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(4.0F))).conditionally(BlockStatePropertyLootCondition.builder(blockx).properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 4))), ItemEntry.builder(Blocks.SNOW).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(5.0F))).conditionally(BlockStatePropertyLootCondition.builder(blockx).properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 5))), ItemEntry.builder(Blocks.SNOW).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(6.0F))).conditionally(BlockStatePropertyLootCondition.builder(blockx).properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 6))), ItemEntry.builder(Blocks.SNOW).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(7.0F))).conditionally(BlockStatePropertyLootCondition.builder(blockx).properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 7))), ItemEntry.builder(Blocks.SNOW_BLOCK)))));
      });
      ...
      this.addDrop(Blocks.CAMPFIRE, (blockx) -> {
         return dropsWithSilkTouch(blockx, (LootPoolEntry.Builder)addSurvivesExplosionCondition(blockx, ItemEntry.builder(Items.CHARCOAL).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(2.0F)))));
      });
      this.addDrop(Blocks.GILDED_BLACKSTONE, (blockx) -> {
         return dropsWithSilkTouch(blockx, (LootPoolEntry.Builder)addSurvivesExplosionCondition(blockx, ((LeafEntry.Builder)ItemEntry.builder(Items.GOLD_NUGGET).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(2.0F, 5.0F))).conditionally(TableBonusLootCondition.builder(Enchantments.FORTUNE, 0.1F, 0.14285715F, 0.25F, 1.0F))).alternatively(ItemEntry.builder(blockx))));
      });
      this.addDrop(Blocks.SOUL_CAMPFIRE, (blockx) -> {
         return dropsWithSilkTouch(blockx, (LootPoolEntry.Builder)addSurvivesExplosionCondition(blockx, ItemEntry.builder(Items.SOUL_SOIL).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F)))));
      });
      this.addDrop(Blocks.AMETHYST_CLUSTER, (blockx) -> {
         return dropsWithSilkTouch(blockx, ((LeafEntry.Builder)ItemEntry.builder(Items.AMETHYST_SHARD).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(4.0F))).apply(ApplyBonusLootFunction.oreDrops(Enchantments.FORTUNE)).conditionally(MatchToolLootCondition.builder(ItemPredicate.Builder.create().tag(ItemTags.CLUSTER_MAX_HARVESTABLES)))).alternatively((LootPoolEntry.Builder)applyExplosionDecay(blockx, ItemEntry.builder(Items.AMETHYST_SHARD).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(2.0F))))));
      });
