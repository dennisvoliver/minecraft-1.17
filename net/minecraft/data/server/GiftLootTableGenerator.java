...
public class GiftLootTableGenerator implements Consumer<BiConsumer<Identifier, LootTable.Builder>> {
   public void accept(BiConsumer<Identifier, LootTable.Builder> biConsumer) {
      ...
      biConsumer.accept(LootTables.HERO_OF_THE_VILLAGE_FLETCHER_GIFT_GAMEPLAY, LootTable.builder().pool(LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0F)).with(ItemEntry.builder(Items.ARROW).weight(26)).with(ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0F, 1.0F))).apply(SetNbtLootFunction.builder((NbtCompound)Util.make(new NbtCompound(), (nbtCompound) -> {
         nbtCompound.putString("Potion", "minecraft:swiftness");
      })))).with(ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0F, 1.0F))).apply(SetNbtLootFunction.builder((NbtCompound)Util.make(new NbtCompound(), (nbtCompound) -> {
         nbtCompound.putString("Potion", "minecraft:slowness");
      })))).with(ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0F, 1.0F))).apply(SetNbtLootFunction.builder((NbtCompound)Util.make(new NbtCompound(), (nbtCompound) -> {
         nbtCompound.putString("Potion", "minecraft:strength");
      })))).with(ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0F, 1.0F))).apply(SetNbtLootFunction.builder((NbtCompound)Util.make(new NbtCompound(), (nbtCompound) -> {
         nbtCompound.putString("Potion", "minecraft:healing");
      })))).with(ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0F, 1.0F))).apply(SetNbtLootFunction.builder((NbtCompound)Util.make(new NbtCompound(), (nbtCompound) -> {
         nbtCompound.putString("Potion", "minecraft:harming");
      })))).with(ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0F, 1.0F))).apply(SetNbtLootFunction.builder((NbtCompound)Util.make(new NbtCompound(), (nbtCompound) -> {
         nbtCompound.putString("Potion", "minecraft:leaping");
      })))).with(ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0F, 1.0F))).apply(SetNbtLootFunction.builder((NbtCompound)Util.make(new NbtCompound(), (nbtCompound) -> {
         nbtCompound.putString("Potion", "minecraft:regeneration");
      })))).with(ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0F, 1.0F))).apply(SetNbtLootFunction.builder((NbtCompound)Util.make(new NbtCompound(), (nbtCompound) -> {
         nbtCompound.putString("Potion", "minecraft:fire_resistance");
      })))).with(ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0F, 1.0F))).apply(SetNbtLootFunction.builder((NbtCompound)Util.make(new NbtCompound(), (nbtCompound) -> {
         nbtCompound.putString("Potion", "minecraft:water_breathing");
      })))).with(ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0F, 1.0F))).apply(SetNbtLootFunction.builder((NbtCompound)Util.make(new NbtCompound(), (nbtCompound) -> {
         nbtCompound.putString("Potion", "minecraft:invisibility");
      })))).with(ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0F, 1.0F))).apply(SetNbtLootFunction.builder((NbtCompound)Util.make(new NbtCompound(), (nbtCompound) -> {
         nbtCompound.putString("Potion", "minecraft:night_vision");
      })))).with(ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0F, 1.0F))).apply(SetNbtLootFunction.builder((NbtCompound)Util.make(new NbtCompound(), (nbtCompound) -> {
         nbtCompound.putString("Potion", "minecraft:weakness");
      })))).with(ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0F, 1.0F))).apply(SetNbtLootFunction.builder((NbtCompound)Util.make(new NbtCompound(), (nbtCompound) -> {
         nbtCompound.putString("Potion", "minecraft:poison");
      }))))));
