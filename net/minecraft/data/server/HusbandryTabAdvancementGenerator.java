...
public class HusbandryTabAdvancementGenerator implements Consumer<Consumer<Advancement>> {
   ...
   private static final Item[] field_33964;
   ...
   public void accept(Consumer<Advancement> consumer) {
      ...
      Advancement advancement6 = this.requireListedFishBucketsFilled(Advancement.Task.create()).parent(advancement5).criteriaMerger(CriterionMerger.OR).display((ItemConvertible)Items.PUFFERFISH_BUCKET, new TranslatableText("advancements.husbandry.tactical_fishing.title"), new TranslatableText("advancements.husbandry.tactical_fishing.description"), (Identifier)null, AdvancementFrame.TASK, true, true, false).build(consumer, "husbandry/tactical_fishing");
      Advancement advancement7 = Advancement.Task.create().parent(advancement6).criteriaMerger(CriterionMerger.OR).criterion(Registry.ITEM.getId(Items.AXOLOTL_BUCKET).getPath(), (CriterionConditions)FilledBucketCriterion.Conditions.create(ItemPredicate.Builder.create().items(Items.AXOLOTL_BUCKET).build())).display((ItemConvertible)Items.AXOLOTL_BUCKET, new TranslatableText("advancements.husbandry.axolotl_in_a_bucket.title"), new TranslatableText("advancements.husbandry.axolotl_in_a_bucket.description"), (Identifier)null, AdvancementFrame.TASK, true, true, false).build(consumer, "husbandry/axolotl_in_a_bucket");
      Advancement.Task.create().parent(advancement7).criterion("kill_axolotl_target", (CriterionConditions)EffectsChangedCriterion.Conditions.create(EntityPredicate.Builder.create().type(EntityType.AXOLOTL).build())).display((ItemConvertible)Items.TROPICAL_FISH_BUCKET, new TranslatableText("advancements.husbandry.kill_axolotl_target.title"), new TranslatableText("advancements.husbandry.kill_axolotl_target.description"), (Identifier)null, AdvancementFrame.TASK, true, true, false).build(consumer, "husbandry/kill_axolotl_target");
      ...
      Advancement advancement8 = Advancement.Task.create().parent(advancement).criterion("safely_harvest_honey", (CriterionConditions)ItemUsedOnBlockCriterion.Conditions.create(LocationPredicate.Builder.create().block(BlockPredicate.Builder.create().tag(BlockTags.BEEHIVES).build()).smokey(true), ItemPredicate.Builder.create().items(Items.GLASS_BOTTLE))).display((ItemConvertible)Items.HONEY_BOTTLE, new TranslatableText("advancements.husbandry.safely_harvest_honey.title"), new TranslatableText("advancements.husbandry.safely_harvest_honey.description"), (Identifier)null, AdvancementFrame.TASK, true, true, false).build(consumer, "husbandry/safely_harvest_honey");
      Advancement advancement9 = Advancement.Task.create().parent(advancement8).display((ItemConvertible)Items.HONEYCOMB, new TranslatableText("advancements.husbandry.wax_on.title"), new TranslatableText("advancements.husbandry.wax_on.description"), (Identifier)null, AdvancementFrame.TASK, true, true, false).criterion("wax_on", (CriterionConditions)ItemUsedOnBlockCriterion.Conditions.create(LocationPredicate.Builder.create().block(BlockPredicate.Builder.create().blocks((Iterable)((BiMap)HoneycombItem.UNWAXED_TO_WAXED_BLOCKS.get()).keySet()).build()), ItemPredicate.Builder.create().items(Items.HONEYCOMB))).build(consumer, "husbandry/wax_on");
      Advancement.Task.create().parent(advancement9).display((ItemConvertible)Items.STONE_AXE, new TranslatableText("advancements.husbandry.wax_off.title"), new TranslatableText("advancements.husbandry.wax_off.description"), (Identifier)null, AdvancementFrame.TASK, true, true, false).criterion("wax_off", (CriterionConditions)ItemUsedOnBlockCriterion.Conditions.create(LocationPredicate.Builder.create().block(BlockPredicate.Builder.create().blocks((Iterable)((BiMap)HoneycombItem.WAXED_TO_UNWAXED_BLOCKS.get()).keySet()).build()), ItemPredicate.Builder.create().items(field_33964))).build(consumer, "husbandry/wax_off");
      ...
      Advancement.Task.create().parent(advancement).display((ItemConvertible)Items.OAK_BOAT, new TranslatableText("advancements.husbandry.ride_a_boat_with_a_goat.title"), new TranslatableText("advancements.husbandry.ride_a_boat_with_a_goat.description"), (Identifier)null, AdvancementFrame.TASK, true, true, false).criterion("ride_a_boat_with_a_goat", (CriterionConditions)StartedRidingCriterion.Conditions.create(EntityPredicate.Builder.create().vehicle(EntityPredicate.Builder.create().type(EntityType.BOAT).passenger(EntityPredicate.Builder.create().type(EntityType.GOAT).build()).build()))).build(consumer, "husbandry/ride_a_boat_with_a_goat");
      Advancement.Task.create().parent(advancement).display((ItemConvertible)Items.GLOW_INK_SAC, new TranslatableText("advancements.husbandry.make_a_sign_glow.title"), new TranslatableText("advancements.husbandry.make_a_sign_glow.description"), (Identifier)null, AdvancementFrame.TASK, true, true, false).criterion("make_a_sign_glow", (CriterionConditions)ItemUsedOnBlockCriterion.Conditions.create(LocationPredicate.Builder.create().block(BlockPredicate.Builder.create().tag(BlockTags.SIGNS).build()), ItemPredicate.Builder.create().items(Items.GLOW_INK_SAC))).build(consumer, "husbandry/make_a_sign_glow");
   }
   ...
   private Advancement.Task requireListedAnimalsBred(Advancement.Task task) {
      ...
      task.criterion(EntityType.getId(EntityType.TURTLE).toString(), (CriterionConditions)BredAnimalsCriterion.Conditions.create(EntityPredicate.Builder.create().type(EntityType.TURTLE).build(), EntityPredicate.Builder.create().type(EntityType.TURTLE).build(), EntityPredicate.ANY));
      return task;
   }
   ...
   private Advancement.Task requireListedFishBucketsFilled(Advancement.Task task) {
      ...
      for(int var4 = 0; var4 < var3; ++var4) {
         Item item = var2[var4];
         task.criterion(Registry.ITEM.getId(item).getPath(), (CriterionConditions)FilledBucketCriterion.Conditions.create(ItemPredicate.Builder.create().items(item).build()));
      }
   ...
   private Advancement.Task requireListedFishCaught(Advancement.Task task) {
      ...
      for(int var4 = 0; var4 < var3; ++var4) {
         Item item = var2[var4];
         task.criterion(Registry.ITEM.getId(item).getPath(), (CriterionConditions)FishingRodHookedCriterion.Conditions.create(ItemPredicate.ANY, EntityPredicate.ANY, ItemPredicate.Builder.create().items(item).build()));
      }
   ...
   static {
      ...
      field_33964 = new Item[]{Items.WOODEN_AXE, Items.GOLDEN_AXE, Items.STONE_AXE, Items.IRON_AXE, Items.DIAMOND_AXE, Items.NETHERITE_AXE};
   }
}
