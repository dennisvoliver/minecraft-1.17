...
public abstract class BlockStateVariantMap {
   ...
   public static class QuintupleProperty<T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>, T4 extends Comparable<T4>, T5 extends Comparable<T5>> extends BlockStateVariantMap {
      ...
      public BlockStateVariantMap.QuintupleProperty<T1, T2, T3, T4, T5> register(T1 firstValue, T2 secondValue, T3 thirdValue, T4 fourthValue, T5 fifthValue, List<BlockStateVariant> variants) {
      ...
      public BlockStateVariantMap.QuintupleProperty<T1, T2, T3, T4, T5> register(T1 firstValue, T2 secondValue, T3 thirdValue, T4 fourthValue, T5 fifthValue, BlockStateVariant variant) {
