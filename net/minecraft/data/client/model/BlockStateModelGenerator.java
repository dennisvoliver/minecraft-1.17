...
public class BlockStateModelGenerator {
   ...
   final Map<Block, TexturedModel> sandstoneModels;
   static final Map<BlockFamily.Variant, BiConsumer<BlockStateModelGenerator.BlockTexturePool, Block>> VARIANT_POOL_FUNCTIONS;
   /**
    ...
    */
   public static final Map<BooleanProperty, Function<Identifier, BlockStateVariant>> CONNECTION_VARIANT_FUNCTIONS;
   ...
   public BlockStateModelGenerator(Consumer<BlockStateSupplier> blockStateCollector, BiConsumer<Identifier, Supplier<JsonElement>> modelCollector, Consumer<Item> simpleItemModelExemptionCollector) {
      ...
      this.stoneStateFactories = ImmutableMap.builder().put(Blocks.STONE, BlockStateModelGenerator::createStoneState).put(Blocks.DEEPSLATE, BlockStateModelGenerator::createDeepslateState).build();
      this.sandstoneModels = ImmutableMap.builder().put(Blocks.SANDSTONE, TexturedModel.SIDE_TOP_BOTTOM_WALL.get(Blocks.SANDSTONE)).put(Blocks.RED_SANDSTONE, TexturedModel.SIDE_TOP_BOTTOM_WALL.get(Blocks.RED_SANDSTONE)).put(Blocks.SMOOTH_SANDSTONE, TexturedModel.getCubeAll(Texture.getSubId(Blocks.SANDSTONE, "_top"))).put(Blocks.SMOOTH_RED_SANDSTONE, TexturedModel.getCubeAll(Texture.getSubId(Blocks.RED_SANDSTONE, "_top"))).put(Blocks.CUT_SANDSTONE, TexturedModel.CUBE_COLUMN.get(Blocks.SANDSTONE).texture((texture) -> {
   ...
   private void registerBigDripleaf() {
      ...
      this.blockStateCollector.accept(VariantsBlockStateSupplier.create(Blocks.BIG_DRIPLEAF).coordinate(createNorthDefaultHorizontalRotationStates()).coordinate(BlockStateVariantMap.create(Properties.TILT).register(Tilt.NONE, (BlockStateVariant)BlockStateVariant.create().put(VariantSettings.MODEL, identifier)).register(Tilt.UNSTABLE, (BlockStateVariant)BlockStateVariant.create().put(VariantSettings.MODEL, identifier)).register(Tilt.PARTIAL, (BlockStateVariant)BlockStateVariant.create().put(VariantSettings.MODEL, identifier2)).register(Tilt.FULL, (BlockStateVariant)BlockStateVariant.create().put(VariantSettings.MODEL, identifier3))));
   }
   ...
   private void registerCauldron() {
      ...
      this.blockStateCollector.accept(createSingletonBlockState(Blocks.LAVA_CAULDRON, Models.TEMPLATE_CAULDRON_FULL.upload(Blocks.LAVA_CAULDRON, Texture.cauldron(Texture.getSubId(Blocks.LAVA, "_still")), this.modelCollector)));
      this.blockStateCollector.accept(VariantsBlockStateSupplier.create(Blocks.WATER_CAULDRON).coordinate(BlockStateVariantMap.create(LeveledCauldronBlock.LEVEL).register(1, (BlockStateVariant)BlockStateVariant.create().put(VariantSettings.MODEL, Models.TEMPLATE_CAULDRON_LEVEL1.upload(Blocks.WATER_CAULDRON, "_level1", Texture.cauldron(Texture.getSubId(Blocks.WATER, "_still")), this.modelCollector))).register(2, (BlockStateVariant)BlockStateVariant.create().put(VariantSettings.MODEL, Models.TEMPLATE_CAULDRON_LEVEL2.upload(Blocks.WATER_CAULDRON, "_level2", Texture.cauldron(Texture.getSubId(Blocks.WATER, "_still")), this.modelCollector))).register(3, (BlockStateVariant)BlockStateVariant.create().put(VariantSettings.MODEL, Models.TEMPLATE_CAULDRON_FULL.upload(Blocks.WATER_CAULDRON, "_full", Texture.cauldron(Texture.getSubId(Blocks.WATER, "_still")), this.modelCollector)))));
      this.blockStateCollector.accept(VariantsBlockStateSupplier.create(Blocks.POWDER_SNOW_CAULDRON).coordinate(BlockStateVariantMap.create(LeveledCauldronBlock.LEVEL).register(1, (BlockStateVariant)BlockStateVariant.create().put(VariantSettings.MODEL, Models.TEMPLATE_CAULDRON_LEVEL1.upload(Blocks.POWDER_SNOW_CAULDRON, "_level1", Texture.cauldron(Texture.getId(Blocks.POWDER_SNOW)), this.modelCollector))).register(2, (BlockStateVariant)BlockStateVariant.create().put(VariantSettings.MODEL, Models.TEMPLATE_CAULDRON_LEVEL2.upload(Blocks.POWDER_SNOW_CAULDRON, "_level2", Texture.cauldron(Texture.getId(Blocks.POWDER_SNOW)), this.modelCollector))).register(3, (BlockStateVariant)BlockStateVariant.create().put(VariantSettings.MODEL, Models.TEMPLATE_CAULDRON_FULL.upload(Blocks.POWDER_SNOW_CAULDRON, "_full", Texture.cauldron(Texture.getId(Blocks.POWDER_SNOW)), this.modelCollector)))));
   }
   ...
   private void registerPointedDripstone() {
      ...
      for(var4 = 0; var4 < var3; ++var4) {
         thickness2 = var2[var4];
         doubleProperty.register(Direction.UP, thickness2, (BlockStateVariant)this.getDripstoneVariant(Direction.UP, thickness2));
      }
      ...
      for(var4 = 0; var4 < var3; ++var4) {
         thickness2 = var2[var4];
         doubleProperty.register(Direction.DOWN, thickness2, (BlockStateVariant)this.getDripstoneVariant(Direction.DOWN, thickness2));
      }
   ...
   private void registerSculkSensor() {
      ...
      this.blockStateCollector.accept(VariantsBlockStateSupplier.create(Blocks.SCULK_SENSOR).coordinate(BlockStateVariantMap.create(Properties.SCULK_SENSOR_PHASE).register((sculkSensorPhase) -> {
         return BlockStateVariant.create().put(VariantSettings.MODEL, sculkSensorPhase == SculkSensorPhase.ACTIVE ? identifier2 : identifier);
      })));
   }
   ...
   private void registerTripwireHook() {
      ...
      this.blockStateCollector.accept(VariantsBlockStateSupplier.create(Blocks.TRIPWIRE_HOOK).coordinate(BlockStateVariantMap.create(Properties.ATTACHED, Properties.POWERED).register((boolean_, boolean2) -> {
         ...
         return var10000.put(var10001, Texture.getSubId(var10002, var10003 + (boolean2 ? "_on" : "")));
   ...
   private void registerWallPlant(Block block) {
      ...
      When.PropertyCondition propertyCondition = (When.PropertyCondition)Util.make(When.create(), (propertyConditionx) -> {
         CONNECTION_VARIANT_FUNCTIONS.forEach((booleanProperty, function) -> {
            if (block.getDefaultState().contains(booleanProperty)) {
               propertyConditionx.set(booleanProperty, (Comparable)false);
            }
      ...
      CONNECTION_VARIANT_FUNCTIONS.forEach((booleanProperty, function) -> {
         if (block.getDefaultState().contains(booleanProperty)) {
            multipartBlockStateSupplier.with(When.create().set(booleanProperty, (Comparable)true), (BlockStateVariant)((BlockStateVariant)function.apply(identifier)));
            multipartBlockStateSupplier.with(propertyCondition, (BlockStateVariant)((BlockStateVariant)function.apply(identifier)));
         }
   ...
   public void register() {
      BlockFamilies.getFamilies().filter(BlockFamily::shouldGenerateModels).forEach((blockFamily) -> {
         this.registerCubeAllModelTexturePool(blockFamily.getBaseBlock()).family(blockFamily);
      });
   ...
   private void registerCandle(Block candle, Block block) {
      ...
      this.blockStateCollector.accept(VariantsBlockStateSupplier.create(candle).coordinate(BlockStateVariantMap.create(Properties.CANDLES, Properties.LIT).register(1, false, (BlockStateVariant)BlockStateVariant.create().put(VariantSettings.MODEL, identifier)).register(2, false, (BlockStateVariant)BlockStateVariant.create().put(VariantSettings.MODEL, identifier2)).register(3, false, (BlockStateVariant)BlockStateVariant.create().put(VariantSettings.MODEL, identifier3)).register(4, false, (BlockStateVariant)BlockStateVariant.create().put(VariantSettings.MODEL, identifier4)).register(1, true, (BlockStateVariant)BlockStateVariant.create().put(VariantSettings.MODEL, identifier5)).register(2, true, (BlockStateVariant)BlockStateVariant.create().put(VariantSettings.MODEL, identifier6)).register(3, true, (BlockStateVariant)BlockStateVariant.create().put(VariantSettings.MODEL, identifier7)).register(4, true, (BlockStateVariant)BlockStateVariant.create().put(VariantSettings.MODEL, identifier8))));
   ...
   static {
      VARIANT_POOL_FUNCTIONS = ImmutableMap.builder().put(BlockFamily.Variant.BUTTON, BlockStateModelGenerator.BlockTexturePool::button).put(BlockFamily.Variant.DOOR, BlockStateModelGenerator.BlockTexturePool::door).put(BlockFamily.Variant.CHISELED, BlockStateModelGenerator.BlockTexturePool::sandstone).put(BlockFamily.Variant.CRACKED, BlockStateModelGenerator.BlockTexturePool::sandstone).put(BlockFamily.Variant.FENCE, BlockStateModelGenerator.BlockTexturePool::fence).put(BlockFamily.Variant.FENCE_GATE, BlockStateModelGenerator.BlockTexturePool::fenceGate).put(BlockFamily.Variant.SIGN, BlockStateModelGenerator.BlockTexturePool::sign).put(BlockFamily.Variant.SLAB, BlockStateModelGenerator.BlockTexturePool::slab).put(BlockFamily.Variant.STAIRS, BlockStateModelGenerator.BlockTexturePool::stairs).put(BlockFamily.Variant.PRESSURE_PLATE, BlockStateModelGenerator.BlockTexturePool::pressurePlate).put(BlockFamily.Variant.TRAPDOOR, BlockStateModelGenerator.BlockTexturePool::registerTrapdoor).put(BlockFamily.Variant.WALL, BlockStateModelGenerator.BlockTexturePool::wall).build();
      CONNECTION_VARIANT_FUNCTIONS = (Map)Util.make(Maps.newHashMap(), (hashMap) -> {
         hashMap.put(Properties.NORTH, (identifier) -> {
            return BlockStateVariant.create().put(VariantSettings.MODEL, identifier);
         });
         hashMap.put(Properties.EAST, (identifier) -> {
            return BlockStateVariant.create().put(VariantSettings.MODEL, identifier).put(VariantSettings.Y, VariantSettings.Rotation.R90).put(VariantSettings.UVLOCK, true);
         });
         hashMap.put(Properties.SOUTH, (identifier) -> {
            return BlockStateVariant.create().put(VariantSettings.MODEL, identifier).put(VariantSettings.Y, VariantSettings.Rotation.R180).put(VariantSettings.UVLOCK, true);
         });
         hashMap.put(Properties.WEST, (identifier) -> {
            return BlockStateVariant.create().put(VariantSettings.MODEL, identifier).put(VariantSettings.Y, VariantSettings.Rotation.R270).put(VariantSettings.UVLOCK, true);
         });
         hashMap.put(Properties.UP, (identifier) -> {
            return BlockStateVariant.create().put(VariantSettings.MODEL, identifier).put(VariantSettings.X, VariantSettings.Rotation.R270).put(VariantSettings.UVLOCK, true);
         });
         hashMap.put(Properties.DOWN, (identifier) -> {
            return BlockStateVariant.create().put(VariantSettings.MODEL, identifier).put(VariantSettings.X, VariantSettings.Rotation.R90).put(VariantSettings.UVLOCK, true);
         });
      });
   }
   ...
   class BlockTexturePool {
      ...
      public BlockStateModelGenerator.BlockTexturePool base(Block block, Model model) {
         ...
         if (BlockStateModelGenerator.this.stoneStateFactories.containsKey(block)) {
            BlockStateModelGenerator.this.blockStateCollector.accept(((BlockStateModelGenerator.StateFactory)BlockStateModelGenerator.this.stoneStateFactories.get(block)).create(block, this.baseModelId, this.texture, BlockStateModelGenerator.this.modelCollector));
         } else {
      ...
      private Identifier ensureModel(Model model, Block block) {
         return (Identifier)this.knownModels.computeIfAbsent(model, (newModel) -> {
            return newModel.upload(block, this.texture, BlockStateModelGenerator.this.modelCollector);
         });
      }
      ...
      public BlockStateModelGenerator.BlockTexturePool family(BlockFamily family) {
         ...
         family.getVariants().forEach((variant, block) -> {
            BiConsumer<BlockStateModelGenerator.BlockTexturePool, Block> biConsumer = (BiConsumer)BlockStateModelGenerator.VARIANT_POOL_FUNCTIONS.get(variant);
            if (biConsumer != null) {
