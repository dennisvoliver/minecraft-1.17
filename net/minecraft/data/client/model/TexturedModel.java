...
public class TexturedModel {
   ...
   static {
      ...
      SIDE_TOP_BOTTOM_WALL = makeFactory(Texture::wallSideTopBottom, Models.CUBE_BOTTOM_TOP);
      SIDE_END_WALL = makeFactory(Texture::wallSideEnd, Models.CUBE_COLUMN);
   }
   ...
   public interface Factory {
      ...
      default TexturedModel.Factory andThen(Consumer<Texture> consumer) {
         return (block) -> {
            return this.get(block).texture(consumer);
         };
      }
   }
}
