...
public class Texture {
   ...
   public static Texture candleCake(Block block, boolean bl) {
      return (new Texture()).put(TextureKey.PARTICLE, getSubId(Blocks.CAKE, "_side")).put(TextureKey.BOTTOM, getSubId(Blocks.CAKE, "_bottom")).put(TextureKey.TOP, getSubId(Blocks.CAKE, "_top")).put(TextureKey.SIDE, getSubId(Blocks.CAKE, "_side")).put(TextureKey.CANDLE, getSubId(block, bl ? "_lit" : ""));
   }

   public static Texture cauldron(Identifier content) {
      return (new Texture()).put(TextureKey.PARTICLE, getSubId(Blocks.CAULDRON, "_side")).put(TextureKey.SIDE, getSubId(Blocks.CAULDRON, "_side")).put(TextureKey.TOP, getSubId(Blocks.CAULDRON, "_top")).put(TextureKey.BOTTOM, getSubId(Blocks.CAULDRON, "_bottom")).put(TextureKey.INSIDE, getSubId(Blocks.CAULDRON, "_inner")).put(TextureKey.CONTENT, content);
   }
   ...
   public static Identifier getSubId(Block block, String suffix) {
      ...
      String var10003 = identifier.getPath();
      return new Identifier(var10002, "block/" + var10003 + suffix);
   }
   ...
   public static Identifier getSubId(Item item, String suffix) {
      ...
      String var10002 = identifier.getNamespace();
      String var10003 = identifier.getPath();
      return new Identifier(var10002, "item/" + var10003 + suffix);
   }
}
