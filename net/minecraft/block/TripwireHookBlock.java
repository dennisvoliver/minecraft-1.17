...
public class TripwireHookBlock extends Block {
   ...
   public void update(World world, BlockPos pos, BlockState state, boolean beingRemoved, boolean bl, int i, @Nullable BlockState blockState) {
      ...
      if (j > 0) {
         ...
         Direction direction2 = direction.getOpposite();
         world.setBlockState(blockPos2, (BlockState)blockState3.with(FACING, direction2), Block.NOTIFY_ALL);
      ...
      if (bl2 != bl4) {
         for(int l = 1; l < j; ++l) {
            ...
            if (blockState4 != null) {
               world.setBlockState(blockPos3, (BlockState)blockState4.with(ATTACHED, bl4), Block.NOTIFY_ALL);
