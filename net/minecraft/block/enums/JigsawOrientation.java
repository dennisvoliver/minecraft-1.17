...
public enum JigsawOrientation implements StringIdentifiable {
   ...
   private static final Int2ObjectMap<JigsawOrientation> BY_INDEX = (Int2ObjectMap)Util.make(new Int2ObjectOpenHashMap(values().length), (int2ObjectOpenHashMap) -> {
      JigsawOrientation[] var1 = values();
      int var2 = var1.length;

      for(int var3 = 0; var3 < var2; ++var3) {
         JigsawOrientation jigsawOrientation = var1[var3];
