...
public class TrapdoorBlock extends HorizontalFacingBlock implements Waterloggable {
   ...
   protected void playToggleSound(@Nullable PlayerEntity player, World world, BlockPos pos, boolean open) {
      int i;
      if (open) {
         i = this.material == Material.METAL ? WorldEvents.IRON_TRAPDOOR_OPENS : WorldEvents.WOODEN_TRAPDOOR_OPENS;
         world.syncWorldEvent(player, i, pos, 0);
      } else {
         i = this.material == Material.METAL ? WorldEvents.IRON_TRAPDOOR_CLOSES : WorldEvents.WOODEN_TRAPDOOR_CLOSES;
         world.syncWorldEvent(player, i, pos, 0);
      }
