...
public class LecternBlock extends BlockWithEntity {
   ...
   static {
      ...
      EAST_SHAPE = VoxelShapes.union(Block.createCuboidShape(10.666667D, 10.0D, 0.0D, 15.0D, 14.0D, 16.0D), Block.createCuboidShape(6.333333D, 12.0D, 0.0D, 10.666667D, 16.0D, 16.0D), Block.createCuboidShape(2.0D, 14.0D, 0.0D, 6.333333D, 18.0D, 16.0D), BASE_SHAPE);
      SOUTH_SHAPE = VoxelShapes.union(Block.createCuboidShape(0.0D, 10.0D, 10.666667D, 16.0D, 14.0D, 15.0D), Block.createCuboidShape(0.0D, 12.0D, 6.333333D, 16.0D, 16.0D, 10.666667D), Block.createCuboidShape(0.0D, 14.0D, 2.0D, 16.0D, 18.0D, 6.333333D), BASE_SHAPE);
   }
}
