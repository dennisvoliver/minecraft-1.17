...
public class BeehiveBlockEntity extends BlockEntity {
   ...
   private static boolean releaseBee(World world, BlockPos pos, BlockState state, BeehiveBlockEntity.Bee bee, @Nullable List<Entity> entities, BeehiveBlockEntity.BeeState beeState, @Nullable BlockPos flowerPos) {
   ...
   private static void tickBees(World world, BlockPos pos, BlockState state, List<BeehiveBlockEntity.Bee> bees, @Nullable BlockPos flowerPos) {
      ...
      for(Iterator iterator = bees.iterator(); iterator.hasNext(); ++bee.ticksInHive) {
         ...
         if (bee.ticksInHive > bee.minOccupationTicks) {
            ...
            if (releaseBee(world, pos, state, bee, (List)null, beeState, flowerPos)) {
               iterator.remove();
            }
         }
      }
   ...
   public static void serverTick(World world, BlockPos pos, BlockState state, BeehiveBlockEntity blockEntity) {
      ...
      if (!blockEntity.bees.isEmpty() && world.getRandom().nextDouble() < 0.005D) {
