...
public class JigsawBlockEntity extends BlockEntity {
   ...
   public void readNbt(NbtCompound nbt) {
      ...
      this.joint = (JigsawBlockEntity.Joint)JigsawBlockEntity.Joint.byName(nbt.getString("joint")).orElseGet(() -> {
   ...
   public void generate(ServerWorld world, int maxDepth, boolean keepJigsaws) {
      ...
      structure.saveFromWorld(world, blockPos, new Vec3i(1, 1, 1), false, (Block)null);
