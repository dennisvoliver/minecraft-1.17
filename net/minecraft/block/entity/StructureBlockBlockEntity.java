...
public class StructureBlockBlockEntity extends BlockEntity {
   ...
   public void readNbt(NbtCompound nbt) {
      ...
      int i = MathHelper.clamp((int)nbt.getInt("posX"), (int)-48, (int)48);
      int j = MathHelper.clamp((int)nbt.getInt("posY"), (int)-48, (int)48);
      int k = MathHelper.clamp((int)nbt.getInt("posZ"), (int)-48, (int)48);
      this.offset = new BlockPos(i, j, k);
      int l = MathHelper.clamp((int)nbt.getInt("sizeX"), (int)0, (int)48);
      int m = MathHelper.clamp((int)nbt.getInt("sizeY"), (int)0, (int)48);
      int n = MathHelper.clamp((int)nbt.getInt("sizeZ"), (int)0, (int)48);
   ...
   private Stream<BlockPos> streamCornerPos(BlockPos start, BlockPos end) {
      ...
      return var10000.map(var10001::getBlockEntity).filter((blockEntity) -> {
         ...
         return blockEntity.mode == StructureBlockMode.CORNER && Objects.equals(this.structureName, blockEntity.structureName);
   ...
   public boolean loadStructure(ServerWorld world, boolean bl) {
      if (this.mode == StructureBlockMode.LOAD && this.structureName != null) {
         ...
         Optional optional2;
         try {
            optional2 = structureManager.getStructure(this.structureName);
         } catch (InvalidIdentifierException var6) {
            return false;
         }

         return !optional2.isPresent() ? false : this.place(world, bl, (Structure)optional2.get());
      } else {
         return false;
      }
   }
