...
public abstract class BlockEntity {
   ...
   public static BlockEntity createFromNbt(BlockPos pos, BlockState state, NbtCompound nbt) {
      ...
      if (identifier == null) {
         LOGGER.error((String)"Block entity has invalid type: {}", (Object)string);
         return null;
      } else {
         return (BlockEntity)Registry.BLOCK_ENTITY_TYPE.getOrEmpty(identifier).map((blockEntityType) -> {
            try {
               ...
               LOGGER.error((String)"Failed to create block entity {}", (Object)string, (Object)var5);
               return null;
            }
         }).map((blockEntity) -> {
            try {
               ...
               LOGGER.error((String)"Failed to load data for block entity {}", (Object)string, (Object)var4);
               return null;
            }
         }).orElseGet(() -> {
   ...
   public void populateCrashReport(CrashReportSection crashReportSection) {
      crashReportSection.add("Name", () -> {
         Identifier var10000 = Registry.BLOCK_ENTITY_TYPE.getId(this.getType());
