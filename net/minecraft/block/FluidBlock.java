...
public class FluidBlock extends Block implements FluidDrainable {
   ...
   public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
      return context.isAbove(COLLISION_SHAPE, pos, true) && (Integer)state.get(LEVEL) == 0 && context.canWalkOnFluid(world.getFluidState(pos.up()), this.fluid) ? COLLISION_SHAPE : VoxelShapes.empty();
   }
