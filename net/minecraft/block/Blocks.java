...
public class Blocks {
   ...
   private static Block createNetherStemBlock(MapColor mapColor) {
      return new PillarBlock(AbstractBlock.Settings.of(Material.NETHER_WOOD, (state) -> {
         return mapColor;
   ...
   static {
      ...
      RED_MUSHROOM = register("red_mushroom", new MushroomPlantBlock(AbstractBlock.Settings.of(Material.PLANT, MapColor.RED).noCollision().ticksRandomly().breakInstantly().sounds(BlockSoundGroup.GRASS).postProcess(Blocks::always), () -> {
      ...
      IRON_BLOCK = register("iron_block", new Block(AbstractBlock.Settings.of(Material.METAL, MapColor.IRON_GRAY).requiresTool().strength(5.0F, 6.0F).sounds(BlockSoundGroup.METAL)));
      ...
      TORCH = register("torch", new TorchBlock(AbstractBlock.Settings.of(Material.DECORATION).noCollision().breakInstantly().luminance((state) -> {
         return 14;
      }).sounds(BlockSoundGroup.WOOD), ParticleTypes.FLAME));
      WALL_TORCH = register("wall_torch", new WallTorchBlock(AbstractBlock.Settings.of(Material.DECORATION).noCollision().breakInstantly().luminance((state) -> {
         return 14;
      }).sounds(BlockSoundGroup.WOOD).dropsLike(TORCH), ParticleTypes.FLAME));
      FIRE = register("fire", new FireBlock(AbstractBlock.Settings.of(Material.FIRE, MapColor.BRIGHT_RED).noCollision().breakInstantly().luminance((state) -> {
         return 15;
      }).sounds(BlockSoundGroup.WOOL)));
      SOUL_FIRE = register("soul_fire", new SoulFireBlock(AbstractBlock.Settings.of(Material.FIRE, MapColor.LIGHT_BLUE).noCollision().breakInstantly().luminance((state) -> {
         return 10;
      }).sounds(BlockSoundGroup.WOOL)));
      ...
      CONDUIT = register("conduit", new ConduitBlock(AbstractBlock.Settings.of(Material.GLASS, MapColor.DIAMOND_BLUE).strength(3.0F).luminance((blockStatex) -> {
         return 15;
      }).nonOpaque()));
      ...
      BAMBOO = register("bamboo", new BambooBlock(AbstractBlock.Settings.of(Material.BAMBOO, MapColor.DARK_GREEN).ticksRandomly().breakInstantly().strength(1.0F).sounds(BlockSoundGroup.BAMBOO).nonOpaque().dynamicBounds()));
      ...
      SHROOMLIGHT = register("shroomlight", new Block(AbstractBlock.Settings.of(Material.SOLID_ORGANIC, MapColor.RED).strength(1.0F).sounds(BlockSoundGroup.SHROOMLIGHT).luminance((blockStatex) -> {
         return 15;
      })));
      ...
      SMALL_AMETHYST_BUD = register("small_amethyst_bud", new AmethystClusterBlock(3, 4, AbstractBlock.Settings.copy(AMETHYST_CLUSTER).sounds(BlockSoundGroup.SMALL_AMETHYST_BUD).luminance((blockStatex) -> {
         return 1;
      })));
      ...
      SCULK_SENSOR = register("sculk_sensor", new SculkSensorBlock(AbstractBlock.Settings.of(Material.SCULK, MapColor.CYAN).strength(1.5F).sounds(BlockSoundGroup.SCULK_SENSOR).luminance((blockStatex) -> {
         return 1;
      }).emissiveLighting((state, world, pos) -> {
         return SculkSensorBlock.getPhase(state) == SculkSensorPhase.ACTIVE;
      }), 8));
      OXIDIZED_COPPER = register("oxidized_copper", new OxidizableBlock(Oxidizable.OxidizationLevel.OXIDIZED, AbstractBlock.Settings.of(Material.METAL, MapColor.TEAL).requiresTool().strength(3.0F, 6.0F).sounds(BlockSoundGroup.COPPER)));
      WEATHERED_COPPER = register("weathered_copper", new OxidizableBlock(Oxidizable.OxidizationLevel.WEATHERED, AbstractBlock.Settings.of(Material.METAL, MapColor.DARK_AQUA).requiresTool().strength(3.0F, 6.0F).sounds(BlockSoundGroup.COPPER)));
      EXPOSED_COPPER = register("exposed_copper", new OxidizableBlock(Oxidizable.OxidizationLevel.EXPOSED, AbstractBlock.Settings.of(Material.METAL, MapColor.TERRACOTTA_LIGHT_GRAY).requiresTool().strength(3.0F, 6.0F).sounds(BlockSoundGroup.COPPER)));
      COPPER_BLOCK = register("copper_block", new OxidizableBlock(Oxidizable.OxidizationLevel.UNAFFECTED, AbstractBlock.Settings.of(Material.METAL, MapColor.ORANGE).requiresTool().strength(3.0F, 6.0F).sounds(BlockSoundGroup.COPPER)));
      ...
      OXIDIZED_CUT_COPPER = register("oxidized_cut_copper", new OxidizableBlock(Oxidizable.OxidizationLevel.OXIDIZED, AbstractBlock.Settings.copy(OXIDIZED_COPPER)));
      WEATHERED_CUT_COPPER = register("weathered_cut_copper", new OxidizableBlock(Oxidizable.OxidizationLevel.WEATHERED, AbstractBlock.Settings.copy(WEATHERED_COPPER)));
      EXPOSED_CUT_COPPER = register("exposed_cut_copper", new OxidizableBlock(Oxidizable.OxidizationLevel.EXPOSED, AbstractBlock.Settings.copy(EXPOSED_COPPER)));
      CUT_COPPER = register("cut_copper", new OxidizableBlock(Oxidizable.OxidizationLevel.UNAFFECTED, AbstractBlock.Settings.copy(COPPER_BLOCK)));
      OXIDIZED_CUT_COPPER_STAIRS = register("oxidized_cut_copper_stairs", new OxidizableStairsBlock(Oxidizable.OxidizationLevel.OXIDIZED, OXIDIZED_CUT_COPPER.getDefaultState(), AbstractBlock.Settings.copy(OXIDIZED_CUT_COPPER)));
      WEATHERED_CUT_COPPER_STAIRS = register("weathered_cut_copper_stairs", new OxidizableStairsBlock(Oxidizable.OxidizationLevel.WEATHERED, WEATHERED_CUT_COPPER.getDefaultState(), AbstractBlock.Settings.copy(WEATHERED_COPPER)));
      EXPOSED_CUT_COPPER_STAIRS = register("exposed_cut_copper_stairs", new OxidizableStairsBlock(Oxidizable.OxidizationLevel.EXPOSED, EXPOSED_CUT_COPPER.getDefaultState(), AbstractBlock.Settings.copy(EXPOSED_COPPER)));
      CUT_COPPER_STAIRS = register("cut_copper_stairs", new OxidizableStairsBlock(Oxidizable.OxidizationLevel.UNAFFECTED, CUT_COPPER.getDefaultState(), AbstractBlock.Settings.copy(COPPER_BLOCK)));
      OXIDIZED_CUT_COPPER_SLAB = register("oxidized_cut_copper_slab", new OxidizableSlabBlock(Oxidizable.OxidizationLevel.OXIDIZED, AbstractBlock.Settings.copy(OXIDIZED_CUT_COPPER).requiresTool()));
      WEATHERED_CUT_COPPER_SLAB = register("weathered_cut_copper_slab", new OxidizableSlabBlock(Oxidizable.OxidizationLevel.WEATHERED, AbstractBlock.Settings.copy(WEATHERED_CUT_COPPER).requiresTool()));
      EXPOSED_CUT_COPPER_SLAB = register("exposed_cut_copper_slab", new OxidizableSlabBlock(Oxidizable.OxidizationLevel.EXPOSED, AbstractBlock.Settings.copy(EXPOSED_CUT_COPPER).requiresTool()));
      CUT_COPPER_SLAB = register("cut_copper_slab", new OxidizableSlabBlock(Oxidizable.OxidizationLevel.UNAFFECTED, AbstractBlock.Settings.copy(CUT_COPPER).requiresTool()));
      ...
      POINTED_DRIPSTONE = register("pointed_dripstone", new PointedDripstoneBlock(AbstractBlock.Settings.of(Material.STONE, MapColor.TERRACOTTA_BROWN).nonOpaque().sounds(BlockSoundGroup.POINTED_DRIPSTONE).ticksRandomly().strength(1.5F, 3.0F).dynamicBounds()));
      ...
      SMALL_DRIPLEAF = register("small_dripleaf", new SmallDripleafBlock(AbstractBlock.Settings.of(Material.PLANT).noCollision().breakInstantly().sounds(BlockSoundGroup.SMALL_DRIPLEAF)));
      HANGING_ROOTS = register("hanging_roots", new HangingRootsBlock(AbstractBlock.Settings.of(Material.REPLACEABLE_PLANT, MapColor.DIRT_BROWN).noCollision().breakInstantly().sounds(BlockSoundGroup.HANGING_ROOTS)));
