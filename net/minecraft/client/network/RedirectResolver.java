...
public interface RedirectResolver {
   ...
   static RedirectResolver createSrv() {
      ...
      try {
         ...
         dirContext2 = new InitialDirContext(hashtable);
      ...
      return (address) -> {
         if (address.getPort() == 25565) {
            try {
               Attributes attributes = dirContext2.getAttributes("_minecraft._tcp." + address.getAddress(), new String[]{"SRV"});
