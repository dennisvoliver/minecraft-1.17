...
public class ParticleManager implements ResourceReloader {
   ...
   private void registerDefaultFactories() {
      ...
      this.registerFactory(ParticleTypes.BARRIER, (ParticleFactory)(new ItemBillboardParticle.BarrierFactory()));
      this.registerFactory(ParticleTypes.LIGHT, (ParticleFactory)(new ItemBillboardParticle.LightFactory()));
      ...
      this.registerFactory(ParticleTypes.SNOWFLAKE, (ParticleManager.SpriteAwareFactory)(SnowflakeParticle.Factory::new));
      ...
      this.registerFactory(ParticleTypes.FALLING_SPORE_BLOSSOM, (ParticleManager.SpriteAwareFactory)(BlockLeakParticle.FallingSporeBlossomFactory::new));
      this.registerFactory(ParticleTypes.SPORE_BLOSSOM_AIR, (ParticleManager.SpriteAwareFactory)(WaterSuspendParticle.SporeBlossomAirFactory::new));
      ...
      this.registerFactory(ParticleTypes.SMALL_FLAME, (ParticleManager.SpriteAwareFactory)(FlameParticle.SmallFactory::new));
      this.registerFactory(ParticleTypes.DRIPPING_DRIPSTONE_WATER, (ParticleManager.SpriteAwareFactory)(BlockLeakParticle.FallingDripstoneWaterFactory::new));
      this.registerFactory(ParticleTypes.FALLING_DRIPSTONE_WATER, (ParticleManager.SpriteAwareFactory)(BlockLeakParticle.DripstoneLavaSplashFactory::new));
      this.registerFactory(ParticleTypes.DRIPPING_DRIPSTONE_LAVA, (ParticleManager.SpriteAwareFactory)(BlockLeakParticle.FallingDripstoneLavaFactory::new));
      this.registerFactory(ParticleTypes.FALLING_DRIPSTONE_LAVA, (ParticleManager.SpriteAwareFactory)(BlockLeakParticle.LandingDripstoneLavaFactory::new));
      this.registerFactory(ParticleTypes.VIBRATION, VibrationParticle.Factory::new);
      this.registerFactory(ParticleTypes.GLOW_SQUID_INK, (ParticleManager.SpriteAwareFactory)(SquidInkParticle.GlowSquidInkFactory::new));
      this.registerFactory(ParticleTypes.GLOW, (ParticleManager.SpriteAwareFactory)(GlowParticle.GlowFactory::new));
      this.registerFactory(ParticleTypes.WAX_ON, (ParticleManager.SpriteAwareFactory)(GlowParticle.WaxOnFactory::new));
      this.registerFactory(ParticleTypes.WAX_OFF, (ParticleManager.SpriteAwareFactory)(GlowParticle.WaxOffFactory::new));
      this.registerFactory(ParticleTypes.ELECTRIC_SPARK, (ParticleManager.SpriteAwareFactory)(GlowParticle.ElectricSparkFactory::new));
      this.registerFactory(ParticleTypes.SCRAPE, (ParticleManager.SpriteAwareFactory)(GlowParticle.ScrapeFactory::new));
   }
         ...
         try {
            ...
            try {
               ...
               if (list == null) {
                  ...
                  result.put(id, (List)list.stream().map((identifierx) -> {
            ...
            for(int p = 0; p < m; ++p) {
               for(int q = 0; q < n; ++q) {
                  for(int r = 0; r < o; ++r) {
                     ...
                     double w = t * k + e;
                     double x = u * l + f;
                     this.addParticle(new BlockDustParticle(this.world, (double)pos.getX() + v, (double)pos.getY() + w, (double)pos.getZ() + x, s - 0.5D, t - 0.5D, u - 0.5D, state, pos));
                  }
               }
            }
   ...
   public void addBlockBreakingParticles(BlockPos pos, Direction direction) {
      ...
      if (blockState.getRenderType() != BlockRenderType.INVISIBLE) {
         ...
         this.addParticle((new BlockDustParticle(this.world, d, e, g, 0.0D, 0.0D, 0.0D, blockState, pos)).move(0.2F).scale(0.6F));
      }
   }
   ...
   @Environment(EnvType.CLIENT)
   private class SimpleSpriteProvider implements SpriteProvider {
