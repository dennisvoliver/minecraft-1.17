...
public class BlockLeakParticle extends SpriteBillboardParticle {
   ...
   @Environment(EnvType.CLIENT)
   private static class Landing extends BlockLeakParticle {
   ...
   @Environment(EnvType.CLIENT)
   private static class DripstoneLavaDrip extends BlockLeakParticle.ContinuousFalling {
   ...
   @Environment(EnvType.CLIENT)
   private static class ContinuousFalling extends BlockLeakParticle.Falling {
   ...
   @Environment(EnvType.CLIENT)
   private static class DrippingLava extends BlockLeakParticle.Dripping {
