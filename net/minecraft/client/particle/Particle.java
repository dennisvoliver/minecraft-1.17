...
public abstract class Particle {
   ...
   public Particle(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
      ...
      this.velocityZ = this.velocityZ / e * d * 0.4000000059604645D;
   }
   ...
   public String toString() {
      ...
      return var10000 + ", Pos (" + this.x + "," + this.y + "," + this.z + "), RGBA (" + this.colorRed + "," + this.colorGreen + "," + this.colorBlue + "," + this.colorAlpha + "), Age " + this.age;
   }
