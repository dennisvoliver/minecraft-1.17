...
public abstract class RenderPhase {
   ...
   protected static final RenderPhase.Shader ENTITY_CUTOUT_NONULL_OFFSET_Z_SHADER = new RenderPhase.Shader(GameRenderer::getRenderTypeEntityCutoutNoNullZOffsetShader);
   protected static final RenderPhase.Shader ITEM_ENTITY_TRANSLUCENT_CULL_SHADER = new RenderPhase.Shader(GameRenderer::getRenderTypeItemEntityTranslucentCullShader);
   ...
   static {
      ...
      NO_TEXTURE = new RenderPhase.TextureBase();
   ...
   protected static final class OffsetTexturing extends RenderPhase.Texturing {
      public OffsetTexturing(float x, float y) {
         super("offset_texturing", () -> {
            RenderSystem.setTextureMatrix(Matrix4f.translate(x, y, 0.0F));
         }, () -> {
            RenderSystem.resetTextureMatrix();
         });
      }
