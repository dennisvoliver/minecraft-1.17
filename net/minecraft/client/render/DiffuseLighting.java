...
public class DiffuseLighting {
   private static final Vec3f field_24426 = (Vec3f)Util.make(new Vec3f(0.2F, 1.0F, -0.7F), Vec3f::normalize);
   private static final Vec3f field_24427 = (Vec3f)Util.make(new Vec3f(-0.2F, 1.0F, 0.7F), Vec3f::normalize);
   private static final Vec3f field_24428 = (Vec3f)Util.make(new Vec3f(0.2F, 1.0F, -0.7F), Vec3f::normalize);
   private static final Vec3f field_24429 = (Vec3f)Util.make(new Vec3f(-0.2F, -1.0F, 0.7F), Vec3f::normalize);
   private static final Vec3f field_29567 = (Vec3f)Util.make(new Vec3f(0.2F, -1.0F, -1.0F), Vec3f::normalize);
   private static final Vec3f field_29568 = (Vec3f)Util.make(new Vec3f(-0.2F, -1.0F, 0.0F), Vec3f::normalize);
