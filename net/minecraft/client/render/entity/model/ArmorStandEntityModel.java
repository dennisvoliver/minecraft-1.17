...
public class ArmorStandEntityModel extends ArmorStandArmorEntityModel {
   ...
   public void animateModel(ArmorStandEntity armorStandEntity, float f, float g, float h) {
      ...
      this.basePlate.yaw = 0.017453292F * -MathHelper.lerpAngleDegrees(h, armorStandEntity.prevYaw, armorStandEntity.getYaw());
   ...
   public void setAngles(ArmorStandEntity armorStandEntity, float f, float g, float h, float i, float j) {
      ...
      this.rightBodyStick.pitch = 0.017453292F * armorStandEntity.getBodyRotation().getPitch();
      this.rightBodyStick.yaw = 0.017453292F * armorStandEntity.getBodyRotation().getYaw();
      this.rightBodyStick.roll = 0.017453292F * armorStandEntity.getBodyRotation().getRoll();
      this.leftBodyStick.pitch = 0.017453292F * armorStandEntity.getBodyRotation().getPitch();
      this.leftBodyStick.yaw = 0.017453292F * armorStandEntity.getBodyRotation().getYaw();
      this.leftBodyStick.roll = 0.017453292F * armorStandEntity.getBodyRotation().getRoll();
