...
public class QuadrupedEntityModel<T extends Entity> extends AnimalModel<T> {
   ...
   public static ModelData getModelData(int stanceWidth, Dilation dilation) {
      ...
      modelPartData.addChild(EntityModelPartNames.HEAD, ModelPartBuilder.create().uv(0, 0).cuboid(-4.0F, -4.0F, -8.0F, 8.0F, 8.0F, 8.0F, dilation), ModelTransform.pivot(0.0F, (float)(18 - stanceWidth), -6.0F));
      modelPartData.addChild(EntityModelPartNames.BODY, ModelPartBuilder.create().uv(28, 8).cuboid(-5.0F, -10.0F, -7.0F, 10.0F, 16.0F, 8.0F, dilation), ModelTransform.of(0.0F, (float)(17 - stanceWidth), 2.0F, 1.5707964F, 0.0F, 0.0F));
