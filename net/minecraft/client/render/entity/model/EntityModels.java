...
public class EntityModels {
   ...
   public static Map<EntityModelLayer, TexturedModelData> getModels() {
      ...
      BoatEntity.Type[] var20 = BoatEntity.Type.values();
      int var21 = var20.length;

      for(int var22 = 0; var22 < var21; ++var22) {
         BoatEntity.Type type = var20[var22];
      ...
      SignType.stream().forEach((signType) -> {
         builder.put(EntityModelLayers.createSign(signType), texturedModelData20);
      });
      ...
      List<EntityModelLayer> list = (List)EntityModelLayers.getLayers().filter((entityModelLayer) -> {
         return !immutableMap.containsKey(entityModelLayer);
