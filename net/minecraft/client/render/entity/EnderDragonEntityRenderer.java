   ...
   public static class DragonEntityModel extends EntityModel<EnderDragonEntity> {
      ...
      public void render(MatrixStack matrices, VertexConsumer vertices, int light, int overlay, float red, float green, float blue, float alpha) {
         ...
         for(int o = 0; o < 5; ++o) {
            ...
            this.neck.pitch = r + this.dragon.getChangeInNeckPitch(o, ds, es) * 0.017453292F * 1.5F * 5.0F;
         ...
         this.head.pitch = MathHelper.fwrapDegrees((double)this.dragon.getChangeInNeckPitch(6, ds, fs)) * 0.017453292F * 1.5F * 5.0F;
         ...
         this.leftWing.roll = -((float)(Math.sin((double)q) + 0.125D)) * 0.8F;
         this.leftWingTip.roll = (float)(Math.sin((double)(q + 2.0F)) + 0.5D) * 0.75F;
