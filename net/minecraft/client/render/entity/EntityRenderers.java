...
public class EntityRenderers {
   ...
   private static final Map<String, EntityRendererFactory<AbstractClientPlayerEntity>> playerRendererFactories = ImmutableMap.of("default", (context) -> {
   ...
   public static boolean isMissingRendererFactories() {
      ...
      while(var1.hasNext()) {
         ...
         if (entityType != EntityType.PLAYER && !rendererFactories.containsKey(entityType)) {
            LOGGER.warn((String)"No renderer registered for {}", (Object)Registry.ENTITY_TYPE.getId(entityType));
            bl = false;
         }
      }
