...
public class GiantEntityRenderer extends MobEntityRenderer<GiantEntity, BipedEntityModel<GiantEntity>> {
   ...
   public GiantEntityRenderer(EntityRendererFactory.Context ctx, float scale) {
      ...
      this.addFeature(new ArmorFeatureRenderer(this, new GiantEntityModel(ctx.getPart(EntityModelLayers.GIANT_INNER_ARMOR)), new GiantEntityModel(ctx.getPart(EntityModelLayers.GIANT_OUTER_ARMOR))));
   }
