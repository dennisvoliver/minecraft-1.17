...
public class EntityRenderDispatcher implements SynchronousResourceReloader {
   ...
   public <T extends Entity> EntityRenderer<? super T> getRenderer(T entity) {
      if (entity instanceof AbstractClientPlayerEntity) {
         ...
         EntityRenderer<? extends PlayerEntity> entityRenderer = (EntityRenderer)this.modelRenderers.get(string);
         return entityRenderer != null ? entityRenderer : (EntityRenderer)this.modelRenderers.get("default");
      } else {
   ...
   public <E extends Entity> void render(E entity, double x, double y, double z, float yaw, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light) {
      ...
      try {
         ...
         crashReportSection2.add("Location", (Object)CrashReportSection.createPositionString(this.world, x, y, z));
   ...
   private static void renderHitbox(MatrixStack matrices, VertexConsumer vertices, Entity entity, float tickDelta) {
      ...
      vertices.vertex(matrix4f, (float)(vec3d.x * 2.0D), (float)((double)entity.getStandingEyeHeight() + vec3d.y * 2.0D), (float)(vec3d.z * 2.0D)).color(0, 0, 255, 255).normal(matrix3f, (float)vec3d.x, (float)vec3d.y, (float)vec3d.z).next();
   }
