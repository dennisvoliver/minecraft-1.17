...
public class Camera {
   ...
   public Camera.class_6355 method_36425() {
      ...
      double e = Math.tan(minecraftClient.options.fov * 0.01745329238474369D / 2.0D) * 0.05000000074505806D;
      double f = e * d;
      Vec3d vec3d = (new Vec3d(this.horizontalPlane)).multiply(0.05000000074505806D);
