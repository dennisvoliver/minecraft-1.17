...
public class BufferBuilder extends FixedColorVertexConsumer implements BufferVertexConsumer {
   ...
   public void end() {
      if (!this.building) {
         ...
         this.building = false;
         this.parameters.add(new BufferBuilder.DrawArrayParameters(this.format, this.vertexCount, i, this.drawMode, intType, this.cameraOffset, bl2));
         this.vertexCount = 0;
   ...
   public void clear() {
      if (this.buildStart != this.nextDrawStart) {
         LOGGER.warn((String)"Bytes mismatch {} {}", (Object)this.buildStart, (Object)this.nextDrawStart);
      }
