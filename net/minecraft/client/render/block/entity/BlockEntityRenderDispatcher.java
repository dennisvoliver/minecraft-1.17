...
public class BlockEntityRenderDispatcher implements SynchronousResourceReloader {
   ...
   public void reload(ResourceManager manager) {
      BlockEntityRendererFactory.Context context = new BlockEntityRendererFactory.Context(this, (BlockRenderManager)this.field_27747.get(), this.entityModelLoader, this.textRenderer);
