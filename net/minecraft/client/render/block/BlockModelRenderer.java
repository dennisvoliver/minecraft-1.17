   ...
   class AmbientOcclusionCalculator {
      ...
      public void apply(BlockRenderView world, BlockState state, BlockPos pos, Direction direction, float[] box, BitSet flags, boolean bl) {
         ...
         if (!bl4 && !bl2) {
            ...
            blockState12 = world.getBlockState(mutable);
            p = brightnessCache.getFloat(blockState12, world, mutable);
            q = brightnessCache.getInt(blockState12, world, mutable);
         }
         ...
         if (!bl5 && !bl2) {
            ...
            blockState12 = world.getBlockState(mutable);
            t = brightnessCache.getFloat(blockState12, world, mutable);
            u = brightnessCache.getInt(blockState12, world, mutable);
         }
         ...
         if (!bl4 && !bl3) {
            ...
            blockState12 = world.getBlockState(mutable);
            x = brightnessCache.getFloat(blockState12, world, mutable);
            y = brightnessCache.getInt(blockState12, world, mutable);
         }
