...
public class GameRenderer implements SynchronousResourceReloader, AutoCloseable {
   ...
   public void loadShaders(ResourceManager manager) {
      ...
      ArrayList list2 = Lists.newArrayListWithCapacity(this.shaders.size());
   ...
   public void render(float tickDelta, long startTime, boolean tick) {
      ...
      if (!this.client.skipGameRender) {
         ...
         CrashReportSection crashReportSection3;
         if (this.client.getOverlay() != null) {
            try {
               this.client.getOverlay().render(matrixStack2, i, j, this.client.getLastFrameDuration());
            } catch (Throwable var16) {
               crashReport3 = CrashReport.create(var16, "Rendering overlay");
               crashReportSection3 = crashReport3.addElement("Overlay render details");
               crashReportSection3.add("Overlay name", () -> {
            ...
            try {
               ...
               crashReport3 = CrashReport.create(var15, "Rendering screen");
               crashReportSection3 = crashReport3.addElement("Screen render details");
               crashReportSection3.add("Screen name", () -> {
                  return this.client.currentScreen.getClass().getCanonicalName();
               });
               crashReportSection3.add("Mouse location", () -> {
                  return String.format(Locale.ROOT, "Scaled: (%d, %d). Absolute: (%f, %f)", i, j, this.client.mouse.getX(), this.client.mouse.getY());
               });
               crashReportSection3.add("Screen size", () -> {
            ...
            try {
               ...
               crashReport3 = CrashReport.create(var14, "Narrating screen");
               crashReportSection3 = crashReport3.addElement("Screen details");
               crashReportSection3.add("Screen name", () -> {
                  return this.client.currentScreen.getClass().getCanonicalName();
               });
               throw new CrashException(crashReport3);
      ...
      if (this.client.worldRenderer.getCompletedChunkCount() > 10 && this.client.worldRenderer.isTerrainRenderComplete() && !this.client.getServer().hasIconFile()) {
         ...
         Util.getIoWorkerExecutor().execute(() -> {
            ...
            try {
               ...
               LOGGER.warn((String)"Couldn't save auto screenshot", (Throwable)var16);
            } finally {
               nativeImage.close();
            }
