...
public class ItemModelGenerator {
   ...
   private List<ModelElement> addLayerElements(int layer, String key, Sprite sprite) {
      ...
      List<ModelElement> list = Lists.newArrayList();
      list.add(new ModelElement(new Vec3f(0.0F, 0.0F, 7.5F), new Vec3f(16.0F, 16.0F, 8.5F), map, (ModelRotation)null, true));
   ...
   private List<ModelElement> addSubComponents(Sprite sprite, String key, int layer) {
      ...
      while(var7.hasNext()) {
         ...
         switch(side) {
         case UP:
            list.add(new ModelElement(new Vec3f(h, i, 7.5F), new Vec3f(j, i, 8.5F), map, (ModelRotation)null, true));
            break;
         case DOWN:
            list.add(new ModelElement(new Vec3f(h, k, 7.5F), new Vec3f(j, k, 8.5F), map, (ModelRotation)null, true));
            break;
         case LEFT:
            list.add(new ModelElement(new Vec3f(h, i, 7.5F), new Vec3f(h, k, 8.5F), map, (ModelRotation)null, true));
            break;
         case RIGHT:
            list.add(new ModelElement(new Vec3f(j, i, 7.5F), new Vec3f(j, k, 8.5F), map, (ModelRotation)null, true));
         }
      }
