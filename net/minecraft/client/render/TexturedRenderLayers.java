...
public class TexturedRenderLayers {
   ...
   public static final Map<BannerPattern, SpriteIdentifier> BANNER_PATTERN_TEXTURES;
   public static final Map<BannerPattern, SpriteIdentifier> SHIELD_PATTERN_TEXTURES;
   ...
   public static void addDefaultTextures(Consumer<SpriteIdentifier> adder) {
      ...
      for(int var3 = 0; var3 < var2; ++var3) {
         SpriteIdentifier spriteIdentifier = var1[var3];
   ...
   static {
      ...
      BANNER_PATTERN_TEXTURES = (Map)Arrays.stream(BannerPattern.values()).collect(Collectors.toMap(Function.identity(), TexturedRenderLayers::createBannerPatternTextureId));
      SHIELD_PATTERN_TEXTURES = (Map)Arrays.stream(BannerPattern.values()).collect(Collectors.toMap(Function.identity(), TexturedRenderLayers::createShieldPatternTextureId));
