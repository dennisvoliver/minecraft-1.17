...
public class CubeMapRenderer {
   ...
   public CubeMapRenderer(Identifier faces) {
      for(int i = 0; i < 6; ++i) {
         ...
         String var10004 = faces.getNamespace();
         String var10005 = faces.getPath();
         var10000[i] = new Identifier(var10004, var10005 + "_" + i + ".png");
      }
   ...
   public void draw(MinecraftClient client, float x, float y, float alpha) {
      ...
      for(int j = 0; j < 4; ++j) {
         ...
         float h = 0.0F;
         matrixStack.translate((double)f, (double)g, 0.0D);
