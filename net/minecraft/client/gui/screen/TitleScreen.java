...
public class TitleScreen extends Screen {
   ...
   private void initWidgetsDemo(int y, int spacingY) {
      ...
      this.buttonResetDemo = (ButtonWidget)this.addDrawableChild(new ButtonWidget(this.width / 2 - 100, y + spacingY * 1, 200, 20, new TranslatableText("menu.resetdemo"), (button) -> {
         ...
         try {
            ...
            LOGGER.warn((String)"Failed to access demo world", (Throwable)var8);
         }
   ...
   private boolean canReadDemoWorldData() {
      try {
         ...
         SystemToast.addWorldAccessFailureToast(this.client, "Demo_World");
         LOGGER.warn((String)"Failed to read demo world data", (Throwable)var6);
         return false;
      }
   }
   ...
   private void onDemoDeletionConfirmed(boolean delete) {
      if (delete) {
         try {
            ...
            LOGGER.warn((String)"Failed to delete demo world", (Throwable)var7);
         }
      }
