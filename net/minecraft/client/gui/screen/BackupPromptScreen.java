...
public class BackupPromptScreen extends Screen {
   ...
   protected void init() {
      ...
      int i = var10000 * 9;
      this.addDrawableChild(new ButtonWidget(this.width / 2 - 155, 100 + i, 150, 20, new TranslatableText("selectWorld.backupJoinConfirmButton"), (button) -> {
         this.callback.proceed(true, this.eraseCacheCheckbox.isChecked());
      }));
      this.addDrawableChild(new ButtonWidget(this.width / 2 - 155 + 160, 100 + i, 150, 20, new TranslatableText("selectWorld.backupJoinSkipButton"), (button) -> {
         this.callback.proceed(false, this.eraseCacheCheckbox.isChecked());
      }));
      this.addDrawableChild(new ButtonWidget(this.width / 2 - 155 + 80, 124 + i, 150, 20, ScreenTexts.CANCEL, (button) -> {
