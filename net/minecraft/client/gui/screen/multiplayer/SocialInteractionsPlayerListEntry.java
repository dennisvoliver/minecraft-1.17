...
public class SocialInteractionsPlayerListEntry extends ElementListWidget.Entry<SocialInteractionsPlayerListEntry> {
   ...
   public SocialInteractionsPlayerListEntry(final MinecraftClient client, final SocialInteractionsScreen parent, UUID uuid, String name, Supplier<Identifier> skinTexture) {
      ...
      this.hideText = new TranslatableText("gui.socialInteractions.tooltip.hide", new Object[]{name});
      this.showText = new TranslatableText("gui.socialInteractions.tooltip.show", new Object[]{name});
      ...
      if (!client.player.getGameProfile().getId().equals(uuid) && !socialInteractionsManager.isPlayerBlocked(uuid)) {
         this.hideButton = new TexturedButtonWidget(0, 0, 20, 20, 0, 38, 20, SocialInteractionsScreen.SOCIAL_INTERACTIONS_TEXTURE, 256, 256, (button) -> {
            ...
            public void onTooltip(ButtonWidget buttonWidget, MatrixStack matrixStack, int i, int j) {
               SocialInteractionsPlayerListEntry var10000 = SocialInteractionsPlayerListEntry.this;
               var10000.timeCounter += client.getLastFrameDuration();
   ...
   MutableText getNarrationMessage(MutableText text) {
      ...
      return text2 == LiteralText.EMPTY ? (new LiteralText(this.name)).append(", ").append((Text)text) : (new LiteralText(this.name)).append(", ").append(text2).append(", ").append((Text)text);
   }
