...
public class SocialInteractionsScreen extends Screen {
   ...
   protected void init() {
      ...
      this.allTabButton = (ButtonWidget)this.addDrawableChild(new ButtonWidget(j, 45, i, 20, ALL_TAB_TITLE, (button) -> {
         this.setCurrentTab(SocialInteractionsScreen.Tab.ALL);
      }));
      this.hiddenTabButton = (ButtonWidget)this.addDrawableChild(new ButtonWidget((j + k - i) / 2 + 1, 45, i, 20, HIDDEN_TAB_TITLE, (button) -> {
         this.setCurrentTab(SocialInteractionsScreen.Tab.HIDDEN);
      }));
      this.blockedTabButton = (ButtonWidget)this.addDrawableChild(new ButtonWidget(k - i + 1, 45, i, 20, BLOCKED_TAB_TITLE, (button) -> {
         this.setCurrentTab(SocialInteractionsScreen.Tab.BLOCKED);
      }));
      this.blockingButton = (ButtonWidget)this.addDrawableChild(new ButtonWidget(n, m, l, 20, BLOCKING_TEXT, (button) -> {
