...
public class ConfirmChatLinkScreen extends ConfirmScreen {
   ...
   protected void method_37051(int i) {
      this.addDrawableChild(new ButtonWidget(this.width / 2 - 50 - 105, this.height / 6 + 96, 100, 20, this.yesTranslated, (button) -> {
      ...
      this.addDrawableChild(new ButtonWidget(this.width / 2 - 50 + 105, this.height / 6 + 96, 100, 20, this.noTranslated, (button) -> {
         this.callback.accept(false);
      }));
   }
