...
public class StructureBlockScreen extends Screen {
   ...
   protected void init() {
      ...
      this.addDrawableChild(new ButtonWidget(this.width / 2 - 4 - 150, 210, 150, 20, ScreenTexts.DONE, (button) -> {
         this.done();
      }));
      this.addDrawableChild(new ButtonWidget(this.width / 2 + 4, 210, 150, 20, ScreenTexts.CANCEL, (button) -> {
         this.cancel();
      }));
      ...
      this.buttonSave = (ButtonWidget)this.addDrawableChild(new ButtonWidget(this.width / 2 + 4 + 100, 185, 50, 20, new TranslatableText("structure_block.button.save"), (button) -> {
      ...
      this.buttonLoad = (ButtonWidget)this.addDrawableChild(new ButtonWidget(this.width / 2 + 4 + 100, 185, 50, 20, new TranslatableText("structure_block.button.load"), (button) -> {
      ...
      this.addDrawableChild(CyclingButtonWidget.builder((structureBlockMode) -> {
         return new TranslatableText("structure_block.mode." + structureBlockMode.asString());
      }).values(MODES_EXCEPT_DATA, MODES).omitKeyText().initially(this.mode).build(this.width / 2 - 4 - 150, 185, 50, 20, new LiteralText("MODE"), (button, mode) -> {
         this.structureBlock.setMode(mode);
         this.updateWidgets(mode);
      }));
      this.buttonDetect = (ButtonWidget)this.addDrawableChild(new ButtonWidget(this.width / 2 + 4 + 100, 120, 50, 20, new TranslatableText("structure_block.button.detect_size"), (button) -> {
         if (this.structureBlock.getMode() == StructureBlockMode.SAVE) {
      ...
      this.buttonMirror = (CyclingButtonWidget)this.addDrawableChild(CyclingButtonWidget.builder(BlockMirror::getName).values((Object[])BlockMirror.values()).omitKeyText().initially(this.mirror).build(this.width / 2 - 20, 185, 40, 20, new LiteralText("MIRROR"), (button, mirror) -> {
      ...
      this.buttonRotate0 = (ButtonWidget)this.addDrawableChild(new ButtonWidget(this.width / 2 - 1 - 40 - 1 - 40 - 20, 185, 40, 20, new LiteralText("0"), (button) -> {
         this.structureBlock.setRotation(BlockRotation.NONE);
         this.updateRotationButton();
      }));
      this.buttonRotate90 = (ButtonWidget)this.addDrawableChild(new ButtonWidget(this.width / 2 - 1 - 40 - 20, 185, 40, 20, new LiteralText("90"), (button) -> {
         this.structureBlock.setRotation(BlockRotation.CLOCKWISE_90);
         this.updateRotationButton();
      }));
      this.buttonRotate180 = (ButtonWidget)this.addDrawableChild(new ButtonWidget(this.width / 2 + 1 + 20, 185, 40, 20, new LiteralText("180"), (button) -> {
         this.structureBlock.setRotation(BlockRotation.CLOCKWISE_180);
         this.updateRotationButton();
      }));
      this.buttonRotate270 = (ButtonWidget)this.addDrawableChild(new ButtonWidget(this.width / 2 + 1 + 40 + 1 + 20, 185, 40, 20, new LiteralText("270"), (button) -> {
