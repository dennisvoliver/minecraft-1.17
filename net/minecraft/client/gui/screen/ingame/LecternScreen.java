...
public class LecternScreen extends BookScreen implements ScreenHandlerProvider<LecternScreenHandler> {
   ...
   protected void addCloseButton() {
      if (this.client.player.canModifyBlocks()) {
         this.addDrawableChild(new ButtonWidget(this.width / 2 - 100, 196, 98, 20, ScreenTexts.DONE, (button) -> {
            this.onClose();
         }));
         this.addDrawableChild(new ButtonWidget(this.width / 2 + 2, 196, 98, 20, new TranslatableText("lectern.take_book"), (button) -> {
