...
public class BookEditScreen extends Screen {
   ...
   public BookEditScreen(PlayerEntity player, ItemStack itemStack, Hand hand) {
      ...
      if (nbtCompound != null) {
         ...
         BookScreen.method_33888(nbtCompound, var10001::add);
      }
   ...
   protected void init() {
      ...
      this.signButton = (ButtonWidget)this.addDrawableChild(new ButtonWidget(this.width / 2 - 100, 196, 98, 20, new TranslatableText("book.signButton"), (button) -> {
         this.signing = true;
         this.updateButtons();
      }));
      ...
      this.finalizeButton = (ButtonWidget)this.addDrawableChild(new ButtonWidget(this.width / 2 - 100, 196, 98, 20, new TranslatableText("book.finalizeButton"), (button) -> {
         if (this.signing) {
         ...
         if (i != j) {
            ...
            if (o == p) {
               ...
               for(t = o + 1; t < p; ++t) {
                  ...
                  Objects.requireNonNull(this.textRenderer);
                  list2.add(this.getRectFromCorners(var10002, new BookEditScreen.Position(v, u + 9)));
               }
   ...
   private Rect2i getLineSelectionRectangle(String string, TextHandler handler, int selectionStart, int selectionEnd, int lineY, int lineStart) {
      ...
      Objects.requireNonNull(this.textRenderer);
      BookEditScreen.Position position2 = new BookEditScreen.Position(var10002, lineY + 9);
   ...
   private static class PageContent {
      ...
      public int getVerticalOffset(int position, int lines) {
         ...
         if (0 <= j && j < this.lineStarts.length) {
            ...
            n = this.lineStarts[j] + Math.min(k, l);
         } else {
            n = position;
         }
