...
public class LoomScreen extends HandledScreen<LoomScreenHandler> {
   ...
   protected void drawBackground(MatrixStack matrices, float delta, int mouseX, int mouseY) {
      ...
      if (this.bannerPatterns != null && !this.hasTooManyPatterns) {
         ...
         BannerBlockEntityRenderer.renderCanvas(matrices, immediate, 15728880, OverlayTexture.DEFAULT_UV, this.bannerField, ModelLoader.BANNER_BASE, true, this.bannerPatterns);
         matrices.pop();
         immediate.draw();
   ...
   static {
      PATTERN_BUTTON_ROW_COUNT = (BannerPattern.COUNT - BannerPattern.HAS_PATTERN_ITEM_COUNT - 1 + 4 - 1) / 4;
   }
}
