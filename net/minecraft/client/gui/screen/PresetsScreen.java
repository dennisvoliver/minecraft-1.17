...
public class PresetsScreen extends Screen {
   ...
   private static FlatChunkGeneratorLayer parseLayerString(String layer, int layerStartHeight) {
      ...
      if (block2 == null) {
         ...
         return new FlatChunkGeneratorLayer(l, block2);
      }
   }
   ...
   protected void init() {
      ...
      this.selectPresetButton = (ButtonWidget)this.addDrawableChild(new ButtonWidget(this.width / 2 - 155, this.height - 28, 150, 20, new TranslatableText("createWorld.customize.presets.select"), (button) -> {
   ...
   class SuperflatPresetsListWidget extends AlwaysSelectedEntryListWidget<PresetsScreen.SuperflatPresetsListWidget.SuperflatPresetEntry> {
      public SuperflatPresetsListWidget() {
         ...
         Iterator var2 = PresetsScreen.PRESETS.iterator();

         while(var2.hasNext()) {
            PresetsScreen.SuperflatPreset superflatPreset = (PresetsScreen.SuperflatPreset)var2.next();
      ...
      public class SuperflatPresetEntry extends AlwaysSelectedEntryListWidget.Entry<PresetsScreen.SuperflatPresetsListWidget.SuperflatPresetEntry> {
         ...
         public Text method_37006() {
            return new TranslatableText("narrator.select", new Object[]{this.preset.getName()});
         }
      }
   }

   @Environment(EnvType.CLIENT)
   private static class SuperflatPreset {
