...
public class CustomizeFlatLevelScreen extends Screen {
   ...
   protected void init() {
      ...
      this.widgetButtonRemoveLayer = (ButtonWidget)this.addDrawableChild(new ButtonWidget(this.width / 2 - 155, this.height - 52, 150, 20, new TranslatableText("createWorld.customize.flat.removeLayer"), (button) -> {
   ...
   @Environment(EnvType.CLIENT)
   private class SuperflatLayersListWidget extends AlwaysSelectedEntryListWidget<CustomizeFlatLevelScreen.SuperflatLayersListWidget.SuperflatLayerEntry> {
      ...
      @Environment(EnvType.CLIENT)
      private class SuperflatLayerEntry extends AlwaysSelectedEntryListWidget.Entry<CustomizeFlatLevelScreen.SuperflatLayersListWidget.SuperflatLayerEntry> {
         SuperflatLayerEntry() {
         }
         ...
         public void render(MatrixStack matrices, int index, int y, int x, int entryWidth, int entryHeight, int mouseX, int mouseY, boolean hovered, float tickDelta) {
            ...
            if (index == 0) {
               text3 = new TranslatableText("createWorld.customize.flat.layer.top", new Object[]{flatChunkGeneratorLayer.getThickness()});
            } else if (index == CustomizeFlatLevelScreen.this.config.getLayers().size() - 1) {
               text3 = new TranslatableText("createWorld.customize.flat.layer.bottom", new Object[]{flatChunkGeneratorLayer.getThickness()});
            } else {
               text3 = new TranslatableText("createWorld.customize.flat.layer", new Object[]{flatChunkGeneratorLayer.getThickness()});
            }

            CustomizeFlatLevelScreen.this.textRenderer.draw(matrices, (Text)text3, (float)(x + 2 + 213 - CustomizeFlatLevelScreen.this.textRenderer.getWidth((StringVisitable)text3)), (float)(y + 3), 16777215);
         }
         ...
         public Text method_37006() {
            ...
            return (Text)(!itemStack.isEmpty() ? new TranslatableText("narrator.select", new Object[]{itemStack.getName()}) : LiteralText.EMPTY);
         }
