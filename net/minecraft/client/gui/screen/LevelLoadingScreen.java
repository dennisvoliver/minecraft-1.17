...
public class LevelLoadingScreen extends Screen {
   ...
   private String getPercentage() {
      ...
      return MathHelper.clamp((int)var10000, (int)0, (int)100) + "%";
   }
   ...
   public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
      ...
      drawCenteredText(matrices, var10001, var10002, i, j - 9 / 2 - 30, 16777215);
   }
   ...
   public static void drawChunkMap(MatrixStack matrices, WorldGenerationProgressTracker progressProvider, int i, int j, int k, int l) {
      ...
      for(int v = 0; v < p; ++v) {
         for(int w = 0; w < p; ++w) {
            ...
            int x = r + v * m;
            int y = s + w * m;
            fill(matrices, x, y, x + k, y + k, STATUS_TO_COLOR.getInt(chunkStatus) | -16777216);
         }
      }
