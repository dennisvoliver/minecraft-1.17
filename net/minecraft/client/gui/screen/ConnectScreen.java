...
public class ConnectScreen extends Screen {
   ...
   private void connect(final MinecraftClient client, final ServerAddress address) {
      LOGGER.info((String)"Connecting to {}, {}", (Object)address.getAddress(), (Object)address.getPort());
         ...
         public void run() {
            ...
            try {
               ...
               if (!optional.isPresent()) {
                  client.execute(() -> {
                     client.openScreen(new DisconnectedScreen(ConnectScreen.this.parent, ScreenTexts.CONNECT_FAILED, ConnectScreen.BLOCKED_HOST_TEXT));
                  });
                  return;
               }
               ...
               client.execute(() -> {
                  client.openScreen(new DisconnectedScreen(ConnectScreen.this.parent, ScreenTexts.CONNECT_FAILED, new TranslatableText("disconnect.genericReason", new Object[]{string})));
               });
            }
   ...
   public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
      ...
      if (l - this.narratorTimer > 2000L) {
         ...
         NarratorManager.INSTANCE.narrate((Text)(new TranslatableText("narrator.joining")));
      }
