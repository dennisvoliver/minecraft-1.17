...
public class GlProgramManager {
   ...
   public static void linkProgram(GlShader shader) {
      ...
      if (i == 0) {
         LOGGER.warn((String)"Error encountered when linking program containing VS {} and FS {}. Log output:", (Object)shader.getVertexShader().getName(), (Object)shader.getFragmentShader().getName());
