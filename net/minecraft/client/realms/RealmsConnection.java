...
public class RealmsConnection {
   ...
   public void connect(final RealmsServer server, ServerAddress address) {
      ...
      NarratorManager.INSTANCE.narrate((Text)(new TranslatableText("mco.connect.success")));
      ...
      (new Thread("Realms-connect-task") {
         public void run() {
            ...
            try {
               ...
               DisconnectedRealmsScreen disconnectedRealmsScreen = new DisconnectedRealmsScreen(RealmsConnection.this.onlineScreen, ScreenTexts.CONNECT_FAILED, new TranslatableText("disconnect.genericReason", new Object[]{stringx}));
