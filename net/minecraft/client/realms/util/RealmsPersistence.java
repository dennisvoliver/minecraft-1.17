...
public class RealmsPersistence {
   ...
   public static RealmsPersistence.RealmsPersistenceData readFile() {
      ...
      try {
         ...
         RealmsPersistence.RealmsPersistenceData realmsPersistenceData = (RealmsPersistence.RealmsPersistenceData)CHECKED_GSON.fromJson(string, RealmsPersistence.RealmsPersistenceData.class);
