...
public class RealmsClient {
   ...
   public RealmsServerAddress join(long worldId) throws RealmsServiceException {
      String string = this.url("worlds" + "/v1/$ID/join/pc".replace("$ID", worldId.makeConcatWithConstants<invokedynamic>(worldId)));
      ...
      try {
         ...
         if (i != 503 && i != 277) {
            ...
            if (i >= 200 && i < 300) {
               ...
               LOGGER.info((String)"Could not authorize you against Realms server: {}", (Object)string2);
               throw new RealmsServiceException(i, string2, -1, string2);
            } else if (string != null && string.length() != 0) {
               RealmsError realmsError = RealmsError.create(string);
               LOGGER.error((String)"Realms http code: {} -  error code: {} -  message: {} - raw body: {}", (Object)i, realmsError.getErrorCode(), realmsError.getErrorMessage(), string);
               throw new RealmsServiceException(i, string, realmsError);
            } else {
               LOGGER.error((String)"Realms error code: {} message: {}", (Object)i, (Object)string);
