...
public class RepeatedNarrator {
   ...
   public void narrate(Text text) {
      RepeatedNarrator.Parameters parameters = (RepeatedNarrator.Parameters)this.params.updateAndGet((parametersx) -> {
         return parametersx != null && text.equals(parametersx.message) ? parametersx : new RepeatedNarrator.Parameters(text, RateLimiter.create((double)this.permitsPerSecond));
      });
