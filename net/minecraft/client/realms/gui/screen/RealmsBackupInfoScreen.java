...
public class RealmsBackupInfoScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.addDrawableChild(new ButtonWidget(this.width / 2 - 100, this.height / 4 + 120 + 24, 200, 20, ScreenTexts.BACK, (button) -> {
   ...
   @Environment(EnvType.CLIENT)
   private class BackupInfoList extends AlwaysSelectedEntryListWidget<RealmsBackupInfoScreen.BackupInfoListEntry> {
   ...
   class BackupInfoListEntry extends AlwaysSelectedEntryListWidget.Entry<RealmsBackupInfoScreen.BackupInfoListEntry> {
      ...
      public Text method_37006() {
         return new TranslatableText("narrator.select", new Object[]{this.key + " " + this.value});
      }
   }
}
