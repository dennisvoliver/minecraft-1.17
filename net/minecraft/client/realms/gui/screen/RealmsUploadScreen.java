...
public class RealmsUploadScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.backButton = (ButtonWidget)this.addDrawableChild(new ButtonWidget(this.width / 2 - 100, this.height - 42, 200, 20, ScreenTexts.BACK, (button) -> {
         this.onBack();
      }));
      this.backButton.visible = false;
      this.cancelButton = (ButtonWidget)this.addDrawableChild(new ButtonWidget(this.width / 2 - 100, this.height - 42, 200, 20, ScreenTexts.CANCEL, (button) -> {
         this.onCancel();
      }));
      ...
      (new Thread(() -> {
         ...
         try {
            ...
            if (UPLOAD_LOCK.isHeldByCurrentThread()) {
               ...
               if (file != null) {
                  LOGGER.debug((String)"Deleting file {}", (Object)file.getAbsolutePath());
                  file.delete();
               }
