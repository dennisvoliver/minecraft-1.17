...
public class RealmsSubscriptionInfoScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.addDrawableChild(new ButtonWidget(this.width / 2 - 100, row(6), 200, 20, new TranslatableText("mco.configure.world.subscription.extend"), (button) -> {
         String var10000 = this.serverData.remoteSubscriptionId;
         String string = "https://aka.ms/ExtendJavaRealms?subscriptionId=" + var10000 + "&profileId=" + this.client.getSession().getUuid();
         this.client.keyboard.setClipboard(string);
         Util.getOperatingSystem().open(string);
      }));
      this.addDrawableChild(new ButtonWidget(this.width / 2 - 100, row(12), 200, 20, ScreenTexts.BACK, (button) -> {
