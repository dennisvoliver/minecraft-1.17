...
public class RealmsSettingsScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.doneButton = (ButtonWidget)this.addDrawableChild(new ButtonWidget(i - 2, row(12), 106, 20, new TranslatableText("mco.configure.world.buttons.done"), (button) -> {
         this.save();
      }));
      this.addDrawableChild(new ButtonWidget(this.width / 2 + 2, row(12), 106, 20, ScreenTexts.CANCEL, (button) -> {
