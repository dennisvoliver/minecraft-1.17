...
public class RealmsPlayerScreen extends RealmsScreen {
   ...
   RealmsPlayerScreen.PlayerOperation operation;
   ...
   public void init() {
      ...
      this.addDrawableChild(new ButtonWidget(this.column2_x, row(1), this.column_width + 10, 20, new TranslatableText("mco.configure.world.buttons.invite"), (button) -> {
         this.client.openScreen(new RealmsInviteScreen(this.parent, this, this.serverData));
      }));
      this.removeButton = (ButtonWidget)this.addDrawableChild(new ButtonWidget(this.column2_x, row(7), this.column_width + 10, 20, new TranslatableText("mco.configure.world.invites.remove.tooltip"), (button) -> {
         this.uninvite(this.player);
      }));
      this.opdeopButton = (ButtonWidget)this.addDrawableChild(new ButtonWidget(this.column2_x, row(9), this.column_width + 10, 20, new TranslatableText("mco.configure.world.invites.ops.tooltip"), (button) -> {
      ...
      this.addDrawableChild(new ButtonWidget(this.column2_x + this.column_width / 2 + 2, row(12), this.column_width / 2 + 10 - 2, 20, ScreenTexts.BACK, (button) -> {
   ...
   public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
      ...
      if (this.serverData != null && this.serverData.players != null) {
         this.textRenderer.draw(matrices, (Text)(new LiteralText("")).append(INVITED_TEXT).append(" (").append(Integer.toString(this.serverData.players.size())).append(")"), (float)this.column1_x, (float)row(0), 10526880);
      } else {
   ...
   class InvitedObjectSelectionListEntry extends AlwaysSelectedEntryListWidget.Entry<RealmsPlayerScreen.InvitedObjectSelectionListEntry> {
      ...
      public Text method_37006() {
         return new TranslatableText("narrator.select", new Object[]{this.playerInfo.getName()});
      }
   }
}
