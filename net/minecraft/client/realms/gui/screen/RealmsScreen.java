...
public abstract class RealmsScreen extends Screen {
   ...
   protected RealmsLabel method_37107(RealmsLabel realmsLabel) {
      ...
      return (RealmsLabel)this.addDrawable(realmsLabel);
   }

   public Text narrateLabels() {
      return ScreenTexts.joinLines((Collection)this.field_33848.stream().map(RealmsLabel::getText).collect(Collectors.toList()));
   }
}
