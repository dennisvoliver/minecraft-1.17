...
public class SamplingRecorder {
   ...
   @Nullable
   final SamplingRecorder.ValueConsumer writeAction;
   private double field_33884;

   protected SamplingRecorder(String string, SamplingChannel samplingChannel, DoubleSupplier doubleSupplier, @Nullable Runnable runnable, @Nullable SamplingRecorder.ValueConsumer valueConsumer) {
   ...
   public static SamplingRecorder create(String string, SamplingChannel samplingChannel, DoubleSupplier doubleSupplier) {
      return new SamplingRecorder(string, samplingChannel, doubleSupplier, (Runnable)null, (SamplingRecorder.ValueConsumer)null);
   }
   ...
   public SamplingRecorder.class_6398 method_37173() {
      ...
      int j;
      int k;
      for(j = Integer.MIN_VALUE; this.buffer.isReadable(8); j = k) {
         k = this.field_33883.readInt();
