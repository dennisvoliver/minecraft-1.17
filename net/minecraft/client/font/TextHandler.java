...
public class TextHandler {
   ...
   public List<StringVisitable> wrapLines(StringVisitable text, int maxWidth, Style style) {
      List<StringVisitable> list = Lists.newArrayList();
      this.wrapLines(text, maxWidth, style, (textx, boolean_) -> {
         list.add(textx);
      });
      return list;
   }
   ...
   public List<StringVisitable> method_35714(StringVisitable stringVisitable, int maxWidth, Style style, StringVisitable stringVisitable2) {
      List<StringVisitable> list = Lists.newArrayList();
      this.wrapLines(stringVisitable, maxWidth, style, (stringVisitable2x, boolean_) -> {
         list.add(boolean_ ? StringVisitable.concat(stringVisitable2, stringVisitable2x) : stringVisitable2x);
      });
      return list;
   }
   ...
   @Environment(EnvType.CLIENT)
   private class LineBreakingVisitor implements CharacterVisitor {
