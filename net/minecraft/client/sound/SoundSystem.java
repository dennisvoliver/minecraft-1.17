               ...
               if (sound2 == SoundManager.MISSING_SOUND) {
                  ...
                  if (h == 0.0F && !sound.shouldAlwaysPlay()) {
                     ...
                     if (this.listener.getVolume() <= 0.0F) {
                        ...
                        bl3 = shouldRepeatInstantly(sound);
                        ...
                        if (sourceManager == null) {
                           ...
                           LOGGER.debug((Marker)MARKER, (String)"Playing sound {} for event {}", sound2.getIdentifier(), identifier);
                           ...
                           if (!bl4) {
                              this.soundLoader.loadStatic(sound2.getLocation()).thenAccept((staticSound) -> {
                                 sourceManager.run((source) -> {
                              ...
                              this.soundLoader.loadStreamed(sound2.getLocation(), bl3).thenAccept((audioStream) -> {
                                 sourceManager.run((source) -> {
   ...
   public void stopSounds(@Nullable Identifier id, @Nullable SoundCategory category) {
      ...
      if (category != null) {
         ...
         while(true) {
            ...
            } while(id != null && !soundInstance2.getId().equals(id));
