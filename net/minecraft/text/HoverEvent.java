...
public class HoverEvent {
   ...
   public static class Action<T> {
      ...
      public static final HoverEvent.Action<HoverEvent.ItemStackContent> SHOW_ITEM = new HoverEvent.Action("show_item", true, HoverEvent.ItemStackContent::parse, HoverEvent.ItemStackContent::toJson, HoverEvent.ItemStackContent::parse);
   ...
   public static class ItemStackContent {
      ...
      private static HoverEvent.ItemStackContent parse(JsonElement json) {
         if (json.isJsonPrimitive()) {
            return new HoverEvent.ItemStackContent((Item)Registry.ITEM.get(new Identifier(json.getAsString())), 1, (NbtCompound)null);
         } else {
            ...
            return new HoverEvent.ItemStackContent(item, i, (NbtCompound)null);
         }
      }
   ...
   public static class EntityContent {
      ...
      public static HoverEvent.EntityContent parse(Text text) {
         try {
            ...
            EntityType<?> entityType = (EntityType)Registry.ENTITY_TYPE.get(new Identifier(nbtCompound.getString("type")));
