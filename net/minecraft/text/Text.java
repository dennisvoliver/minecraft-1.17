      ...
      public MutableText deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
         if (jsonElement.isJsonPrimitive()) {
            ...
            if (jsonElement.isJsonArray()) {
               ...
               Iterator var16 = jsonArray3.iterator();

               while(var16.hasNext()) {
                  JsonElement jsonElement2 = (JsonElement)var16.next();
            ...
            if (jsonObject.has("text")) {
               ...
               if (jsonObject.has("translate")) {
                  ...
                  mutableText12 = new SelectorText(JsonHelper.getString(jsonObject, "selector"), optional);
                  ...
                  if (jsonObject.has("block")) {
                     mutableText12 = new NbtText.BlockNbtText(string2, bl, JsonHelper.getString(jsonObject, "block"), optional2);
                  } else if (jsonObject.has("entity")) {
                     mutableText12 = new NbtText.EntityNbtText(string2, bl, JsonHelper.getString(jsonObject, "entity"), optional2);
                  } else {
                     if (!jsonObject.has("storage")) {
                        throw new JsonParseException("Don't know how to turn " + jsonElement + " into a Component");
                     }

                     mutableText12 = new NbtText.StorageNbtText(string2, bl, new Identifier(JsonHelper.getString(jsonObject, "storage")), optional2);
                  }
               }
            }
