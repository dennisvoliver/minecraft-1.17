   ...
   public static class Conditions extends AbstractCriterionConditions {
      ...
      public static InventoryChangedCriterion.Conditions items(ItemConvertible... items) {
         ...
         for(int i = 0; i < items.length; ++i) {
            itemPredicates[i] = new ItemPredicate((Tag)null, ImmutableSet.of(items[i].asItem()), NumberRange.IntRange.ANY, NumberRange.IntRange.ANY, EnchantmentPredicate.ARRAY_OF_ANY, EnchantmentPredicate.ARRAY_OF_ANY, (Potion)null, NbtPredicate.ANY);
         }
