...
public class LootScoreProviderTypes {
   ...
   private static LootScoreProviderType register(String id, JsonSerializer<? extends LootScoreProvider> jsonSerializer) {
      return (LootScoreProviderType)Registry.register(Registry.LOOT_SCORE_PROVIDER_TYPE, (Identifier)(new Identifier(id)), new LootScoreProviderType(jsonSerializer));
   }
