...
public class ExplorationMapLootFunction extends ConditionalLootFunction {
   ...
   public static final StructureFeature<?> DEFAULT_DESTINATION;
      ...
      if (!stack.isOf(Items.MAP)) {
         ...
         if (vec3d != null) {
            ...
            if (blockPos != null) {
               ...
               String var10003 = this.destination.getName();
   ...
   static {
      DEFAULT_DESTINATION = StructureFeature.BURIED_TREASURE;
   ...
   public static class Serializer extends ConditionalLootFunction.Serializer<ExplorationMapLootFunction> {
      ...
      public ExplorationMapLootFunction fromJson(JsonObject jsonObject, JsonDeserializationContext jsonDeserializationContext, LootCondition[] lootConditions) {
         ...
         try {
            ...
            ExplorationMapLootFunction.LOGGER.error((String)"Error while parsing loot table decoration entry. Found {}. Defaulting to {}", (Object)string, (Object)ExplorationMapLootFunction.DEFAULT_DECORATION);
         }
