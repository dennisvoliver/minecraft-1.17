      ...
      public LootContext build(LootContextType type) {
         ...
         if (!set.isEmpty()) {
            ...
            if (!set2.isEmpty()) {
               ...
               ServerWorld var10004 = this.world;
               LootManager var10005 = minecraftServer.getLootManager();
               Objects.requireNonNull(var10005);
               Function var6 = var10005::getTable;
               LootConditionManager var10006 = minecraftServer.getPredicateManager();
               Objects.requireNonNull(var10006);
               return new LootContext(random, var10003, var10004, var6, var10006::get, this.parameters, this.drops);
            }
         }
      }
   }
