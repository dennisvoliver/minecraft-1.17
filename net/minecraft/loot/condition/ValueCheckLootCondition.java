...
public class ValueCheckLootCondition implements LootCondition {
   ...
   public static class Serializer implements JsonSerializer<ValueCheckLootCondition> {
      ...
      public ValueCheckLootCondition fromJson(JsonObject jsonObject, JsonDeserializationContext jsonDeserializationContext) {
         LootNumberProvider lootNumberProvider = (LootNumberProvider)JsonHelper.deserialize(jsonObject, "value", jsonDeserializationContext, LootNumberProvider.class);
         BoundedIntUnaryOperator boundedIntUnaryOperator = (BoundedIntUnaryOperator)JsonHelper.deserialize(jsonObject, "range", jsonDeserializationContext, BoundedIntUnaryOperator.class);
