...
public class RuinedPortalStructurePiece extends SimpleStructurePiece {
   ...
   public RuinedPortalStructurePiece(StructureManager structureManager, BlockPos blockPos, RuinedPortalStructurePiece.VerticalPlacement verticalPlacement, RuinedPortalStructurePiece.Properties properties, Identifier identifier, Structure structure, BlockRotation rotation, BlockMirror mirror, BlockPos blockPos2) {
      super(StructurePieceType.RUINED_PORTAL, 0, structureManager, identifier, identifier.toString(), createPlacementData(mirror, rotation, verticalPlacement, blockPos2, properties), blockPos);
      this.verticalPlacement = verticalPlacement;
      this.properties = properties;
   }

   public RuinedPortalStructurePiece(ServerWorld world, NbtCompound nbt) {
      super(StructurePieceType.RUINED_PORTAL, nbt, world, (identifier) -> {
         return createPlacementData(world, nbt, identifier);
      });
   ...
   private static StructurePlacementData createPlacementData(ServerWorld world, NbtCompound nbt, Identifier id) {
      ...
      RuinedPortalStructurePiece.VerticalPlacement var10002 = RuinedPortalStructurePiece.VerticalPlacement.getFromId(nbt.getString("VerticalPlacement"));
      DataResult var10004 = RuinedPortalStructurePiece.Properties.CODEC.parse(new Dynamic(NbtOps.INSTANCE, nbt.get("Properties")));
      Logger var10006 = field_24992;
      Objects.requireNonNull(var10006);
      return createPlacementData(var10000, var10001, var10002, blockPos, (RuinedPortalStructurePiece.Properties)var10004.getOrThrow(true, var10006::error));
   }
