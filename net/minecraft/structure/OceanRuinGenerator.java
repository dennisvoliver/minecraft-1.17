...
public class OceanRuinGenerator {
   ...
   private static void method_14825(StructureManager manager, Random random, BlockRotation rotation, BlockPos pos, OceanRuinFeatureConfig config, StructurePiecesHolder structurePiecesHolder) {
   ...
   public static class Piece extends SimpleStructurePiece {
      ...
      public Piece(ServerWorld world, NbtCompound nbt) {
         super(StructurePieceType.OCEAN_TEMPLE, nbt, world, (identifier) -> {
      ...
      protected void handleMetadata(String metadata, BlockPos pos, ServerWorldAccess world, Random random, BlockBox boundingBox) {
         if ("chest".equals(metadata)) {
            ...
            DrownedEntity drownedEntity = (DrownedEntity)EntityType.DROWNED.create(world.toServerWorld());
            drownedEntity.setPersistent();
            drownedEntity.refreshPositionAndAngles(pos, 0.0F, 0.0F);
            drownedEntity.initialize(world, world.getLocalDifficulty(pos), SpawnReason.STRUCTURE, (EntityData)null, (NbtCompound)null);
