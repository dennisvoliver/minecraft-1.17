...
public class OceanMonumentGenerator {
   ...
   private static class DoubleYZRoomFactory implements OceanMonumentGenerator.PieceFactory {
      DoubleYZRoomFactory() {
      }
   ...
   private static class DoubleXYRoomFactory implements OceanMonumentGenerator.PieceFactory {
      DoubleXYRoomFactory() {
      }
   ...
   private static class DoubleZRoomFactory implements OceanMonumentGenerator.PieceFactory {
      DoubleZRoomFactory() {
      }
   ...
   private static class DoubleXRoomFactory implements OceanMonumentGenerator.PieceFactory {
      DoubleXRoomFactory() {
      }
   ...
   private static class DoubleYRoomFactory implements OceanMonumentGenerator.PieceFactory {
      DoubleYRoomFactory() {
      }
   ...
   private static class SimpleRoomFactory implements OceanMonumentGenerator.PieceFactory {
      SimpleRoomFactory() {
      }
   ...
   public static class WingRoom extends OceanMonumentGenerator.Piece {
      ...
      public boolean generate(StructureWorldAccess world, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos, BlockPos pos) {
         if (this.field_14481 == 0) {
            int j;
            for(j = 0; j < 4; ++j) {
               this.fillWithOutline(world, boundingBox, 10 - j, 3 - j, 20 - j, 12 + j, 3 - j, 20, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
            }
            ...
            for(p = 0; p < 2; ++p) {
               this.fillWithOutline(world, boundingBox, k, 0, 10, k, 6, 10, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
               this.fillWithOutline(world, boundingBox, k, 0, 12, k, 6, 12, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
               this.addBlock(world, SEA_LANTERN, k, 0, 10, boundingBox);
               this.addBlock(world, SEA_LANTERN, k, 0, 12, boundingBox);
               this.addBlock(world, SEA_LANTERN, k, 4, 10, boundingBox);
               this.addBlock(world, SEA_LANTERN, k, 4, 12, boundingBox);
               k = 12;
            }
            ...
            for(p = 0; p < 2; ++p) {
               this.fillWithOutline(world, boundingBox, k, 0, 7, k, 2, 7, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
               this.fillWithOutline(world, boundingBox, k, 0, 14, k, 2, 14, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
               k = 14;
            }
   ...
   public static class CoreRoom extends OceanMonumentGenerator.Piece {
      ...
      public boolean generate(StructureWorldAccess world, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos, BlockPos pos) {
         ...
         this.fillWithOutline(world, boundingBox, 0, 7, 0, 0, 7, 15, blockState2, blockState2, false);
         this.fillWithOutline(world, boundingBox, 15, 7, 0, 15, 7, 15, blockState2, blockState2, false);
         this.fillWithOutline(world, boundingBox, 1, 7, 0, 15, 7, 0, blockState2, blockState2, false);
         this.fillWithOutline(world, boundingBox, 1, 7, 15, 14, 7, 15, blockState2, blockState2, false);
         ...
         for(l = 1; l <= 6; ++l) {
            ...
            for(int k = 0; k <= 15; k += 15) {
               this.fillWithOutline(world, boundingBox, k, l, 0, k, l, 1, blockState2, blockState2, false);
               this.fillWithOutline(world, boundingBox, k, l, 6, k, l, 9, blockState2, blockState2, false);
               this.fillWithOutline(world, boundingBox, k, l, 14, k, l, 15, blockState2, blockState2, false);
            }

            this.fillWithOutline(world, boundingBox, 1, l, 0, 1, l, 0, blockState2, blockState2, false);
            this.fillWithOutline(world, boundingBox, 6, l, 0, 9, l, 0, blockState2, blockState2, false);
            this.fillWithOutline(world, boundingBox, 14, l, 0, 14, l, 0, blockState2, blockState2, false);
            this.fillWithOutline(world, boundingBox, 1, l, 15, 14, l, 15, blockState2, blockState2, false);
         }
   ...
   public static class DoubleYZRoom extends OceanMonumentGenerator.Piece {
      ...
      public boolean generate(StructureWorldAccess world, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos, BlockPos pos) {
         ...
         for(j = 1; j <= 7; ++j) {
            ...
            this.fillWithOutline(world, boundingBox, 0, j, 0, 0, j, 15, blockState2, blockState2, false);
            this.fillWithOutline(world, boundingBox, 7, j, 0, 7, j, 15, blockState2, blockState2, false);
            this.fillWithOutline(world, boundingBox, 1, j, 0, 6, j, 0, blockState2, blockState2, false);
            this.fillWithOutline(world, boundingBox, 1, j, 15, 6, j, 15, blockState2, blockState2, false);
         }
   ...
   public static class Base extends OceanMonumentGenerator.Piece {
            ...
            while(true) {
               ...
               do {
                  do {
                     ...
                     pieceSetting = (OceanMonumentGenerator.PieceSetting)var7.next();
               ...
               while(var9.hasNext()) {
                  OceanMonumentGenerator.PieceFactory pieceFactory = (OceanMonumentGenerator.PieceFactory)var9.next();
      ...
      private void method_14761(boolean bl, int i, StructureWorldAccess world, Random random, BlockBox box) {
         ...
         if (this.method_14775(box, i, 0, i + 23, 20)) {
            ...
            int l;
            for(l = 0; l < 4; ++l) {
               this.fillWithOutline(world, box, i + l, l + 1, l, i + l, l + 1, 20, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
               this.fillWithOutline(world, box, i + l + 7, l + 5, l + 7, i + l + 7, l + 5, 20, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
               this.fillWithOutline(world, box, i + 17 - l, l + 5, l + 7, i + 17 - l, l + 5, 20, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
               this.fillWithOutline(world, box, i + 24 - l, l + 1, l, i + 24 - l, l + 1, 20, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
               this.fillWithOutline(world, box, i + l + 1, l + 1, l, i + 23 - l, l + 1, l, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
               this.fillWithOutline(world, box, i + l + 8, l + 5, l + 7, i + 16 - l, l + 5, l + 7, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
            }
            ...
            int p;
            for(p = 20; p >= 5; p -= 3) {
               this.addBlock(world, ALSO_PRISMARINE_BRICKS, l, 5, p, box);
            }

            for(p = 19; p >= 7; p -= 3) {
               this.addBlock(world, ALSO_PRISMARINE_BRICKS, m, 5, p, box);
            }
      ...
      private void method_14762(StructureWorldAccess world, Random random, BlockBox box) {
         if (this.method_14775(box, 15, 20, 42, 21)) {
            ...
            int k;
            for(k = 0; k < 7; ++k) {
               this.addBlock(world, DARK_PRISMARINE, 28 - k, 6 + k, 21, box);
               this.addBlock(world, DARK_PRISMARINE, 29 + k, 6 + k, 21, box);
            }

            for(k = 0; k < 4; ++k) {
               this.addBlock(world, DARK_PRISMARINE, 28 - k, 9 + k, 21, box);
               this.addBlock(world, DARK_PRISMARINE, 29 + k, 9 + k, 21, box);
            }
      ...
      private void method_14764(StructureWorldAccess world, Random random, BlockBox box) {
         ...
         if (this.method_14775(box, 0, 21, 6, 58)) {
            ...
            for(k = 23; k < 53; k += 3) {
               this.addBlock(world, ALSO_PRISMARINE_BRICKS, 5, 5, k, box);
            }
         ...
         if (this.method_14775(box, 51, 21, 58, 58)) {
            ...
            for(k = 0; k < 4; ++k) {
               this.fillWithOutline(world, box, 57 - k, k + 1, 21, 57 - k, k + 1, 57 - k, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
            }

            for(k = 23; k < 53; k += 3) {
               this.addBlock(world, ALSO_PRISMARINE_BRICKS, 52, 5, k, box);
            }
         ...
         if (this.method_14775(box, 0, 51, 57, 57)) {
            ...
            for(k = 0; k < 4; ++k) {
               this.fillWithOutline(world, box, k + 1, k + 1, 57 - k, 56 - k, k + 1, 57 - k, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
            }
         }
      ...
      private void method_14766(StructureWorldAccess world, Random random, BlockBox box) {
         ...
         if (this.method_14775(box, 7, 21, 13, 50)) {
            ...
            for(n = 0; n < 4; ++n) {
               this.fillWithOutline(world, box, n + 7, n + 5, 21, n + 7, n + 5, 54, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
            }

            for(n = 21; n <= 45; n += 3) {
               this.addBlock(world, ALSO_PRISMARINE_BRICKS, 12, 9, n, box);
            }
         }
         ...
         if (this.method_14775(box, 44, 21, 50, 54)) {
            ...
            for(n = 0; n < 4; ++n) {
               this.fillWithOutline(world, box, 50 - n, n + 5, 21, 50 - n, n + 5, 54, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
            }

            for(n = 21; n <= 45; n += 3) {
               this.addBlock(world, ALSO_PRISMARINE_BRICKS, 45, 9, n, box);
            }
         }
         ...
         if (this.method_14775(box, 8, 44, 49, 54)) {
            ...
            for(n = 12; n <= 45; n += 3) {
               this.addBlock(world, ALSO_PRISMARINE_BRICKS, n, 9, 45, box);
               this.addBlock(world, ALSO_PRISMARINE_BRICKS, n, 9, 52, box);
               if (n == 12 || n == 18 || n == 24 || n == 33 || n == 39 || n == 45) {
                  this.addBlock(world, ALSO_PRISMARINE_BRICKS, n, 9, 47, box);
                  this.addBlock(world, ALSO_PRISMARINE_BRICKS, n, 9, 50, box);
                  this.addBlock(world, ALSO_PRISMARINE_BRICKS, n, 10, 45, box);
                  this.addBlock(world, ALSO_PRISMARINE_BRICKS, n, 10, 46, box);
                  this.addBlock(world, ALSO_PRISMARINE_BRICKS, n, 10, 51, box);
                  this.addBlock(world, ALSO_PRISMARINE_BRICKS, n, 10, 52, box);
                  this.addBlock(world, ALSO_PRISMARINE_BRICKS, n, 11, 47, box);
                  this.addBlock(world, ALSO_PRISMARINE_BRICKS, n, 11, 50, box);
                  this.addBlock(world, ALSO_PRISMARINE_BRICKS, n, 12, 48, box);
                  this.addBlock(world, ALSO_PRISMARINE_BRICKS, n, 12, 49, box);
               }
            }
      ...
      private void method_14767(StructureWorldAccess world, Random random, BlockBox box) {
         ...
         if (this.method_14775(box, 14, 21, 20, 43)) {
            ...
            for(n = 0; n < 4; ++n) {
               this.fillWithOutline(world, box, n + 14, n + 9, 21, n + 14, n + 9, 43 - n, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
            }

            for(n = 23; n <= 39; n += 3) {
               this.addBlock(world, ALSO_PRISMARINE_BRICKS, 19, 13, n, box);
            }
         }
         ...
         if (this.method_14775(box, 37, 21, 43, 43)) {
            ...
            for(n = 0; n < 4; ++n) {
               this.fillWithOutline(world, box, 43 - n, n + 9, 21, 43 - n, n + 9, 43 - n, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
            }

            for(n = 23; n <= 39; n += 3) {
               this.addBlock(world, ALSO_PRISMARINE_BRICKS, 38, 13, n, box);
            }
         }
         ...
         if (this.method_14775(box, 15, 37, 42, 43)) {
            ...
            for(n = 0; n < 4; ++n) {
               this.fillWithOutline(world, box, 15 + n, n + 9, 43 - n, 42 - n, n + 9, 43 - n, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
            }
   ...
   protected abstract static class Piece extends StructurePiece {
      ...
      protected boolean spawnElderGuardian(StructureWorldAccess world, BlockBox box, int x, int y, int z) {
         ...
         if (box.contains(blockPos)) {
            ElderGuardianEntity elderGuardianEntity = (ElderGuardianEntity)EntityType.ELDER_GUARDIAN.create(world.toServerWorld());
            elderGuardianEntity.heal(elderGuardianEntity.getMaxHealth());
            elderGuardianEntity.refreshPositionAndAngles((double)blockPos.getX() + 0.5D, (double)blockPos.getY(), (double)blockPos.getZ() + 0.5D, 0.0F, 0.0F);
            elderGuardianEntity.initialize(world, world.getLocalDifficulty(elderGuardianEntity.getBlockPos()), SpawnReason.STRUCTURE, (EntityData)null, (NbtCompound)null);
