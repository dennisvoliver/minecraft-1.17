...
public class WoodlandMansionGenerator {
   ...
   private static class LayoutGenerator {
                  ...
                  if (flagMatrix4.get(q, p) == 2 || bl2) {
                     ...
                     if (s == 65536) {
                        ...
                        if (s == 131072 && direction2 != null) {
                           direction4 = parameters.method_15040(flagMatrix4, q, p, m, t);
      ...
      private void addRoof(List<WoodlandMansionGenerator.Piece> pieces, WoodlandMansionGenerator.GenerationPiece generationPiece, WoodlandMansionGenerator.FlagMatrix flagMatrix, Direction direction, int i, int j, int k, int l) {
         int m = i;
         int n = j;
      ...
      private void addEntrance(List<WoodlandMansionGenerator.Piece> pieces, WoodlandMansionGenerator.GenerationPiece generationPiece) {
         ...
         pieces.add(new WoodlandMansionGenerator.Piece(this.manager, "entrance", generationPiece.position.offset((Direction)direction, 9), generationPiece.rotation));
      ...
      private void addMediumRoom(List<WoodlandMansionGenerator.Piece> pieces, BlockPos pos, BlockRotation rotation, Direction direction, Direction direction2, WoodlandMansionGenerator.RoomPool roomPool, boolean staircase) {
         ...
         if (direction2 == Direction.EAST && direction == Direction.SOUTH) {
            blockPos14 = pos.offset((Direction)rotation.rotate(Direction.EAST), 1);
            pieces.add(new WoodlandMansionGenerator.Piece(this.manager, roomPool.getMediumFunctionalRoom(this.random, staircase), blockPos14, rotation));
         } else if (direction2 == Direction.EAST && direction == Direction.NORTH) {
            blockPos14 = pos.offset((Direction)rotation.rotate(Direction.EAST), 1);
            blockPos14 = blockPos14.offset((Direction)rotation.rotate(Direction.SOUTH), 6);
            pieces.add(new WoodlandMansionGenerator.Piece(this.manager, roomPool.getMediumFunctionalRoom(this.random, staircase), blockPos14, rotation, BlockMirror.LEFT_RIGHT));
         } else if (direction2 == Direction.WEST && direction == Direction.NORTH) {
            blockPos14 = pos.offset((Direction)rotation.rotate(Direction.EAST), 7);
            blockPos14 = blockPos14.offset((Direction)rotation.rotate(Direction.SOUTH), 6);
            pieces.add(new WoodlandMansionGenerator.Piece(this.manager, roomPool.getMediumFunctionalRoom(this.random, staircase), blockPos14, rotation.rotate(BlockRotation.CLOCKWISE_180)));
         } else if (direction2 == Direction.WEST && direction == Direction.SOUTH) {
            blockPos14 = pos.offset((Direction)rotation.rotate(Direction.EAST), 7);
            pieces.add(new WoodlandMansionGenerator.Piece(this.manager, roomPool.getMediumFunctionalRoom(this.random, staircase), blockPos14, rotation, BlockMirror.FRONT_BACK));
         } else if (direction2 == Direction.SOUTH && direction == Direction.EAST) {
            blockPos14 = pos.offset((Direction)rotation.rotate(Direction.EAST), 1);
            pieces.add(new WoodlandMansionGenerator.Piece(this.manager, roomPool.getMediumFunctionalRoom(this.random, staircase), blockPos14, rotation.rotate(BlockRotation.CLOCKWISE_90), BlockMirror.LEFT_RIGHT));
         } else if (direction2 == Direction.SOUTH && direction == Direction.WEST) {
            blockPos14 = pos.offset((Direction)rotation.rotate(Direction.EAST), 7);
            pieces.add(new WoodlandMansionGenerator.Piece(this.manager, roomPool.getMediumFunctionalRoom(this.random, staircase), blockPos14, rotation.rotate(BlockRotation.CLOCKWISE_90)));
         } else if (direction2 == Direction.NORTH && direction == Direction.WEST) {
            blockPos14 = pos.offset((Direction)rotation.rotate(Direction.EAST), 7);
            blockPos14 = blockPos14.offset((Direction)rotation.rotate(Direction.SOUTH), 6);
            pieces.add(new WoodlandMansionGenerator.Piece(this.manager, roomPool.getMediumFunctionalRoom(this.random, staircase), blockPos14, rotation.rotate(BlockRotation.CLOCKWISE_90), BlockMirror.FRONT_BACK));
         } else if (direction2 == Direction.NORTH && direction == Direction.EAST) {
            blockPos14 = pos.offset((Direction)rotation.rotate(Direction.EAST), 1);
            blockPos14 = blockPos14.offset((Direction)rotation.rotate(Direction.SOUTH), 6);
            pieces.add(new WoodlandMansionGenerator.Piece(this.manager, roomPool.getMediumFunctionalRoom(this.random, staircase), blockPos14, rotation.rotate(BlockRotation.COUNTERCLOCKWISE_90)));
         } else if (direction2 == Direction.SOUTH && direction == Direction.NORTH) {
            blockPos14 = pos.offset((Direction)rotation.rotate(Direction.EAST), 1);
            blockPos14 = blockPos14.offset((Direction)rotation.rotate(Direction.NORTH), 8);
            pieces.add(new WoodlandMansionGenerator.Piece(this.manager, roomPool.getMediumGenericRoom(this.random, staircase), blockPos14, rotation));
         } else if (direction2 == Direction.NORTH && direction == Direction.SOUTH) {
            blockPos14 = pos.offset((Direction)rotation.rotate(Direction.EAST), 7);
            blockPos14 = blockPos14.offset((Direction)rotation.rotate(Direction.SOUTH), 14);
            pieces.add(new WoodlandMansionGenerator.Piece(this.manager, roomPool.getMediumGenericRoom(this.random, staircase), blockPos14, rotation.rotate(BlockRotation.CLOCKWISE_180)));
         } else if (direction2 == Direction.WEST && direction == Direction.EAST) {
            blockPos14 = pos.offset((Direction)rotation.rotate(Direction.EAST), 15);
            pieces.add(new WoodlandMansionGenerator.Piece(this.manager, roomPool.getMediumGenericRoom(this.random, staircase), blockPos14, rotation.rotate(BlockRotation.CLOCKWISE_90)));
         } else if (direction2 == Direction.EAST && direction == Direction.WEST) {
            blockPos14 = pos.offset((Direction)rotation.rotate(Direction.WEST), 7);
            blockPos14 = blockPos14.offset((Direction)rotation.rotate(Direction.SOUTH), 6);
            pieces.add(new WoodlandMansionGenerator.Piece(this.manager, roomPool.getMediumGenericRoom(this.random, staircase), blockPos14, rotation.rotate(BlockRotation.COUNTERCLOCKWISE_90)));
         } else if (direction2 == Direction.UP && direction == Direction.EAST) {
            blockPos14 = pos.offset((Direction)rotation.rotate(Direction.EAST), 15);
            pieces.add(new WoodlandMansionGenerator.Piece(this.manager, roomPool.getMediumSecretRoom(this.random), blockPos14, rotation.rotate(BlockRotation.CLOCKWISE_90)));
         } else if (direction2 == Direction.UP && direction == Direction.SOUTH) {
            blockPos14 = pos.offset((Direction)rotation.rotate(Direction.EAST), 1);
            blockPos14 = blockPos14.offset((Direction)rotation.rotate(Direction.NORTH), 0);
   ...
   private static class ThirdFloorRoomPool extends WoodlandMansionGenerator.SecondFloorRoomPool {
      ThirdFloorRoomPool() {
      }
   }

   private static class SecondFloorRoomPool extends WoodlandMansionGenerator.RoomPool {
      SecondFloorRoomPool() {
      }
   ...
   public static class Piece extends SimpleStructurePiece {
      ...
      public Piece(ServerWorld world, NbtCompound nbt) {
         super(StructurePieceType.WOODLAND_MANSION, nbt, world, (identifier) -> {
      ...
      protected void handleMetadata(String metadata, BlockPos pos, ServerWorldAccess world, Random random, BlockBox boundingBox) {
         if (metadata.startsWith("Chest")) {
            ...
            switch(var8) {
            case 0:
               illagerEntity3 = (IllagerEntity)EntityType.EVOKER.create(world.toServerWorld());
               break;
            case 1:
               illagerEntity3 = (IllagerEntity)EntityType.VINDICATOR.create(world.toServerWorld());
               break;
            default:
               return;
            }
            ...
            illagerEntity3.initialize(world, world.getLocalDifficulty(illagerEntity3.getBlockPos()), SpawnReason.STRUCTURE, (EntityData)null, (NbtCompound)null);
            world.spawnEntityAndPassengers(illagerEntity3);
