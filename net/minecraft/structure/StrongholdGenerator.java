...
public class StrongholdGenerator {
   ...
   private static StrongholdGenerator.Piece createPiece(Class<? extends StrongholdGenerator.Piece> pieceType, StructurePiecesHolder structurePiecesHolder, Random random, int x, int y, int z, @Nullable Direction orientation, int chainLength) {
   ...
   static StructurePiece pieceGenerator(StrongholdGenerator.Start start, StructurePiecesHolder structurePiecesHolder, Random random, int x, int y, int z, @Nullable Direction orientation, int chainLength) {
      if (chainLength > 50) {
         return null;
   ...
   public static class Corridor extends StrongholdGenerator.Piece {
      ...
      public static StrongholdGenerator.Corridor create(StructurePiecesHolder structurePiecesHolder, Random random, int x, int y, int z, Direction orientation, int chainLength) {
         BlockBox blockBox = BlockBox.rotated(x, y, z, -1, -1, 0, 5, 5, 7, orientation);
         return isInBounds(blockBox) && structurePiecesHolder.getIntersecting(blockBox) == null ? new StrongholdGenerator.Corridor(chainLength, random, blockBox, orientation) : null;
      }
   ...
   public static class PrisonHall extends StrongholdGenerator.Piece {
      ...
      public static StrongholdGenerator.PrisonHall create(StructurePiecesHolder structurePiecesHolder, Random random, int x, int y, int z, Direction orientation, int chainLength) {
         BlockBox blockBox = BlockBox.rotated(x, y, z, -1, -1, 0, 9, 5, 11, orientation);
         return isInBounds(blockBox) && structurePiecesHolder.getIntersecting(blockBox) == null ? new StrongholdGenerator.PrisonHall(chainLength, random, blockBox, orientation) : null;
      }
   ...
   public static class LeftTurn extends StrongholdGenerator.Turn {
      ...
      public static StrongholdGenerator.LeftTurn create(StructurePiecesHolder structurePiecesHolder, Random random, int x, int y, int z, Direction orientation, int chainLength) {
         BlockBox blockBox = BlockBox.rotated(x, y, z, -1, -1, 0, 5, 5, 5, orientation);
         return isInBounds(blockBox) && structurePiecesHolder.getIntersecting(blockBox) == null ? new StrongholdGenerator.LeftTurn(chainLength, random, blockBox, orientation) : null;
      }
   ...
   public static class RightTurn extends StrongholdGenerator.Turn {
      ...
      public static StrongholdGenerator.RightTurn create(StructurePiecesHolder structurePiecesHolder, Random random, int x, int y, int z, Direction orientation, int chainLength) {
         BlockBox blockBox = BlockBox.rotated(x, y, z, -1, -1, 0, 5, 5, 5, orientation);
         return isInBounds(blockBox) && structurePiecesHolder.getIntersecting(blockBox) == null ? new StrongholdGenerator.RightTurn(chainLength, random, blockBox, orientation) : null;
      }
   ...
   public static class SquareRoom extends StrongholdGenerator.Piece {
      ...
      public static StrongholdGenerator.SquareRoom create(StructurePiecesHolder structurePiecesHolder, Random random, int x, int y, int z, Direction orientation, int chainLength) {
         BlockBox blockBox = BlockBox.rotated(x, y, z, -4, -1, 0, 11, 7, 11, orientation);
         return isInBounds(blockBox) && structurePiecesHolder.getIntersecting(blockBox) == null ? new StrongholdGenerator.SquareRoom(chainLength, random, blockBox, orientation) : null;
      }
   ...
   public static class Stairs extends StrongholdGenerator.Piece {
      ...
      public static StrongholdGenerator.Stairs create(StructurePiecesHolder structurePiecesHolder, Random random, int x, int y, int z, Direction orientation, int chainLength) {
         BlockBox blockBox = BlockBox.rotated(x, y, z, -1, -7, 0, 5, 11, 8, orientation);
         return isInBounds(blockBox) && structurePiecesHolder.getIntersecting(blockBox) == null ? new StrongholdGenerator.Stairs(chainLength, random, blockBox, orientation) : null;
      }
   ...
   public static class SpiralStaircase extends StrongholdGenerator.Piece {
      ...
      public static StrongholdGenerator.SpiralStaircase create(StructurePiecesHolder structurePiecesHolder, Random random, int x, int y, int z, Direction orientation, int chainLength) {
         BlockBox blockBox = BlockBox.rotated(x, y, z, -1, -7, 0, 5, 11, 5, orientation);
         return isInBounds(blockBox) && structurePiecesHolder.getIntersecting(blockBox) == null ? new StrongholdGenerator.SpiralStaircase(chainLength, random, blockBox, orientation) : null;
      }
   ...
   public static class FiveWayCrossing extends StrongholdGenerator.Piece {
      ...
      public static StrongholdGenerator.FiveWayCrossing create(StructurePiecesHolder structurePiecesHolder, Random random, int x, int y, int z, Direction orientation, int chainLength) {
         BlockBox blockBox = BlockBox.rotated(x, y, z, -4, -3, 0, 10, 9, 11, orientation);
         return isInBounds(blockBox) && structurePiecesHolder.getIntersecting(blockBox) == null ? new StrongholdGenerator.FiveWayCrossing(chainLength, random, blockBox, orientation) : null;
      }
   ...
   public static class ChestCorridor extends StrongholdGenerator.Piece {
      ...
      public static StrongholdGenerator.ChestCorridor create(StructurePiecesHolder structurePiecesHolder, Random random, int x, int y, int z, Direction orientation, int chainlength) {
         BlockBox blockBox = BlockBox.rotated(x, y, z, -1, -1, 0, 5, 5, 7, orientation);
         return isInBounds(blockBox) && structurePiecesHolder.getIntersecting(blockBox) == null ? new StrongholdGenerator.ChestCorridor(chainlength, random, blockBox, orientation) : null;
      }
   ...
   public static class Library extends StrongholdGenerator.Piece {
      ...
      public static StrongholdGenerator.Library create(StructurePiecesHolder structurePiecesHolder, Random random, int x, int y, int z, Direction orientation, int chainLength) {
   ...
   public static class PortalRoom extends StrongholdGenerator.Piece {
      ...
      public static StrongholdGenerator.PortalRoom create(StructurePiecesHolder structurePiecesHolder, int x, int y, int z, Direction orientation, int chainLength) {
         ...
         return isInBounds(blockBox) && structurePiecesHolder.getIntersecting(blockBox) == null ? new StrongholdGenerator.PortalRoom(chainLength, blockBox, orientation) : null;
      }
   ...
   private abstract static class Piece extends StructurePiece {
      ...
      @Nullable
      protected StructurePiece fillForwardOpening(StrongholdGenerator.Start start, StructurePiecesHolder structurePiecesHolder, Random random, int leftRightOffset, int heightOffset) {
         Direction direction = this.getFacing();
         if (direction != null) {
            switch(direction) {
            case NORTH:
      ...
      @Nullable
      protected StructurePiece fillNWOpening(StrongholdGenerator.Start start, StructurePiecesHolder structurePiecesHolder, Random random, int heightOffset, int leftRightOffset) {
         Direction direction = this.getFacing();
         if (direction != null) {
            switch(direction) {
            case NORTH:
      ...
      @Nullable
      protected StructurePiece fillSEOpening(StrongholdGenerator.Start start, StructurePiecesHolder structurePiecesHolder, Random random, int heightOffset, int leftRightOffset) {
         Direction direction = this.getFacing();
         if (direction != null) {
            switch(direction) {
            case NORTH:
