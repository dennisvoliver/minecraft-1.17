      ...
      if (!this.method_14839(world, boundingBox, 0)) {
         ...
         if (!this.hasWitch) {
            ...
            if (boundingBox.contains(blockPos)) {
               ...
               witchEntity.refreshPositionAndAngles((double)blockPos.getX() + 0.5D, (double)blockPos.getY(), (double)blockPos.getZ() + 0.5D, 0.0F, 0.0F);
   ...
   private void spawnCat(ServerWorldAccess world, BlockBox box) {
      if (!this.hasCat) {
         ...
         if (box.contains(blockPos)) {
            ...
            catEntity.refreshPositionAndAngles((double)blockPos.getX() + 0.5D, (double)blockPos.getY(), (double)blockPos.getZ() + 0.5D, 0.0F, 0.0F);
