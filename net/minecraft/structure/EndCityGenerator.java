...
public class EndCityGenerator {
   ...
   static EndCityGenerator.Piece createPiece(StructureManager structureManager, EndCityGenerator.Piece lastPiece, BlockPos relativePosition, String template, BlockRotation rotation, boolean ignoreAir) {
   ...
   public static class Piece extends SimpleStructurePiece {
      ...
      public Piece(ServerWorld world, NbtCompound nbtCompound) {
         super(StructurePieceType.END_CITY, nbtCompound, world, (identifier) -> {
