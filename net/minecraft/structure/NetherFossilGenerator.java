...
public class NetherFossilGenerator {
   ...
   public static void addPieces(StructureManager manager, StructurePiecesHolder structurePiecesHolder, Random random, BlockPos pos) {
      ...
      structurePiecesHolder.addPiece(new NetherFossilGenerator.Piece(manager, (Identifier)Util.getRandom((Object[])FOSSILS, random), pos, blockRotation));
   }
   ...
   public static class Piece extends SimpleStructurePiece {
      ...
      public Piece(ServerWorld world, NbtCompound nbt) {
         super(StructurePieceType.NETHER_FOSSIL, nbt, world, (identifier) -> {
