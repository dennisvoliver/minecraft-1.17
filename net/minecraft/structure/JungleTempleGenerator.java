...
public class JungleTempleGenerator extends StructurePieceWithDimensions {
   ...
   public boolean generate(StructureWorldAccess world, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos, BlockPos pos) {
      if (!this.method_14839(world, boundingBox, 0)) {
         ...
         int j;
         for(j = 0; j <= 14; j += 14) {
            this.fillWithOutline(world, boundingBox, 2, 4, j, 2, 5, j, false, random, COBBLESTONE_RANDOMIZER);
            this.fillWithOutline(world, boundingBox, 4, 4, j, 4, 5, j, false, random, COBBLESTONE_RANDOMIZER);
            this.fillWithOutline(world, boundingBox, 7, 4, j, 7, 5, j, false, random, COBBLESTONE_RANDOMIZER);
            this.fillWithOutline(world, boundingBox, 9, 4, j, 9, 5, j, false, random, COBBLESTONE_RANDOMIZER);
         }
         ...
         int n;
         for(n = 0; n < 4; ++n) {
            this.addBlock(world, blockState3, 5, 0 - n, 6 + n, boundingBox);
            this.addBlock(world, blockState3, 6, 0 - n, 6 + n, boundingBox);
            this.fill(world, boundingBox, 5, 0 - n, 7 + n, 6, 0 - n, 9 + n);
         }
         ...
         for(n = 1; n <= 13; n += 2) {
            this.fillWithOutline(world, boundingBox, 1, -3, n, 1, -2, n, false, random, COBBLESTONE_RANDOMIZER);
         }
