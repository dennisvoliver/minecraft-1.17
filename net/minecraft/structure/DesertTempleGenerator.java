...
public class DesertTempleGenerator extends StructurePieceWithDimensions {
   ...
   public boolean generate(StructureWorldAccess world, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos, BlockPos pos) {
      ...
      int j;
      for(j = 1; j <= 9; ++j) {
         this.fillWithOutline(world, boundingBox, j, j, j, this.width - 1 - j, j, this.depth - 1 - j, Blocks.SANDSTONE.getDefaultState(), Blocks.SANDSTONE.getDefaultState(), false);
         this.fillWithOutline(world, boundingBox, j + 1, j, j + 1, this.width - 2 - j, j, this.depth - 2 - j, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
      }
      ...
      this.fillWithOutline(world, boundingBox, this.width - 4, 10, 1, this.width - 2, 10, 3, Blocks.SANDSTONE.getDefaultState(), Blocks.SANDSTONE.getDefaultState(), false);
      ...
      this.fillWithOutline(world, boundingBox, 5, 4, 5, this.width - 6, 4, this.depth - 6, Blocks.SANDSTONE.getDefaultState(), Blocks.SANDSTONE.getDefaultState(), false);
      ...
      this.fillWithOutline(world, boundingBox, this.width - 5, 1, 5, this.width - 2, 4, 11, Blocks.SANDSTONE.getDefaultState(), Blocks.SANDSTONE.getDefaultState(), false);
      ...
      this.fillWithOutline(world, boundingBox, this.width - 7, 7, 9, this.width - 7, 7, 11, Blocks.SANDSTONE.getDefaultState(), Blocks.SANDSTONE.getDefaultState(), false);
      ...
      this.fillWithOutline(world, boundingBox, this.width - 6, 5, 9, this.width - 6, 7, 11, Blocks.CUT_SANDSTONE.getDefaultState(), Blocks.CUT_SANDSTONE.getDefaultState(), false);
      ...
      this.fillWithOutline(world, boundingBox, this.width - 3, 1, 3, this.width - 2, 2, 3, Blocks.SANDSTONE.getDefaultState(), Blocks.SANDSTONE.getDefaultState(), false);
      ...
      this.fillWithOutline(world, boundingBox, this.width - 5, 3, 5, this.width - 5, 3, 17, Blocks.SANDSTONE.getDefaultState(), Blocks.SANDSTONE.getDefaultState(), false);
      ...
      int o;
      for(o = 5; o <= 17; o += 2) {
         this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), 4, 1, o, boundingBox);
         this.addBlock(world, Blocks.CHISELED_SANDSTONE.getDefaultState(), 4, 2, o, boundingBox);
         this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), this.width - 5, 1, o, boundingBox);
         this.addBlock(world, Blocks.CHISELED_SANDSTONE.getDefaultState(), this.width - 5, 2, o, boundingBox);
      }
      ...
      for(o = 0; o <= this.width - 1; o += this.width - 1) {
         this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o, 2, 1, boundingBox);
         this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o, 2, 2, boundingBox);
         this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o, 2, 3, boundingBox);
         this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o, 3, 1, boundingBox);
         this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o, 3, 2, boundingBox);
         this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o, 3, 3, boundingBox);
         this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o, 4, 1, boundingBox);
         this.addBlock(world, Blocks.CHISELED_SANDSTONE.getDefaultState(), o, 4, 2, boundingBox);
         this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o, 4, 3, boundingBox);
         this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o, 5, 1, boundingBox);
         this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o, 5, 2, boundingBox);
         this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o, 5, 3, boundingBox);
         this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o, 6, 1, boundingBox);
         this.addBlock(world, Blocks.CHISELED_SANDSTONE.getDefaultState(), o, 6, 2, boundingBox);
         this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o, 6, 3, boundingBox);
         this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o, 7, 1, boundingBox);
         this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o, 7, 2, boundingBox);
         this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o, 7, 3, boundingBox);
         this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o, 8, 1, boundingBox);
         this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o, 8, 2, boundingBox);
         this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o, 8, 3, boundingBox);
      }
      ...
      this.fillWithOutline(world, boundingBox, 8, -10, 8, 12, -10, 12, Blocks.CHISELED_SANDSTONE.getDefaultState(), Blocks.CHISELED_SANDSTONE.getDefaultState(), false);
