...
public class NetherFortressGenerator {
   ...
   static NetherFortressGenerator.Piece createPiece(NetherFortressGenerator.PieceData pieceData, StructurePiecesHolder structurePiecesHolder, Random random, int x, int y, int z, Direction orientation, int chainLength) {
   ...
   public static class Bridge extends NetherFortressGenerator.Piece {
      ...
      public static NetherFortressGenerator.Bridge create(StructurePiecesHolder structurePiecesHolder, Random random, int x, int y, int z, Direction orientation, int chainLength) {
         BlockBox blockBox = BlockBox.rotated(x, y, z, -1, -3, 0, 5, 10, 19, orientation);
         return isInBounds(blockBox) && structurePiecesHolder.getIntersecting(blockBox) == null ? new NetherFortressGenerator.Bridge(chainLength, random, blockBox, orientation) : null;
      }
   ...
   public static class BridgeCrossing extends NetherFortressGenerator.Piece {
      ...
      public static NetherFortressGenerator.BridgeCrossing create(StructurePiecesHolder structurePiecesHolder, int x, int y, int z, Direction orientation, int chainLength) {
         BlockBox blockBox = BlockBox.rotated(x, y, z, -8, -3, 0, 19, 10, 19, orientation);
         return isInBounds(blockBox) && structurePiecesHolder.getIntersecting(blockBox) == null ? new NetherFortressGenerator.BridgeCrossing(chainLength, blockBox, orientation) : null;
      }
      ...
      public boolean generate(StructureWorldAccess world, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos, BlockPos pos) {
         ...
         for(k = 7; k <= 11; ++k) {
            for(l = 0; l <= 2; ++l) {
               ...
               this.fillDownwards(world, Blocks.NETHER_BRICKS.getDefaultState(), k, -1, 18 - l, boundingBox);
            }
         }
   ...
   public static class BridgeSmallCrossing extends NetherFortressGenerator.Piece {
      ...
      public static NetherFortressGenerator.BridgeSmallCrossing create(StructurePiecesHolder structurePiecesHolder, int x, int y, int z, Direction orientation, int chainLength) {
         BlockBox blockBox = BlockBox.rotated(x, y, z, -2, 0, 0, 7, 9, 7, orientation);
         return isInBounds(blockBox) && structurePiecesHolder.getIntersecting(blockBox) == null ? new NetherFortressGenerator.BridgeSmallCrossing(chainLength, blockBox, orientation) : null;
      }
   ...
   public static class BridgeStairs extends NetherFortressGenerator.Piece {
      ...
      public static NetherFortressGenerator.BridgeStairs create(StructurePiecesHolder structurePiecesHolder, int x, int y, int z, int chainlength, Direction orientation) {
         BlockBox blockBox = BlockBox.rotated(x, y, z, -2, 0, 0, 7, 11, 7, orientation);
         return isInBounds(blockBox) && structurePiecesHolder.getIntersecting(blockBox) == null ? new NetherFortressGenerator.BridgeStairs(chainlength, blockBox, orientation) : null;
      }
   ...
   public static class BridgePlatform extends NetherFortressGenerator.Piece {
      ...
      public static NetherFortressGenerator.BridgePlatform create(StructurePiecesHolder structurePiecesHolder, int x, int y, int z, int chainLength, Direction orientation) {
         BlockBox blockBox = BlockBox.rotated(x, y, z, -2, 0, 0, 7, 8, 9, orientation);
         return isInBounds(blockBox) && structurePiecesHolder.getIntersecting(blockBox) == null ? new NetherFortressGenerator.BridgePlatform(chainLength, blockBox, orientation) : null;
      }
   ...
   public static class CorridorExit extends NetherFortressGenerator.Piece {
      ...
      public static NetherFortressGenerator.CorridorExit create(StructurePiecesHolder structurePiecesHolder, Random random, int x, int y, int z, Direction orientation, int chainLength) {
         BlockBox blockBox = BlockBox.rotated(x, y, z, -5, -3, 0, 13, 14, 13, orientation);
         return isInBounds(blockBox) && structurePiecesHolder.getIntersecting(blockBox) == null ? new NetherFortressGenerator.CorridorExit(chainLength, random, blockBox, orientation) : null;
      }
      ...
      public boolean generate(StructureWorldAccess world, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos, BlockPos pos) {
         ...
         int m;
         for(m = 1; m <= 11; m += 2) {
            this.fillWithOutline(world, boundingBox, m, 10, 0, m, 11, 0, blockState, blockState, false);
            this.fillWithOutline(world, boundingBox, m, 10, 12, m, 11, 12, blockState, blockState, false);
            this.fillWithOutline(world, boundingBox, 0, 10, m, 0, 11, m, blockState2, blockState2, false);
            this.fillWithOutline(world, boundingBox, 12, 10, m, 12, 11, m, blockState2, blockState2, false);
            this.addBlock(world, Blocks.NETHER_BRICKS.getDefaultState(), m, 13, 0, boundingBox);
            this.addBlock(world, Blocks.NETHER_BRICKS.getDefaultState(), m, 13, 12, boundingBox);
            this.addBlock(world, Blocks.NETHER_BRICKS.getDefaultState(), 0, 13, m, boundingBox);
            this.addBlock(world, Blocks.NETHER_BRICKS.getDefaultState(), 12, 13, m, boundingBox);
            if (m != 11) {
               this.addBlock(world, blockState, m + 1, 13, 0, boundingBox);
               this.addBlock(world, blockState, m + 1, 13, 12, boundingBox);
               this.addBlock(world, blockState2, 0, 13, m + 1, boundingBox);
               this.addBlock(world, blockState2, 12, 13, m + 1, boundingBox);
            }
         }
         ...
         for(m = 3; m <= 9; m += 2) {
            this.fillWithOutline(world, boundingBox, 1, 7, m, 1, 8, m, (BlockState)blockState2.with(FenceBlock.WEST, true), (BlockState)blockState2.with(FenceBlock.WEST, true), false);
            this.fillWithOutline(world, boundingBox, 11, 7, m, 11, 8, m, (BlockState)blockState2.with(FenceBlock.EAST, true), (BlockState)blockState2.with(FenceBlock.EAST, true), false);
         }
         ...
         for(m = 4; m <= 8; ++m) {
            for(n = 0; n <= 2; ++n) {
               ...
               this.fillDownwards(world, Blocks.NETHER_BRICKS.getDefaultState(), m, -1, 12 - n, boundingBox);
            }
         }
   ...
   public static class SmallCorridor extends NetherFortressGenerator.Piece {
      ...
      public static NetherFortressGenerator.SmallCorridor create(StructurePiecesHolder structurePiecesHolder, int x, int y, int z, Direction orientation, int chainLength) {
         BlockBox blockBox = BlockBox.rotated(x, y, z, -1, 0, 0, 5, 7, 5, orientation);
         return isInBounds(blockBox) && structurePiecesHolder.getIntersecting(blockBox) == null ? new NetherFortressGenerator.SmallCorridor(chainLength, blockBox, orientation) : null;
      }
   ...
   public static class CorridorRightTurn extends NetherFortressGenerator.Piece {
      ...
      public static NetherFortressGenerator.CorridorRightTurn create(StructurePiecesHolder structurePiecesHolder, Random random, int x, int y, int z, Direction orientation, int chainLength) {
         BlockBox blockBox = BlockBox.rotated(x, y, z, -1, 0, 0, 5, 7, 5, orientation);
         return isInBounds(blockBox) && structurePiecesHolder.getIntersecting(blockBox) == null ? new NetherFortressGenerator.CorridorRightTurn(chainLength, random, blockBox, orientation) : null;
      }
   ...
   public static class CorridorLeftTurn extends NetherFortressGenerator.Piece {
      ...
      public static NetherFortressGenerator.CorridorLeftTurn create(StructurePiecesHolder structurePiecesHolder, Random random, int x, int y, int z, Direction orientation, int chainLength) {
         BlockBox blockBox = BlockBox.rotated(x, y, z, -1, 0, 0, 5, 7, 5, orientation);
         return isInBounds(blockBox) && structurePiecesHolder.getIntersecting(blockBox) == null ? new NetherFortressGenerator.CorridorLeftTurn(chainLength, random, blockBox, orientation) : null;
      }
   ...
   public static class CorridorStairs extends NetherFortressGenerator.Piece {
      ...
      public static NetherFortressGenerator.CorridorStairs create(StructurePiecesHolder structurePiecesHolder, int x, int y, int z, Direction orientation, int chainLength) {
         BlockBox blockBox = BlockBox.rotated(x, y, z, -1, -7, 0, 5, 14, 10, orientation);
         return isInBounds(blockBox) && structurePiecesHolder.getIntersecting(blockBox) == null ? new NetherFortressGenerator.CorridorStairs(chainLength, blockBox, orientation) : null;
      }
   ...
   public static class CorridorBalcony extends NetherFortressGenerator.Piece {
      ...
      public static NetherFortressGenerator.CorridorBalcony create(StructurePiecesHolder structurePiecesHolder, int x, int y, int z, Direction orientation, int chainLength) {
         BlockBox blockBox = BlockBox.rotated(x, y, z, -3, 0, 0, 9, 7, 9, orientation);
         return isInBounds(blockBox) && structurePiecesHolder.getIntersecting(blockBox) == null ? new NetherFortressGenerator.CorridorBalcony(chainLength, blockBox, orientation) : null;
      }
   ...
   public static class CorridorCrossing extends NetherFortressGenerator.Piece {
      ...
      public static NetherFortressGenerator.CorridorCrossing create(StructurePiecesHolder structurePiecesHolder, int x, int y, int z, Direction orientation, int chainLength) {
         BlockBox blockBox = BlockBox.rotated(x, y, z, -1, 0, 0, 5, 7, 5, orientation);
         return isInBounds(blockBox) && structurePiecesHolder.getIntersecting(blockBox) == null ? new NetherFortressGenerator.CorridorCrossing(chainLength, blockBox, orientation) : null;
      }
   ...
   public static class CorridorNetherWartsRoom extends NetherFortressGenerator.Piece {
      ...
      public static NetherFortressGenerator.CorridorNetherWartsRoom create(StructurePiecesHolder structurePiecesHolder, int x, int y, int z, Direction orientation, int chainlength) {
         BlockBox blockBox = BlockBox.rotated(x, y, z, -5, -3, 0, 13, 14, 13, orientation);
         return isInBounds(blockBox) && structurePiecesHolder.getIntersecting(blockBox) == null ? new NetherFortressGenerator.CorridorNetherWartsRoom(chainlength, blockBox, orientation) : null;
      }
      ...
      public boolean generate(StructureWorldAccess world, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos, BlockPos pos) {
         ...
         int j;
         for(j = 1; j <= 11; j += 2) {
            this.fillWithOutline(world, boundingBox, j, 10, 0, j, 11, 0, blockState, blockState, false);
            this.fillWithOutline(world, boundingBox, j, 10, 12, j, 11, 12, blockState, blockState, false);
            this.fillWithOutline(world, boundingBox, 0, 10, j, 0, 11, j, blockState2, blockState2, false);
            this.fillWithOutline(world, boundingBox, 12, 10, j, 12, 11, j, blockState2, blockState2, false);
            this.addBlock(world, Blocks.NETHER_BRICKS.getDefaultState(), j, 13, 0, boundingBox);
            this.addBlock(world, Blocks.NETHER_BRICKS.getDefaultState(), j, 13, 12, boundingBox);
            this.addBlock(world, Blocks.NETHER_BRICKS.getDefaultState(), 0, 13, j, boundingBox);
            this.addBlock(world, Blocks.NETHER_BRICKS.getDefaultState(), 12, 13, j, boundingBox);
            if (j != 11) {
               this.addBlock(world, blockState, j + 1, 13, 0, boundingBox);
               this.addBlock(world, blockState, j + 1, 13, 12, boundingBox);
               this.addBlock(world, blockState2, 0, 13, j + 1, boundingBox);
               this.addBlock(world, blockState2, 12, 13, j + 1, boundingBox);
            }
         }
         ...
         for(k = 0; k <= 6; ++k) {
            ...
            for(q = 5; q <= 7; ++q) {
               this.addBlock(world, blockState5, q, 5 + k, l, boundingBox);
            }
         ...
         for(k = 5; k <= 7; ++k) {
            this.addBlock(world, blockState5, k, 12, 11, boundingBox);
         }
         ...
         for(q = 4; q <= 8; ++q) {
            for(r = 0; r <= 2; ++r) {
               ...
               this.fillDownwards(world, Blocks.NETHER_BRICKS.getDefaultState(), q, -1, 12 - r, boundingBox);
            }
         }
   ...
   public static class BridgeEnd extends NetherFortressGenerator.Piece {
      ...
      public static NetherFortressGenerator.BridgeEnd create(StructurePiecesHolder structurePiecesHolder, Random random, int x, int y, int z, Direction orientation, int chainLength) {
         BlockBox blockBox = BlockBox.rotated(x, y, z, -1, -3, 0, 5, 10, 8, orientation);
         return isInBounds(blockBox) && structurePiecesHolder.getIntersecting(blockBox) == null ? new NetherFortressGenerator.BridgeEnd(chainLength, random, blockBox, orientation) : null;
      }
      ...
      public boolean generate(StructureWorldAccess world, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos, BlockPos pos) {
         ...
         p = random2.nextInt(8);
         this.fillWithOutline(world, boundingBox, 0, 5, 0, 0, 5, p, Blocks.NETHER_BRICKS.getDefaultState(), Blocks.NETHER_BRICKS.getDefaultState(), false);
         p = random2.nextInt(8);
         this.fillWithOutline(world, boundingBox, 4, 5, 0, 4, 5, p, Blocks.NETHER_BRICKS.getDefaultState(), Blocks.NETHER_BRICKS.getDefaultState(), false);

         for(p = 0; p <= 4; ++p) {
            q = random2.nextInt(5);
            this.fillWithOutline(world, boundingBox, p, 2, 0, p, 2, q, Blocks.NETHER_BRICKS.getDefaultState(), Blocks.NETHER_BRICKS.getDefaultState(), false);
         }
   ...
   abstract static class Piece extends StructurePiece {
      ...
      private NetherFortressGenerator.Piece pickPiece(NetherFortressGenerator.Start start, List<NetherFortressGenerator.PieceData> possiblePieces, StructurePiecesHolder structurePiecesHolder, Random random, int x, int y, int z, Direction orientation, int chainLength) {
      ...
      private StructurePiece pieceGenerator(NetherFortressGenerator.Start start, StructurePiecesHolder structurePiecesHolder, Random random, int x, int y, int z, @Nullable Direction orientation, int chainLength, boolean inside) {
      ...
      @Nullable
      protected StructurePiece fillForwardOpening(NetherFortressGenerator.Start start, StructurePiecesHolder structurePiecesHolder, Random random, int leftRightOffset, int heightOffset, boolean inside) {
         Direction direction = this.getFacing();
         if (direction != null) {
            switch(direction) {
            case NORTH:
      ...
      @Nullable
      protected StructurePiece fillNWOpening(NetherFortressGenerator.Start start, StructurePiecesHolder structurePiecesHolder, Random random, int heightOffset, int leftRightOffset, boolean inside) {
         Direction direction = this.getFacing();
         if (direction != null) {
            switch(direction) {
            case NORTH:
      ...
      @Nullable
      protected StructurePiece fillSEOpening(NetherFortressGenerator.Start start, StructurePiecesHolder structurePiecesHolder, Random random, int heightOffset, int leftRightOffset, boolean inside) {
         Direction direction = this.getFacing();
         if (direction != null) {
            switch(direction) {
            case NORTH:
