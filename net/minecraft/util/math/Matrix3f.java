...
public final class Matrix3f {
   ...
   private static Quaternion method_22857(Matrix3f matrix) {
      ...
      if (matrix.a01 * matrix.a01 + matrix.a10 * matrix.a10 > 1.0E-6F) {
         pair3 = getSinAndCosOfRotation(matrix.a00, 0.5F * (matrix.a01 + matrix.a10), matrix.a11);
      ...
      if (matrix.a02 * matrix.a02 + matrix.a20 * matrix.a20 > 1.0E-6F) {
         pair3 = getSinAndCosOfRotation(matrix.a00, 0.5F * (matrix.a02 + matrix.a20), matrix.a22);
      ...
      if (matrix.a12 * matrix.a12 + matrix.a21 * matrix.a21 > 1.0E-6F) {
         pair3 = getSinAndCosOfRotation(matrix.a11, 0.5F * (matrix.a12 + matrix.a21), matrix.a22);
         float4 = (Float)pair3.getFirst();
         float5 = (Float)pair3.getSecond();
   ...
   private static void method_35260(Matrix3f matrix, Quaternion quaternion) {
      ...
      if (f < g) {
         ...
         matrix.a02 = k;
         quaternion4 = new Quaternion(0.0F, 0.0F, SQRT_HALF, SQRT_HALF);
         quaternion.hamiltonProduct(quaternion4);
         k = f;
         f = g;
         g = k;
      ...
      if (f < h) {
         ...
         matrix.a02 = k;
         quaternion4 = new Quaternion(0.0F, SQRT_HALF, 0.0F, SQRT_HALF);
         quaternion.hamiltonProduct(quaternion4);
         h = f;
      }
      ...
      if (g < h) {
         ...
         matrix.a12 = k;
         quaternion4 = new Quaternion(SQRT_HALF, 0.0F, 0.0F, SQRT_HALF);
         quaternion.hamiltonProduct(quaternion4);
      }
