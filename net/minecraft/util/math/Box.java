...
public class Box {
   ...
   public static Box from(Vec3d pos) {
      return new Box(pos.x, pos.y, pos.z, pos.x + 1.0D, pos.y + 1.0D, pos.z + 1.0D);
   }
   ...
   public static Box of(Vec3d center, double dx, double dy, double dz) {
      return new Box(center.x - dx / 2.0D, center.y - dy / 2.0D, center.z - dz / 2.0D, center.x + dx / 2.0D, center.y + dy / 2.0D, center.z + dz / 2.0D);
   }
}
