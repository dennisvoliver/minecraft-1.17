   ...
   public static class Present<T> implements Weighted {
      ...
      public static <E> Codec<Weighted.Present<E>> createCodec(Codec<E> dataCodec) {
         return RecordCodecBuilder.create((instance) -> {
            return instance.group(dataCodec.fieldOf("data").forGetter(Weighted.Present::getData), Weight.CODEC.fieldOf("weight").forGetter(Weighted.Present::getWeight)).apply(instance, (BiFunction)(Weighted.Present::new));
         });
      }
   }
