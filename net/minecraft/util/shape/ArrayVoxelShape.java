...
public class ArrayVoxelShape extends VoxelShape {
   ...
   protected ArrayVoxelShape(VoxelSet voxelSet, double[] ds, double[] es, double[] fs) {
      this(voxelSet, (DoubleList)DoubleArrayList.wrap(Arrays.copyOf(ds, voxelSet.getXSize() + 1)), (DoubleList)DoubleArrayList.wrap(Arrays.copyOf(es, voxelSet.getYSize() + 1)), (DoubleList)DoubleArrayList.wrap(Arrays.copyOf(fs, voxelSet.getZSize() + 1)));
   }
