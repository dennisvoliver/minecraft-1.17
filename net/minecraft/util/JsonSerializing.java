...
public class JsonSerializing {
   ...
   public static class TypeHandler<E, T extends JsonSerializableType<E>> {
      ...
      public Object createGsonSerializer() {
         return new JsonSerializing.GsonSerializer(this.registry, this.rootFieldName, this.idFieldName, this.typeIdentification, this.field_28444, this.customSerializer);
      }
   }
   ...
   static class GsonSerializer<E, T extends JsonSerializableType<E>> implements JsonDeserializer<E>, com.google.gson.JsonSerializer<E> {
      ...
      GsonSerializer(Registry<T> registry, String rootFieldName, String idFieldName, Function<E, T> typeIdentification, @Nullable T jsonSerializableType, @Nullable com.mojang.datafixers.util.Pair<T, JsonSerializing.CustomSerializer<? extends E>> elementSerializer) {
         this.registry = registry;
         this.rootFieldName = rootFieldName;
         this.idFieldName = idFieldName;
         this.typeIdentification = typeIdentification;
      ...
      public E deserialize(JsonElement json, Type type, JsonDeserializationContext context) throws JsonParseException {
         if (json.isJsonObject()) {
            ...
            JsonSerializableType jsonSerializableType2;
            if (string.isEmpty()) {
               jsonSerializableType2 = this.field_28445;
            } else {
               Identifier identifier = new Identifier(string);
               jsonSerializableType2 = (JsonSerializableType)this.registry.get(identifier);
            }

            if (jsonSerializableType2 == null) {
               throw new JsonSyntaxException("Unknown type '" + string + "'");
            } else {
               return jsonSerializableType2.getJsonSerializer().fromJson(jsonObject, context);
            }
         } else if (this.elementSerializer == null) {
            throw new UnsupportedOperationException("Object " + json + " can't be deserialized");
         } else {
            return ((JsonSerializing.CustomSerializer)this.elementSerializer.getSecond()).fromJson(json, context);
         }
      }
