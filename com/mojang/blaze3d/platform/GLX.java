...
public class GLX {
   ...
   public static void _renderCrosshair(int size, boolean drawX, boolean drawY, boolean drawZ) {
      ...
      if (drawX) {
         ...
         bufferBuilder.vertex((double)size, 0.0D, 0.0D).color(0, 0, 0, 255).normal(1.0F, 0.0F, 0.0F).next();
      }

      if (drawY) {
         bufferBuilder.vertex(0.0D, 0.0D, 0.0D).color(0, 0, 0, 255).normal(0.0F, 1.0F, 0.0F).next();
         bufferBuilder.vertex(0.0D, (double)size, 0.0D).color(0, 0, 0, 255).normal(0.0F, 1.0F, 0.0F).next();
      }

      if (drawZ) {
         bufferBuilder.vertex(0.0D, 0.0D, 0.0D).color(0, 0, 0, 255).normal(0.0F, 0.0F, 1.0F).next();
         bufferBuilder.vertex(0.0D, 0.0D, (double)size).color(0, 0, 0, 255).normal(0.0F, 0.0F, 1.0F).next();
      }
      ...
      if (drawX) {
         ...
         bufferBuilder.vertex((double)size, 0.0D, 0.0D).color(255, 0, 0, 255).normal(1.0F, 0.0F, 0.0F).next();
      }

      if (drawY) {
         bufferBuilder.vertex(0.0D, 0.0D, 0.0D).color(0, 255, 0, 255).normal(0.0F, 1.0F, 0.0F).next();
         bufferBuilder.vertex(0.0D, (double)size, 0.0D).color(0, 255, 0, 255).normal(0.0F, 1.0F, 0.0F).next();
      }

      if (drawZ) {
         bufferBuilder.vertex(0.0D, 0.0D, 0.0D).color(127, 127, 255, 255).normal(0.0F, 0.0F, 1.0F).next();
         bufferBuilder.vertex(0.0D, 0.0D, (double)size).color(127, 127, 255, 255).normal(0.0F, 0.0F, 1.0F).next();
      }
